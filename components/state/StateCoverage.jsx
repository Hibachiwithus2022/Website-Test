      ...
      <div className="max-w-5xl mx-auto">
        <div style={{ display: 'grid', gap: '3rem' }} className="md:grid-cols-2">
          ...
          <div>
            ...
            <h2 className="font-display" style={{ fontSize: 'clamp(1.9rem,4vw,2.8rem)', color: '#1A1209', marginBottom: '1.25rem', lineHeight: 1.1 }}>
              Statewide Coverage<br />
              <span style={{ color: '#C8102E' }}>Across {state}</span>
            </h2>
            <p style={{ color: 'rgba(26,18,9,0.65)', lineHeight: 1.82, fontSize: '0.95rem', marginBottom: '1.5rem' }}>
              {stateData.regionNotes}
            </p>
            <p style={{ color: 'rgba(26,18,9,0.55)', lineHeight: 1.82, fontSize: '0.9rem' }}>
          ...
          {/* Right: city pills */}
          <div>
            <div style={{ fontSize: '0.68rem', fontWeight: 600, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(26,18,9,0.4)', marginBottom: '1.25rem' }}>
              Areas We Serve
            </div>
            ...
            <div style={{ marginTop: '2.5rem' }}>
              <div style={{ fontSize: '0.68rem', fontWeight: 600, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(26,18,9,0.4)', marginBottom: '1rem' }}>
                What's Included
              </div>
              <ul style={{ fontSize: '0.9rem', color: 'rgba(26,18,9,0.7)', lineHeight: 2.1 }}>
                {[
