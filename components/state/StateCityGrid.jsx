...
export default function StateCityGrid({ state, stateSlug, cities }) {
  ...
  return (
    <section id="cities" style={{ background: 'linear-gradient(180deg,#1E1410,#1A1209)', padding: '4.5rem 1.5rem' }}>
      <div className="max-w-5xl mx-auto">
        <div className="text-center" style={{ marginBottom: '3rem' }}>
          ...
          <p style={{ color: 'rgba(245,239,224,0.55)', maxWidth: '36rem', margin: '1rem auto 0', fontSize: '0.95rem', lineHeight: 1.75 }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#F5EFE0', fontSize: '0.92rem' }}>Don't see your city?</div>
            <div style={{ fontSize: '0.82rem', color: 'rgba(245,239,224,0.5)', marginTop: '0.2rem' }}>We serve all of {state} — contact us for availability in your area.</div>
          </div>
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          ...
          <div style={{ fontSize: '0.72rem', color: 'rgba(245,239,224,0.4)', marginTop: '0.15rem' }}>Hibachi Chef Available</div>
        </div>
