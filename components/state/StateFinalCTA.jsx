    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center" style={{ position: 'relative' }}>
        ...
        <h2
          ...
          style={{ fontSize: 'clamp(2.6rem,7vw,5rem)', marginBottom: '1.25rem' }}
        >
          Book Your Hibachi<br />
          <span style={{ color: '#C8102E' }}>Experience in {state} Today</span>
        </h2>

        <p style={{ color: 'rgba(245,239,224,0.65)', fontSize: '1.05rem', lineHeight: 1.78, marginBottom: '2.75rem', maxWidth: '38rem', margin: '0 auto 2.75rem' }}>
        ...
        >
          <div style={{ display: 'grid', gap: '1rem' }} className="sm:grid-cols-2">
            <div>
              <label style={{ fontSize: '0.75rem', color: 'rgba(245,239,224,0.5)', letterSpacing: '0.08em', textTransform: 'uppercase', display: 'block', marginBottom: '0.4rem' }}>Name</label>
              <input type="text" placeholder="Your name" required className="form-input" />
            </div>
            <div>
              <label style={{ fontSize: '0.75rem', color: 'rgba(245,239,224,0.5)', letterSpacing: '0.08em', textTransform: 'uppercase', display: 'block', marginBottom: '0.4rem' }}>Phone</label>
              <input type="tel" placeholder="(602) 767-2965" required className="form-input" />
            </div>
            <div>
              <label style={{ fontSize: '0.75rem', color: 'rgba(245,239,224,0.5)', letterSpacing: '0.08em', textTransform: 'uppercase', display: 'block', marginBottom: '0.4rem' }}>City in {state}</label>
              <input type="text" placeholder={`City, ${state}`} className="form-input" />
            </div>
            <div>
              <label style={{ fontSize: '0.75rem', color: 'rgba(245,239,224,0.5)', letterSpacing: '0.08em', textTransform: 'uppercase', display: 'block', marginBottom: '0.4rem' }}>Guest Count</label>
              <input type="number" placeholder="# of guests" min="10" className="form-input" />
            </div>
            <div className="sm:col-span-2">
              <label style={{ fontSize: '0.75rem', color: 'rgba(245,239,224,0.5)', letterSpacing: '0.08em', textTransform: 'uppercase', display: 'block', marginBottom: '0.4rem' }}>Event Date</label>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '2rem', flexWrap: 'wrap', marginTop: '2.5rem' }}>
          {[
            ...
            <span key={badge} style={{ fontSize: '0.8rem', color: 'rgba(245,239,224,0.45)', letterSpacing: '0.04em' }}>{badge}</span>
          ))}
        </div>

        {/* Phone */}
        <div style={{ marginTop: '2rem', fontSize: '0.9rem', color: 'rgba(245,239,224,0.45)' }}>
