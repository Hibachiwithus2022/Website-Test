      ...
      <div className="max-w-5xl mx-auto">
        <div style={{ display: 'grid', gap: '3rem' }} className="lg:grid-cols-[1fr_auto]">
          ...
          <div>
            ...
            <p style={{ color: 'rgba(26,18,9,0.68)', lineHeight: 1.82, fontSize: '1rem', maxWidth: '54rem', marginBottom: '1.25rem' }}>
              {stateData.blurb}
            </p>
            <p style={{ color: 'rgba(26,18,9,0.58)', lineHeight: 1.82, fontSize: '0.95rem', maxWidth: '54rem' }}>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={f.label} style={{
                ...
                <span style={{ fontSize: '0.82rem', color: 'rgba(26,18,9,0.55)' }}>{f.label}</span>
                <span style={{ fontSize: '0.82rem', fontWeight: 600, color: '#1A1209' }}>{f.value}</span>
              </div>
            ))}
          </div>
