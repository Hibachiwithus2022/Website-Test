      ...
      <div className="max-w-5xl mx-auto">
        <div style={{ display: 'grid', gap: '3.5rem', alignItems: 'start' }} className="md:grid-cols-2">
          ...
          <div>
            ...
            <h2 className="font-display" style={{ fontSize: 'clamp(2rem,5vw,3rem)', color: '#F5EFE0', lineHeight: 1.05, marginBottom: '1.25rem' }}>
              We Proudly Serve<br />
              <span style={{ color: '#C8102E' }}>{cityName} & Surrounding Areas</span>
            </h2>
            <p style={{ color: 'rgba(245,239,224,0.65)', lineHeight: 1.82, fontSize: '0.95rem', marginBottom: '1.25rem' }}>
            ...
            <p style={{ color: 'rgba(245,239,224,0.5)', lineHeight: 1.82, fontSize: '0.88rem' }}>
          ...
          {nearbyCities.length > 0 && (
            <div>
              <div style={{ fontSize: '0.68rem', fontWeight: 600, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(245,239,224,0.38)', marginBottom: '1.25rem' }}>
                ...
                {[cityName, ...nearbyCities].map((city) => (
                  <div
                    ...
                    style={{
                      ...
                      fontSize: '0.85rem',
                      color: city === cityName ? '#F5EFE0' : 'rgba(245,239,224,0.65)',
