...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: `https://hibachiconnect.com/og?type=state&state=${encodeURIComponent(state)}`, width: 1200, height: 630, alt: `Private hibachi chef serving ${state}` }],
    },
    twitter: { card: 'summary_large_image', images: [`https://hibachiconnect.com/og?type=state&state=${encodeURIComponent(state)}`] },
  }
}
