...
const GLOBAL_INTRO_VARIANTS = [
  ...
  // ── 1: Convenience-first ───────────────────────────────────────────────────
  {
    ...
    opening:  (city, state) =>
      `Planning a dinner event in ${city} doesn't have to mean hunting for a table big enough for your whole group, splitting the party into separate cars, or spending the evening managing food orders across the room. With Hibachi Connect, you pick the date — we handle everything else. A certified teppanyaki chef shows up to your ${city} home or backyard with a full propane grill, fresh ingredients, and complete setup, arriving about 30 minutes before your guests do.`,
    middle:   (city, state) =>
...
// Combined array: global 0–4 + Texas generic 5–9 + city-specific 10–17
// 10=Houston 11=Dallas 12=Austin 13=SanAntonio 14=FortWorth
// 15=Katy 16=SugarLand 17=TheWoodlands
// Components use `INTRO_VARIANTS[uniqueIntroVariant % INTRO_VARIANTS.length]`
// so adding entries here automatically makes higher indices work without any
// component changes.
export const INTRO_VARIANTS = [...GLOBAL_INTRO_VARIANTS, ...TEXAS_INTRO_VARIANTS, ...TEXAS_CITY_INTROS]
...
// Combined array: global 0–4 + Texas generic 5–9 + city-specific 10–17
export const CLOSING_VARIANTS = [...GLOBAL_CLOSING_VARIANTS, ...TEXAS_CLOSING_VARIANTS, ...TEXAS_CITY_CLOSINGS]
