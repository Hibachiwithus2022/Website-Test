...
export const INTRO_VARIANTS = [
  ...
  // ── 1: Convenience-first ───────────────────────────────────────────────────
  {
    ...
    closing:  (city, state) =>
      `Hibachi Connect has run hundreds of events across ${state} — birthday dinners, corporate retreats, graduation parties, bachelorette nights, and ordinary Saturdays that became anything but ordinary. If you can host 10 people in ${city}, we can make it an unforgettable evening. Standard package starts at $60 per adult, $600 minimum.`,
  },
  // ── 2: Craft/food-first ────────────────────────────────────────────────────
  {
    angle:    'craft',
...
export const SHARED_FAQ_POOL = [
  ...
  },
  {
    ...
    a: 'No hidden fees. Your price is $60/adult, $30/child (12 & under), $600 event minimum. Travel fees may apply for locations more than 30 miles from our nearest chef base. All fees are disclosed and agreed upon before you book — nothing surprises you at the event.',
  },
  {
    pool: 'pricing',
...
const DESC_TEMPLATES = [
  ...
  // 4 — occasion + urgency
  (city, state) => `Planning a party in ${city}? A private hibachi chef brings the grill, food, and entertainment to your ${state} home. $60/adult · $550 min · Setup + cleanup included.`,
]
