...
const GA_SECTION_VARIANTS = [
  // Theme 0 — Atlanta Corporate
  {
    ...
    experiencePoints:   [
      ...
      'Greater Atlanta and all of North Georgia fully served',
      'Premium proteins, full live show, zero cleanup',
    ],
  ...
  // Theme 2 — Coastal / Vacation
  {
    ...
    experiencePoints:   [
      'Chef comes directly to your rental — no crowded restaurant logistics',
  ...
  // Theme 3 — Athens College & Eclectic
  {
    ...
    experiencePoints:   [
      ...
      'Perfect for UGA graduation season when restaurants are fully booked',
  ...
  // Theme 4 — Augusta Golf / Private Estate
  {
    ...
    experiencePoints:   [
      'Premium proteins — filet mignon, lobster tail — available for any event',
      'Certified teppanyaki chef for intimate groups of 8–20 or larger estates',
      'Masters Week and corporate retreat events our specialty',
      'Flawless setup and cleanup — your property stays immaculate',
    ],
