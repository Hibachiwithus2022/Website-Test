...
const GA_SECTION_VARIANTS = [
  ...
  // Theme 2 — Coastal / Vacation
  {
    ...
    experiencePoints:   [
      { icon: '🏖️', title: 'Chef Comes to Your Rental',         desc: 'Skip the crowded coastal restaurant — your chef arrives with everything needed for a full teppanyaki show at your property.' },
      ...
      { icon: '🏠', title: 'Property Stays Spotless',            desc: 'Full setup and complete pack-out included. Your Georgia coastal rental looks exactly as it did when the chef arrived.' },
    ],
  ...
  // Theme 3 — Athens College & Eclectic
  {
    ...
    experiencePoints:   [
      { icon: '👥', title: 'Dual Stations for Large Groups',    desc: 'Two chef stations for groups of 25–60+ — faster service and double the performance energy for your event.' },
      { icon: '🎓', title: 'Built for Graduation Season',       desc: 'Perfect for UGA graduation when restaurants are fully booked — hibachi brings the celebration to your own property.' },
  ...
  // Theme 4 — Augusta Golf / Private Estate
  {
    ...
    experiencePoints:   [
      { icon: '🥩', title: 'Premium Proteins for Any Event',    desc: 'Filet mignon, lobster tail, and the full premium menu — available for estate events and luxury occasions at any time of year.' },
      { icon: '👨‍🍳', title: 'Private Chef for Your Property',   desc: 'A certified teppanyaki chef for intimate groups of 8–20 or larger estate gatherings — scaled to your exact guest count.' },
      ...
      { icon: '✨', title: 'Property Stays Immaculate',         desc: 'Flawless setup and complete cleanup — your Augusta estate looks exactly as it did before the chef arrived.' },
    ],
...
const GA_SUPPORT_IMAGES = {
  ...
  'atlanta': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',     alt: () => `Corporate hibachi event in Atlanta, GA`,            caption: 'Atlanta corporate dining',           intro: () => `Atlanta professionals set the standard. Here's what they find:` },
  ...
  'savannah': {
    testimonial: { src: '/pics/hibachi-catering.jpg',       alt: () => `Bachelorette hibachi at a Savannah GA rental`,       caption: 'Savannah vacation rental hibachi',   intro: () => `Savannah guests come back every season. Here's why:` },
  ...
  'augusta': {
    testimonial: { src: '/pics/hibachi-event.jpg',          alt: () => `Estate hibachi dinner in Augusta, GA`,               caption: 'Augusta estate entertaining',        intro: () => `Augusta hosts expect the exceptional. Here's what they find:` },
  ...
  'columbus': {
    testimonial: { src: '/pics/hibachi-catering.jpg',       alt: () => `Graduation hibachi party in Columbus, GA`,           caption: 'Columbus graduation season',         intro: () => `Columbus families celebrate big. Here's what they say:` },
  ...
  'athens': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',     alt: () => `UGA graduation hibachi party in Athens, GA`,         caption: 'Athens graduation season',           intro: () => `Athens families and UGA hosts keep coming back. Here's why:` },
  ...
  'marietta': {
    testimonial: { src: '/pics/hibachi-catering-3.jpg',     alt: () => `Private hibachi dinner party in Marietta, GA`,       caption: 'Marietta private dining events',     intro: () => `Marietta hosts have high standards. Here's what they find:` },
  ...
  'alpharetta': {
    testimonial: { src: '/pics/hibachi-catering.jpg',       alt: () => `Graduation hibachi event in Alpharetta, GA`,         caption: 'Alpharetta graduation season',       intro: () => `Alpharetta hosts keep coming back. Here's what they say:` },
  ...
  'st-simons-island': {
    testimonial: { src: '/pics/hibachi-austin-home.jpg',    alt: () => `Birthday hibachi at a St. Simons Island rental`,     caption: 'St. Simons Island vacation hibachi', intro: () => `St. Simons Island guests say it best:` },
  ...
  'decatur': {
    testimonial: { src: '/pics/hibachi-catering-3.jpg',     alt: () => `Private hibachi dinner in Decatur, GA`,              caption: 'Decatur private dining events',      intro: () => `Decatur hosts set the standard. Here's what they find:` },
  ...
  'sandy-springs': {
    testimonial: { src: '/pics/hibachi-catering.jpg',       alt: () => `Backyard hibachi party in Sandy Springs, GA`,        caption: 'Sandy Springs backyard hibachi',     intro: () => `Sandy Springs families celebrate in the backyard. Here's what they find:` },
  ...
  'roswell': {
    testimonial: { src: '/pics/hibachi-catering.jpg',       alt: () => `Backyard graduation party in Roswell, GA`,           caption: 'Roswell graduation celebrations',    intro: () => `Roswell families know how to celebrate:` },
  ...
  'dunwoody': {
    testimonial: { src: '/pics/hibachi-dallas-home.jpg',    alt: () => `Private hibachi dinner in Dunwoody, GA`,             caption: 'Dunwoody private dining events',     intro: () => `Dunwoody hosts set the standard. Here's what they find:` },
  ...
  'johns-creek': {
    testimonial: { src: '/pics/backyard-hibachi.jpg',       alt: () => `Backyard hibachi party in Johns Creek, GA`,          caption: 'Johns Creek backyard celebrations',  intro: () => `Johns Creek families say it best:` },
  ...
  'evans': {
    testimonial: { src: '/pics/hibachi-catering-3.jpg',     alt: () => `Private hibachi dinner in Evans, GA`,                caption: 'Evans private dining events',        intro: () => `Evans hosts keep booking us. Here's what they say:` },
  ...
  'duluth': {
    testimonial: { src: '/pics/hibachi-shot-2.jpg',         alt: () => `Backyard hibachi party in Duluth, GA`,               caption: 'Duluth backyard celebrations',       intro: () => `Duluth families celebrate big. Here's what they say:` },
  ...
  'woodstock': {
    testimonial: { src: '/pics/backyard-hibachi-2.jpg',     alt: () => `Backyard hibachi event in Woodstock, GA`,            caption: 'Woodstock backyard hibachi events',  intro: () => `Woodstock families say it best:` },
  ...
  'kennesaw': {
    testimonial: { src: '/pics/backyard-hibachi.jpg',       alt: () => `Graduation hibachi party in Kennesaw, GA`,           caption: 'Kennesaw graduation celebrations',   intro: () => `Kennesaw families celebrate big. Here's what they say:` },
  ...
  'peachtree-city': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',     alt: () => `Family hibachi gathering in Peachtree City, GA`,     caption: 'Peachtree City family celebrations', intro: () => `Peachtree City families know how to celebrate. Here's what they say:` },
  ...
  'gainesville': {
    testimonial: { src: '/pics/hibachi-catering-3.jpg',     alt: () => `Private hibachi in Gainesville, GA`,                 caption: 'Gainesville backyard hibachi events', intro: () => `Gainesville families celebrate together. Here's what they say:` },
  ...
  'warner-robins': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',     alt: () => `Hibachi event in Warner Robins, GA`,                 caption: 'Warner Robins backyard celebrations', intro: () => `Warner Robins families keep booking us. Here's why:` },
...
const GA_SUPPORT_FALLBACKS = [
  // Theme 0 — Atlanta Corporate
  {
    testimonial: { src: '/pics/hibachi-catering.jpg',       alt: (city) => `Corporate hibachi event in ${city}, GA`,          caption: 'Georgia professionals agree',         intro: (city) => `${city} hosts keep booking us. Here's what they say:` },
  ...
  {
    testimonial: { src: '/pics/hibachi-dallas-home.jpg',    alt: (city) => `Backyard hibachi event in ${city}, GA`,           caption: 'North Atlanta hosts agree',           intro: (city) => `${city} hosts say it best:` },
    cta:         { src: '/pics/backyard-hibachi-2.jpg',      alt: (city) => `Private hibachi chef in ${city}, GA`,             caption: 'Your backyard, upgraded' },
  },
  // Theme 2 — Coastal
  {
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg', alt: (city) => `Coastal house hibachi in ${city}, GA`,            caption: 'Georgia coastal guests agree',        intro: (city) => `${city} guests keep booking us. Here's why:` },
    cta:         { src: '/pics/hibachi-photo-2.jpg',         alt: (city) => `Mobile hibachi chef in ${city}, GA`,              caption: 'The Georgia coast dinner upgrade' },
  },
  // Theme 3 — Athens College
  {
    testimonial: { src: '/pics/hibachi-colorado.jpg',       alt: (city) => `Graduation hibachi in ${city}, GA`,               caption: 'Georgia college hosts agree',         intro: (city) => `${city} hosts keep coming back. Here's why:` },
    cta:         { src: '/pics/traveling-hibachi.jpg',       alt: (city) => `Private hibachi chef in ${city}, GA`,             caption: 'The Georgia college town dinner' },
  },
  // Theme 4 — Augusta Golf
  {
    testimonial: { src: '/pics/hibachi-chef-home.jpg',      alt: (city) => `Estate hibachi event in ${city}, GA`,             caption: 'Augusta region hosts agree',          intro: (city) => `${city} hosts expect the exceptional. Here's what they find:` },
    cta:         { src: '/pics/private-hibachi.jpg',         alt: (city) => `Private hibachi chef in ${city}, GA`,             caption: 'Your private Georgia estate evening' },
  },
  // Theme 5 — Suburban Family
  {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',     alt: (city) => `Family hibachi gathering in ${city}, GA`,         caption: 'Georgia suburban families celebrate', intro: (city) => `${city} families know how to celebrate. Here's what they say:` },
