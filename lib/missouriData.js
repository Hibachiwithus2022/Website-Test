...
const MO_FAQ_SETS = [
  ...
  (city) => [
    ...
    {
      q: `Do you serve smaller lake communities near ${city}?`,
      a: `Yes — we serve all of the Lake of the Ozarks area including Osage Beach, Lake Ozark, Camdenton, Laurie, Sunrise Beach, Four Seasons, and surrounding lake communities. Travel fees may apply for more remote locations and are always disclosed before booking.`,
    },
  ],
  // Theme 4 — University
  (city) => [
...
const MO_SUPPORT_IMAGES = {
  'kansas-city': {
    testimonial: { src: '/pics/hibachi-event.jpg',        alt: () => `Kansas City backyard hibachi dinner with guests gathered around the grill`,    caption: 'KC backyard dining, elevated',         intro: () => `Kansas City hosts know good food. Here's what they find:` },
    cta:         { src: '/pics/hero-4.jpg',               alt: () => `Private hibachi chef performing in Kansas City MO`,                            caption: 'Your KC backyard event starts here' },
  },
  'st-louis': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',   alt: () => `Graduation hibachi party in St. Louis MO`,                                    caption: 'St. Louis graduation season',           intro: () => `St. Louis hosts say it best:` },
  ...
  'chesterfield': {
    testimonial: { src: '/pics/hibachi-colorado-home.jpg', alt: () => `Private hibachi dinner at a Chesterfield MO estate`,                         caption: 'Chesterfield private dining',           intro: () => `Chesterfield hosts expect the exceptional. Here's what they find:` },
  ...
  'lee-s-summit': {
    testimonial: { src: '/pics/backyard-hibachi-2.jpg',   alt: () => `Backyard hibachi party in Lee's Summit MO`,                                   caption: "Lee's Summit graduation season",        intro: () => `Lee's Summit families celebrate big. Here's what they say:` },
    cta:         { src: '/pics/hero-4.jpg',               alt: () => `Private hibachi chef performing in Lee's Summit MO`,                          caption: "Your Lee's Summit backyard event" },
  },
  'o-fallon': {
    testimonial: { src: '/pics/hibachi-shot-1.jpg',       alt: () => `Graduation hibachi party in O'Fallon MO`,                                     caption: "O'Fallon family celebrations",          intro: () => `O'Fallon hosts keep booking us. Here's why:` },
  ...
  'st-charles': {
    testimonial: { src: '/pics/hibachi-shot-2.jpg',       alt: () => `Family hibachi dinner in St. Charles MO`,                                     caption: 'St. Charles family gatherings',         intro: () => `St. Charles hosts say it best:` },
  ...
  'blue-springs': {
    testimonial: { src: '/pics/hibachi-catering.jpg',     alt: () => `Backyard hibachi party in Blue Springs MO`,                                   caption: 'Blue Springs backyard events',          intro: () => `Blue Springs hosts keep booking us. Here's why:` },
    cta:         { src: '/pics/hero-4.jpg',               alt: () => `Private hibachi chef performing in Blue Springs MO`,                          caption: 'Your Blue Springs backyard event' },
  },
  'lake-of-the-ozarks': {
    testimonial: { src: '/pics/mobile-hibachi.jpg',       alt: () => `Lake house hibachi at a Lake of the Ozarks vacation rental`,                  caption: 'Lake of the Ozarks lake house hibachi', intro: () => `Ozarks vacation guests keep coming back. Here's why:` },
  ...
  'branson': {
    testimonial: { src: '/pics/mobile-hibachi-2.jpg',     alt: () => `Vacation rental hibachi in Branson MO`,                                       caption: 'Branson vacation rental hibachi',       intro: () => `Branson vacation guests say it best:` },
  ...
  'columbia': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',   alt: () => `Mizzou graduation hibachi party in Columbia MO`,                              caption: 'Columbia graduation celebrations',      intro: () => `Columbia hosts and Tiger families say it best:` },
  ...
  'springfield': {
    testimonial: { src: '/pics/hibachi-photo-2.jpg',      alt: () => `Graduation hibachi party in Springfield MO`,                                  caption: 'Springfield graduation celebrations',   intro: () => `Springfield hosts keep booking us. Here's what they say:` },
  ...
  'kirkwood': {
    testimonial: { src: '/pics/hero-3.jpg',               alt: () => `Private hibachi dinner at a Kirkwood MO backyard`,                            caption: 'Kirkwood backyard dining',             intro: () => `Kirkwood hosts have high standards. Here's what they find:` },
  ...
  'joplin': {
    testimonial: { src: '/pics/backyard-hibachi.jpg',     alt: () => `Backyard hibachi party in Joplin MO`,                                         caption: 'Joplin backyard celebrations',          intro: () => `Joplin hosts say it best:` },
...
const MO_SUPPORT_FALLBACKS = [
  { // Theme 0 — KC Metro
    testimonial: { src: '/pics/hibachi-event.jpg',         alt: (city) => `Kansas City metro hibachi event in ${city}, MO`,    caption: 'KC metro hosts agree',             intro: (city) => `${city} hosts keep booking us. Here's what they say:` },
    cta:         { src: '/pics/hero-4.jpg',                alt: (city) => `Private hibachi chef in ${city}, MO`,               caption: 'Your KC metro event' },
  },
  { // Theme 1 — STL Metro
    testimonial: { src: '/pics/hibachi-catering-2.jpg',    alt: (city) => `St. Louis metro hibachi event in ${city}, MO`,     caption: 'St. Louis metro hosts agree',       intro: (city) => `${city} hosts say it best:` },
    cta:         { src: '/pics/hibachi-catering-3.jpg',    alt: (city) => `Private hibachi chef in ${city}, MO`,               caption: 'Your St. Louis metro event' },
  },
  { // Theme 2 — STL Affluent
    testimonial: { src: '/pics/hibachi-colorado-home.jpg', alt: (city) => `Private hibachi event in ${city}, MO`,             caption: 'St. Louis County hosts agree',      intro: (city) => `${city} hosts have high standards. Here's what they find:` },
    cta:         { src: '/pics/private-hibachi.jpg',       alt: (city) => `Private hibachi chef in ${city}, MO`,               caption: 'Your private dining event' },
  },
  { // Theme 3 — Ozarks Vacation
    testimonial: { src: '/pics/mobile-hibachi.jpg',        alt: (city) => `Ozarks lake house hibachi event near ${city}, MO`, caption: 'Ozarks vacation guests agree',      intro: (city) => `${city} vacation guests keep coming back. Here's why:` },
    cta:         { src: '/pics/hibachi-virginia-beach.jpg',alt: (city) => `Mobile hibachi chef near ${city}, MO`,              caption: 'The Ozarks lake house dinner' },
  },
  { // Theme 4 — University
    testimonial: { src: '/pics/hibachi-catering-2.jpg',    alt: (city) => `Graduation hibachi party in ${city}, MO`,          caption: 'Mid-Missouri hosts agree',          intro: (city) => `${city} hosts and families say it best:` },
    cta:         { src: '/pics/hibachi-colorado.jpg',      alt: (city) => `Private hibachi chef in ${city}, MO`,               caption: 'Your Mid-Missouri celebration' },
  },
  { // Theme 5 — Long-tail
    testimonial: { src: '/pics/backyard-hibachi-2.jpg',    alt: (city) => `Backyard hibachi event in ${city}, MO`,            caption: 'Southwest Missouri hosts agree',    intro: (city) => `${city} hosts say it best:` },
