...
const SC_HOW_IT_WORKS = [
  // Theme 0 — Charleston Historic Luxury
  {
    ...
    steps: [
      ...
      { num: '04', title: 'Live Cooking Performance',     desc: 'Guests gather on your patio or deck for 90–120 minutes of live hibachi — fire tricks, flying shrimp, freshly grilled food cooked to order.' },
  ...
  // Theme 1 — Upstate Corporate
  {
    ...
    steps: [
      ...
      { num: '02', title: 'Confirm Menu & Logistics',     desc: 'Choose your protein selections and confirm any dietary preferences. For groups over 25, we schedule two chef stations. All details locked in advance.' },
  ...
  // Theme 2 — Grand Strand Vacation
  {
    ...
    steps: [
      ...
      { num: '02', title: 'Pick Your Proteins',        desc: 'Choose your menu from the standard lineup or add premium upgrades. We confirm your rental address and lock in your booking.' },
      ...
      { num: '04', title: 'Beach House Dinner Show',   desc: 'Guests gather on your deck, patio, or yard for 90–120 minutes of live hibachi — fire tricks, grilled-to-order proteins, the full show.' },
      { num: '05', title: 'Pack-Out and Done',         desc: 'Chef handles complete cleanup and takes everything with them. Your rental is spotless and you had the best dinner of the summer.' },
    ],
  },
  // Theme 3 — Lowcountry Coastal
  {
    ...
    steps: [
      ...
      { num: '02', title: 'Select Your Menu',             desc: 'Choose proteins from the standard menu or premium upgrades (filet mignon, lobster tail, wagyu). Travel fees for remote properties confirmed upfront.' },
      { num: '03', title: 'Chef Travels to You',          desc: 'Your certified teppanyaki chef arrives with everything: teppan grill, propane, all fresh proteins, sauces, plates, and utensils.' },
      { num: '04', title: 'Lowcountry Live Fire Dining',  desc: 'Guests gather around the grill for 90–120 minutes of live hibachi cooking — fire tricks, custom proteins, fried rice, grilled vegetables.' },
      { num: '05', title: 'Full Cleanup, Nothing Left',   desc: 'Chef handles all teardown and cleanup. Your vacation property is spotless when they leave. You keep the memories.' },
    ],
  },
  // Theme 4 — Columbia Midlands
  {
    ...
    steps: [
      ...
      { num: '02', title: 'Confirm Your Menu',            desc: 'Select proteins and any premium upgrades. Confirm final guest count and outdoor space. Your event details are locked in.' },
  ...
  // Theme 5 — SC Suburban
  {
    ...
    steps: [
      ...
      { num: '02', title: 'Choose Your Menu',             desc: 'Pick your proteins from the standard lineup or upgrade to filet mignon, lobster tail, or Chilean sea bass. Menu locked in advance.' },
      { num: '03', title: 'Chef Arrives with Everything', desc: 'Certified chef arrives with full teppan grill, propane, all ingredients, sauces, plates, and chopsticks. No shopping required.' },
      { num: '04', title: 'The Performance Begins',       desc: 'Guests gather around the grill for a live teppanyaki show — fire tricks, fresh proteins cooked to order, fried rice and vegetables.' },
      { num: '05', title: 'Zero Cleanup for You',         desc: 'Chef packs everything out completely. You hosted the best dinner of the season and didn\'t touch a single dish.' },
    ],
  },
]
...
const SC_SUPPORT_IMAGES = {
  // Theme 0 — Charleston Historic Luxury
  'charleston': {
    testimonial: { src: '/pics/private-hibachi.jpg',       alt: () => `Private hibachi chef at a Charleston SC historic home`,    caption: 'Charleston private dining',          trustBadge: "South Carolina's Favorite Hibachi Experience", intro: () => `Charleston sets the standard for private entertaining in the Palmetto State — from Daniel Island dinner parties to Sullivan's Island bachelorette weekends, hosts here expect perfection. Our certified chefs arrive at your historic home or waterfront property with the full teppanyaki setup and handle every detail. Here's what Charleston hosts find when they book:` },
  ...
  'mount-pleasant': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',    alt: () => `Private hibachi dinner in Mount Pleasant, SC`,             caption: 'Mount Pleasant private dining',       trustBadge: 'Trusted by Local Families', intro: () => `Mount Pleasant's affluent families and waterfront entertainers have made private hibachi the go-to choice for backyard luxury on the Charleston side of the Cooper River. Our chefs travel to your home or Isle of Palms rental with zero setup stress and full cleanup included. Here's what Mount Pleasant hosts say every time:` },
  ...
  // Theme 1 — Upstate Corporate
  'greenville': {
    testimonial: { src: '/pics/hibachi-catering-3.jpg',    alt: () => `Corporate hibachi event in Greenville, SC`,               caption: 'Greenville corporate dining events',  trustBadge: 'Five-Star Entertainment & Dining', intro: () => `Greenville's booming food scene and growing corporate community have made it one of Upstate SC's top markets for private teppanyaki events — from Falls Park-area company dinners to rooftop birthday celebrations. Our chefs bring the full hibachi experience to your venue with restaurant-quality execution and live performance. Here's what Greenville clients keep telling us:` },
  ...
  'spartanburg': {
    testimonial: { src: '/pics/backyard-hibachi-2.jpg',    alt: () => `Backyard hibachi party in Spartanburg, SC`,               caption: 'Spartanburg backyard celebrations',   trustBadge: 'Hundreds of Private Events', intro: () => `Spartanburg families in the Upstate SC corridor know that private hibachi turns any backyard gathering into something worth talking about — whether it's a milestone birthday near Wofford College or a summer block party with the whole neighborhood. Our chefs travel to your home with all equipment and handle setup, cooking, and cleanup from start to finish. Here's what Spartanburg guests consistently say:` },
    cta:         { src: '/pics/hibachi-event.jpg',          alt: () => `Private hibachi chef at a Spartanburg SC event`,           caption: 'Your Spartanburg celebration' },
  },
  'simpsonville': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',    alt: () => `Backyard hibachi party in Simpsonville, SC`,              caption: 'Simpsonville backyard celebrations',  trustBadge: 'Highly Rated by Local Hosts', intro: () => `Simpsonville families in the Greenville metro have made private hibachi a signature way to celebrate — from graduation parties to neighborhood cookouts that needed a serious upgrade. Our certified chefs bring the full teppanyaki setup directly to your backyard and deliver a live-fire dining experience your guests won't stop talking about. Here's why Simpsonville hosts keep booking us:` },
  ...
  // Theme 2 — Grand Strand Vacation
  'myrtle-beach': {
    testimonial: { src: '/pics/hibachi-photo-2.jpg',       alt: () => `Bachelorette hibachi at a Myrtle Beach SC rental`,        caption: 'Myrtle Beach vacation rental hibachi', trustBadge: 'Thousands of Happy Guests', intro: () => `Myrtle Beach vacation rental groups and Grand Strand summer visitors choose private hibachi when they want the best dinner of the trip — without leaving the comfort of their beach house or condo. Our certified chefs travel to your rental with the full teppanyaki setup and zero cleanup required on your end. Here's why Myrtle Beach guests keep coming back every season:` },
  ...
  'north-myrtle-beach': {
    testimonial: { src: '/pics/hibachi-austin-2.jpg',      alt: () => `Birthday hibachi at a North Myrtle Beach SC rental`,      caption: 'North Myrtle Beach vacation hibachi',  trustBadge: 'Unforgettable Private Dining Experiences', intro: () => `North Myrtle Beach vacation groups — from bachelorette weekends to family reunion weeks on the Grand Strand — have discovered that private hibachi at the rental house beats any restaurant on the strip. Our mobile chefs arrive ready to cook, entertain, and leave your space spotless. Here's what Grand Strand guests say about the experience:` },
  ...
  // Theme 3 — Lowcountry Coastal
  'hilton-head-island': {
    testimonial: { src: '/pics/hibachi-dallas-home.jpg',   alt: () => `Golf group hibachi at a Hilton Head Island SC plantation`, caption: 'Hilton Head golf vacation dining',    trustBadge: '5.0 Average Rating', intro: () => `Hilton Head Island resort guests — golf groups, bachelorette weekends, and luxury vacation rental parties — have made private hibachi their go-to dinner upgrade when they want something beyond another restaurant reservation. Our certified chefs travel to your plantation villa or vacation rental with the complete teppanyaki experience and full cleanup included. Here's why Hilton Head guests keep booking us trip after trip:` },
  ...
  'bluffton': {
    testimonial: { src: '/pics/private-hibachi.jpg',       alt: () => `Private hibachi dinner in Bluffton, SC`,                  caption: 'Bluffton private dining events',      trustBadge: "South Carolina's Favorite Hibachi Experience", intro: () => `Bluffton's rapidly growing affluent community — nestled between Hilton Head Island and the Lowcountry marshes — has embraced private hibachi as the premier way to entertain outdoors in the Palmetto State. Our chefs bring the full teppanyaki setup to your backyard or golf community, delivering a dining experience worthy of the neighborhood. Here's what Bluffton hosts find:` },
  ...
  'pawleys-island': {
    testimonial: { src: '/pics/hibachi-austin-home.jpg',   alt: () => `Private hibachi at a Pawleys Island SC beach house`,      caption: 'Pawleys Island vacation home hibachi', trustBadge: 'Trusted by Local Families', intro: () => `Pawleys Island's upscale coastal retreat attracts vacation homeowners and guests who expect quiet luxury — and private hibachi at the beach house delivers exactly that, with our certified chefs handling everything from teppanyaki setup to post-dinner cleanup. Whether it's a reunion week or a milestone birthday on the Lowcountry coast, the experience speaks for itself. Here's why Pawleys Island hosts keep coming back every season:` },
  ...
  // Theme 4 — Columbia Midlands
  'columbia': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',    alt: () => `USC graduation hibachi party in Columbia, SC`,            caption: 'Columbia graduation season',          trustBadge: 'Hundreds of Private Events', intro: () => `Columbia families celebrating USC graduation season and Midlands professionals hosting client dinners have made private hibachi one of the most-requested party formats in the state capital. Our certified chefs bring the full teppanyaki experience to your backyard or event space, feeding the whole family and delivering a show that elevates any occasion. Here's why Columbia hosts keep coming back:` },
  ...
  'lexington': {
    testimonial: { src: '/pics/hibachi-dallas-home.jpg',   alt: () => `Backyard graduation party in Lexington, SC`,              caption: 'Lexington graduation celebrations',   trustBadge: 'Five-Star Entertainment & Dining', intro: () => `Lexington families on Lake Murray and throughout the growing Columbia suburb circuit have made private hibachi the celebration of choice — from backyard graduation parties to summer lakeside dinners that needed more than a standard cookout. Our chefs travel to your home with all the equipment and handle every detail so you can enjoy the moment. Here's what Lexington guests say:` },
    cta:         { src: '/pics/backyard-hibachi.jpg',       alt: () => `Backyard hibachi chef in Lexington, SC`,                   caption: 'Lexington\'s backyard party standard' },
  },
  'rock-hill': {
    testimonial: { src: '/pics/hibachi-shot-2.jpg',        alt: () => `Private hibachi dinner in Rock Hill, SC`,                 caption: 'Rock Hill private dining events',     trustBadge: 'Highly Rated by Local Hosts', intro: () => `Rock Hill and York County families — sitting squarely in the Charlotte metro corridor — have discovered that private hibachi delivers big-city dining experiences right in their own backyard without the drive across the state line. Our certified chefs serve the full teppanyaki setup at your home with showmanship, great food, and zero cleanup for the host. Here's what Rock Hill hosts consistently tell us:` },
    cta:         { src: '/pics/hibachi-catering-2.jpg',     alt: () => `Private hibachi chef in Rock Hill, SC`,                   caption: 'Your Rock Hill celebration' },
  },
  // Theme 5 — SC Suburban
  'summerville': {
    testimonial: { src: '/pics/hibachi-catering.jpg',      alt: () => `Graduation hibachi party in Summerville, SC`,             caption: 'Summerville graduation season',       trustBadge: 'Unforgettable Private Dining Experiences', intro: () => `Summerville's fast-growing community — including many military families from Joint Base Charleston — has embraced private hibachi as the go-to celebration format for graduation parties, homecomings, and everything in between. Our certified chefs travel to your Lowcountry suburb home and deliver a full teppanyaki experience with showmanship, restaurant-quality food, and complete cleanup. Here's what Summerville families say after every event:` },
...
const SC_SUPPORT_FALLBACKS = [
  // Theme 0 — Charleston Historic Luxury
  {
    testimonial: { src: '/pics/hibachi-catering.jpg',      alt: (city) => `Private hibachi event in ${city}, SC`,                caption: 'Charleston area hosts agree',         trustBadge: '5.0 Average Rating', intro: (city) => `${city} hosts in the Historic Charleston area know that private hibachi elevates any gathering — from bachelorette weekends to wedding-season dinner parties — with a live teppanyaki chef arriving fully equipped at your door. Our certified team handles setup, performance, and full cleanup so the host never lifts a finger. Here's what ${city} guests keep telling us after every event:` },
    cta:         { src: '/pics/hibachi-event.jpg',          alt: (city) => `Private hibachi chef in ${city}, SC`,                 caption: 'Your private Charleston evening' },
  },
  // Theme 1 — Upstate Corporate
  {
    testimonial: { src: '/pics/hibachi-event.jpg',         alt: (city) => `Corporate hibachi event in ${city}, SC`,              caption: 'Upstate SC hosts agree',              trustBadge: 'Thousands of Happy Guests', intro: (city) => `${city} professionals and families in Upstate SC have found that private hibachi is the most memorable way to host — whether it's a corporate client dinner or a milestone birthday celebration with the whole family around the grill. Our certified chefs travel to your home or venue with full teppanyaki equipment and bring the show directly to your event. Here's what ${city} hosts say about the experience:` },
    cta:         { src: '/pics/hibachi-chef-home.jpg',      alt: (city) => `Private hibachi chef in ${city}, SC`,                 caption: 'Your Upstate SC event, elevated' },
  },
  // Theme 2 — Grand Strand Vacation
  {
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg', alt: (city) => `Beach house hibachi in ${city}, SC`,                 caption: 'Grand Strand guests agree',           trustBadge: 'Unforgettable Private Dining Experiences', intro: (city) => `${city} vacation rental groups on the Grand Strand choose private hibachi when they want the best dinner of their trip without leaving the comfort of their beach house or condo. Our mobile chefs travel to your rental with the full teppanyaki setup and zero cleanup required — all you do is enjoy the show. Here's why Grand Strand guests keep booking us every summer:` },
    cta:         { src: '/pics/hibachi-photo-2.jpg',        alt: (city) => `Mobile hibachi chef in ${city}, SC`,                  caption: 'The Grand Strand dinner upgrade' },
  },
  // Theme 3 — Lowcountry Coastal
  {
    testimonial: { src: '/pics/hibachi-catering-3.jpg',    alt: (city) => `Vacation rental hibachi in ${city}, SC`,              caption: 'Lowcountry hosts agree',              trustBadge: 'Highly Rated by Local Hosts', intro: (city) => `${city} vacation guests and Lowcountry coastal hosts have made private hibachi the signature dinner upgrade for beach house rentals, marsh-view gatherings, and bachelorette weekends along the South Carolina coast. Our certified chefs arrive at your property fully equipped and deliver a live teppanyaki experience that outlasts any restaurant reservation. Here's what ${city} guests say every time:` },
    cta:         { src: '/pics/hibachi-catering.jpg',       alt: (city) => `Private hibachi chef in ${city}, SC`,                 caption: 'The Lowcountry coastal dinner' },
  },
  // Theme 4 — Columbia Midlands
  {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',    alt: (city) => `Family hibachi gathering in ${city}, SC`,             caption: 'Midlands families celebrate',         trustBadge: 'Trusted by Local Families', intro: (city) => `${city} families in the Midlands know how to mark a major occasion — and private hibachi has become the go-to choice for graduation parties, birthday milestones, and community gatherings throughout the Columbia metro area. Our chefs bring the full teppanyaki setup to your backyard and handle everything from fire-up to cleanup. Here's what ${city} families have to say:` },
    cta:         { src: '/pics/backyard-hibachi-2.jpg',     alt: (city) => `Private hibachi chef in ${city}, SC`,                 caption: 'Your Midlands celebration, elevated' },
  },
  // Theme 5 — SC Suburban
  {
    testimonial: { src: '/pics/hibachi-catering.jpg',      alt: (city) => `Backyard hibachi event in ${city}, SC`,               caption: 'Greater Charleston hosts agree',      trustBadge: 'Five-Star Entertainment & Dining', intro: (city) => `${city} families in the Greater Charleston suburban corridor have found that private hibachi transforms an ordinary backyard night into an unforgettable celebration — with a certified chef arriving fully equipped to cook, entertain, and clean up without any effort from the host. It's the kind of dinner experience that becomes the new standard for every party on the block. Here's what ${city} hosts say after their first booking:` },
