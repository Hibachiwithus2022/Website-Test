...
const SC_SECTION_VARIANTS = [
  // Theme 0 — Charleston Historic Luxury
  {
    ...
    experiencePoints:   [
      'No crowded restaurants — your historic property or vacation rental is the venue',
      'Certified teppanyaki chef performs exclusively for your group',
      'Perfect for bachelorette weekends, milestone birthdays, and rehearsal dinners',
  ...
  // Theme 1 — Upstate Corporate
  {
    ...
    experiencePoints:   [
      'No reservation battles — your outdoor space or corporate venue is the setting',
      'Certified teppanyaki chef for 90–120 minutes of live performance',
      'Perfect for Greenville-Spartanburg corporate events and team dinners',
  ...
  // Theme 2 — Grand Strand Vacation
  {
    ...
    experiencePoints:   [
      'Chef comes to your rental — no packed restaurant reservations on the strip',
      'All guests at the same outdoor table for the full show',
      'Fire tricks, live cooking, 90–120 minute performance',
      'Full setup and pack-out — vacation rental stays spotless',
    ],
  ...
  // Theme 3 — Lowcountry Coastal
  {
    ...
    experiencePoints:   [
      'Private chef comes to your golf villa, vacation rental, or Lowcountry home',
      'Premium proteins, live fire performance, full service',
      'Perfect for groups of 8–20 or larger family gatherings up to 60',
  ...
  // Theme 4 — Columbia Midlands
  {
    ...
    experiencePoints:   [
      'Dual-station capacity for USC graduation groups of 25–60+ guests',
  ...
  // Theme 5 — SC Suburban
  {
    ...
    experiencePoints:   [
      'No reservation required — your backyard is the venue',
