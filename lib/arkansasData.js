...
// Batch 2 (profileIdx 5–7): Little Rock, Conway, Benton
// Batch 3 (profileIdx 8–10): Hot Springs, Mountain Home, Russellville
// Batch 4 (profileIdx 11–12): Fort Smith, Jonesboro
//
...
const AR_TESTIMONIALS = {
  ...
  'little-rock': [
    {
      text:     "We hosted an executive dinner for eight colleagues at our Chenal Valley home and the experience was flawless. The chef arrived early, set up on the back terrace, and performed a two-hour dinner that generated more conversation than any restaurant event we've hosted. Our firm has already booked the next one.",
      name:     'Thomas G.',
      city:     'Little Rock, AR',
    ...
    {
      text:     "My son's medical school graduation coincided with every Little Rock restaurant being fully booked. We hosted 24 family members at our Heights neighborhood home and the evening was genuinely perfect — the food was exceptional, the chef's performance kept everyone at the table the entire time, and we didn't manage a single detail.",
      name:     'Linda A.',
      city:     'Little Rock, AR',
      event:    'Medical School Graduation Celebration',
      initials: 'LA',
    },
    {
      text:     "Used Hibachi Connect for a client entertainment dinner in West Little Rock — 16 guests, outdoor patio, the chef was completely professional and the food quality was outstanding. Three clients specifically commented it was the best corporate entertainment event they'd attended.",
      name:     'Brian F.',
      city:     'Little Rock, AR',
      event:    'Client Entertainment Dinner',
      initials: 'BF',
    },
  ],
  'conway': [
    {
      text:     "My daughter graduated from UCA and we wanted something special for the family — grandparents drove up from Pine Bluff, cousins came from Memphis. The private hibachi chef made the whole evening feel like a celebration worthy of the moment. No restaurant reservation stress, no time limits, just a perfect dinner at our house.",
      name:     'Sandra K.',
      city:     'Conway, AR',
      event:    'UCA Graduation Celebration',
      initials: 'SK',
    },
    {
      text:     "We've lived in Conway for three years and hosted plenty of backyard dinners, but nothing compared to what a private hibachi chef delivers. Twenty guests for my husband's 50th — the chef entertained the whole group, the food was excellent, and our neighbors are already asking how to book one.",
      name:     'Jennifer T.',
      city:     'Conway, AR',
    ...
    {
      text:     "Booked for a faculty retirement celebration — 18 guests, evening patio event. The chef was professional, punctual, and the presentation was genuinely impressive. Our colleague said it was the best retirement sendoff she'd ever seen. This is now our department's format for every major event.",
      name:     'Dr. Raymond P.',
      city:     'Conway, AR',
      event:    'Faculty Retirement Celebration',
      initials: 'RP',
    },
  ],
  'benton': [
    {
      text:     "Saline County doesn't have many options for a premium private event experience — Hibachi Connect filled that gap perfectly. We hosted my wife's milestone birthday for 22 people in our backyard and it was the best party we've thrown in fifteen years of hosting. Chef was excellent, cleanup was complete, and we barely lifted a finger.",
      name:     'Greg M.',
      city:     'Benton, AR',
      event:    'Milestone Birthday Celebration',
      initials: 'GM',
    ...
    {
      text:     "My daughter graduated from Bryant High this year and we wanted a celebration that matched the moment. Thirty guests at our Benton home, the chef set up in the backyard, and four generations of family spent two hours together around the same table. I couldn't have asked for a better graduation dinner.",
      name:     'Carla H.',
      city:     'Benton, AR',
      event:    'Graduation Party',
      initials: 'CH',
    ...
    {
      text:     "We recently moved to Benton from Little Rock and hosted a housewarming for our new neighborhood. The private hibachi chef was a complete hit — 14 neighbors, most of whom had never seen a teppanyaki performance at someone's home. We made a lot of new friends that evening.",
      name:     'Paul and Dana R.',
      city:     'Benton, AR',
      event:    'New Home Housewarming',
      initials: 'PR',
    },
  ],
  'hot-springs': [
    {
      text:     "We booked a private hibachi chef for eight people on our Lake Hamilton deck — bachelorette weekend for my sister's group. The chef set up on the dock deck, the sunset timing was perfect, and nobody wanted the evening to end. Every one of us agreed it was the best dinner of the entire trip. Way better than driving into Hot Springs and fighting for a table.",
      name:     'Brittany L.',
      city:     'Hot Springs, AR',
      event:    'Bachelorette Weekend Dinner',
      initials: 'BL',
    },
    {
      text:     "Family reunion at our Lake Ouachita cabin — 22 people across three generations. The chef arrived at the cabin, set up on the covered patio, and kept every single person — from my grandfather to my nephews — completely engaged for two hours. Best money we spent on the entire trip. Already planning to do it again next summer.",
      name:     'Robert C.',
      city:     'Hot Springs, AR',
      event:    'Family Reunion Dinner',
      initials: 'RC',
    ...
    {
      text:     "We do a guys' fishing weekend at our Hot Springs lake house every year. This year someone suggested we do the private hibachi chef instead of grilling ourselves and it was the best decision we've made in years. The chef was outstanding, the food was exceptional, and the whole group has already agreed it's becoming an annual tradition.",
      name:     'Mike T.',
      city:     'Hot Springs, AR',
      event:    'Lake House Group Dinner',
      initials: 'MT',
    },
  ],
  'mountain-home': [
    {
      text:     "We rented a cabin on Lake Norfork for a long reunion weekend — 14 cousins, spouses, and kids. The mobile hibachi chef was an absolute hit. He set up on the cabin deck, everyone gathered around the grill, and it became the highlight of the entire three-day trip. Highly recommend for any Twin Lakes group vacation.",
      name:     'Sandra K.',
      city:     'Mountain Home, AR',
      event:    'Lake Norfork Cabin Reunion',
      initials: 'SK',
    },
    {
      text:     "My wife's 50th birthday party at our Bull Shoals Lake cabin had 16 guests. The hibachi chef drove all the way to Mountain Home and I was nervous about logistics, but it was completely seamless. Chef arrived on time, full setup on the back deck, incredible performance, and full cleanup. My wife said it was the best birthday she's had.",
      name:     'David H.',
      city:     'Mountain Home, AR',
      event:    '50th Birthday at the Lake',
      initials: 'DH',
    },
    {
      text:     "We had 12 friends at a Lake Bull Shoals rental house and booked the private hibachi for our last night. It was the send-off the whole trip deserved. The food was legitimately excellent and the chef was one of the best we've seen anywhere. Twin Lakes vacation groups — do this. You will not regret it.",
      name:     'Amy P.',
      city:     'Mountain Home, AR',
      event:    'Lake House Weekend Finale',
      initials: 'AP',
    },
  ],
  'russellville': [
    {
      text:     "We hosted our daughter's Arkansas Tech graduation party at our Lake Dardanelle cabin — 20 family members from three states. The hibachi chef was absolutely perfect. He set up on the screened porch, the view of the lake behind him was incredible, and the performance kept every guest at the table the entire evening. We could not have planned a better graduation dinner.",
      name:     'Patricia G.',
      city:     'Russellville, AR',
      event:    'ATU Graduation Celebration',
      initials: 'PG',
    },
    {
      text:     "Our River Valley business team of 16 celebrated a record quarter at a colleague's home in Russellville. Hibachi Connect was a new experience for half the team and by the end of the night everyone agreed it was the best team event we've done. The food was excellent, the chef was professional and entertaining, and the full cleanup was genuinely appreciated.",
      name:     'Kevin M.',
      city:     'Russellville, AR',
    ...
    {
      text:     "Twenty family members for my parents' anniversary at our Russellville home — the private hibachi chef turned the backyard into something special. The kids watched every move the chef made, the adults had the best conversation of any family dinner in years, and the food was legitimately restaurant-quality. Will be doing this for every major family event going forward.",
      name:     'Laura D.',
      city:     'Russellville, AR',
  ...
  'fort-smith': [
    {
      text:     "We hired Hibachi Connect for our Fort Smith manufacturing team's end-of-year celebration — 24 people at a manager's home in Greenwood. The chef was completely professional, the food was excellent, and the performance kept the entire group engaged for nearly two hours. Two team members said it was the best corporate event they'd attended in their careers.",
      name:     'Tim B.',
      city:     'Fort Smith, AR',
      event:    'Corporate Team Dinner',
      initials: 'TB',
    ...
    {
      text:     "My daughter's high school graduation had 28 guests — grandparents from Texas, cousins from Oklahoma, the whole extended River Valley family. Every Fort Smith restaurant was fully booked and I was out of ideas until I found Hibachi Connect. The private chef at our home was not only the practical solution — it was by far the best graduation dinner we've ever done.",
      name:     'Connie R.',
      city:     'Fort Smith, AR',
      event:    'High School Graduation Celebration',
      initials: 'CR',
    },
    {
      text:     "We hosted a birthday party for my husband's 60th at our home near Lake Fort Smith — 22 friends and family. The hibachi chef was outstanding from start to finish. Arrived early, set up quickly, the performance was genuinely impressive, and the food was exceptional. Every guest asked for the contact information before they left.",
      name:     'Diane W.',
      city:     'Fort Smith, AR',
  ...
  'jonesboro': [
    {
      text:     "We hosted an Arkansas State graduation party for our son at our home — 25 guests from across Northeast Arkansas and Tennessee. Every restaurant in Jonesboro had a weeks-long wait for large parties around graduation. The private hibachi chef was the solution I didn't know existed, and it turned into the best graduation dinner our family has ever hosted.",
      name:     'Brenda F.',
      city:     'Jonesboro, AR',
      event:    'A-State Graduation Party',
      initials: 'BF',
    },
    {
      text:     "Our Northeast Arkansas sales team of 18 celebrated a strong quarter at a colleague's home in Jonesboro. Everyone expected a standard backyard gathering — what they got was a full professional hibachi experience. The chef was exceptional, the food was outstanding, and the whole evening ended with the group already asking when we're doing it again.",
      name:     'Mark S.',
      city:     'Jonesboro, AR',
      event:    'Sales Team Celebration',
      initials: 'MS',
    },
    {
      text:     "My wife's 40th birthday had 20 of our closest Jonesboro friends in our backyard. The hibachi chef made the entire evening. Kids loved watching every move, adults couldn't stop talking about the food, and the full setup and cleanup meant I could actually be present the whole time instead of managing logistics. Best party we've hosted.",
      name:     'Chris E.',
      city:     'Jonesboro, AR',
...
const AR_CITY_IMAGE_MAP = {
  ...
  // ── Batch 2 ──────────────────────────────────────────────────────────────────
  'little-rock':   { src: '/pics/hibachi-home-2.jpg',            alt: (city) => `Private hibachi chef at a Little Rock, AR home` },
  'conway':        { src: '/pics/hero-1.jpg',                    alt: (city) => `Hibachi at home event in Conway, AR` },
  'benton':        { src: '/pics/hibachi-austin-home.jpg',       alt: (city) => `Hibachi at home in Benton, AR` },
...
const AR_SUPPORT_IMAGES = {
  ...
  'little-rock': {
    testimonial: {
      src:        '/pics/hibachi-shot-1.jpg',
      alt:        (city) => `Private hibachi chef at a Little Rock, AR executive home`,
      caption:    'Little Rock professional and executive entertaining',
      trustBadge: 'Trusted by Little Rock Professionals',
      intro:      (city) => `Little Rock's professional community — Chenal Valley executives, Pleasant Valley healthcare leaders, and Heights neighborhood families — hosts events where quality is expected, not hoped for. Private hibachi delivers that standard directly to your outdoor space. Here's what Little Rock hosts have experienced:`,
    },
    cta: {
      src:     '/pics/private-party-chef-6.jpg',
      alt:     (city) => `Private hibachi chef ready for a Little Rock, AR event`,
      caption: 'The Little Rock professional entertaining format',
    },
  },
  'conway': {
    testimonial: {
      src:        '/pics/mobile-hibachi.jpg',
      alt:        (city) => `Hibachi at home celebration in Conway, AR`,
      caption:    'Conway graduation and family events',
      trustBadge: 'Trusted by Conway Families',
      intro:      (city) => `Conway families — UCA graduation hosts, Hendrix College families, and suburban Conway households — have discovered that private hibachi solves the graduation-weekend restaurant problem while delivering the best group dinner format in Central Arkansas. Here's what Conway hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-event.jpg',
      alt:     (city) => `Private hibachi chef at a Conway, AR home`,
      caption: 'The Conway graduation celebration format',
    },
  },
  'benton': {
    testimonial: {
      src:        '/pics/backyard-hibachi-3.jpg',
      alt:        (city) => `Backyard hibachi party in Benton, AR`,
      caption:    'Benton and Saline County celebrations',
      trustBadge: 'Trusted by Saline County Hosts',
      intro:      (city) => `Benton and Saline County families have found that private hibachi fits their entertaining style better than any local restaurant: larger guest lists, outdoor space restaurants can't match, and a format that keeps every generation at the same table for the entire evening. See what Benton hosts have found:`,
    },
    cta: {
      src:     '/pics/hero-1.jpg',
      alt:     (city) => `Private hibachi chef at a Benton, AR backyard event`,
      caption: 'The Benton family celebration format',
    },
  },
  'hot-springs': {
    testimonial: {
      src:        '/pics/hibachi-raleigh.jpg',
      alt:        (city) => `Private hibachi chef at a ${city} area lake house or vacation rental`,
      caption:    'Hot Springs lake house and vacation group events',
      trustBadge: 'Trusted by Hot Springs Vacation Hosts',
      intro:      (city) => `Hot Springs vacation groups — Lake Hamilton bachelorette weekends, Lake Ouachita family reunions, and cabin trip send-offs — have all found the same answer: a private hibachi chef at your rental property delivers more than any lakefront restaurant can. See what ${city} hosts are saying:`,
    },
    cta: { src: '/pics/hero-1.jpg', alt: (city) => `Private hibachi chef setup at a ${city} lake house`, caption: 'The Hot Springs lake vacation upgrade' },
  },
  'mountain-home': {
    testimonial: {
      src:        '/pics/hibachi-wilmington.jpg',
      alt:        (city) => `Mobile hibachi chef at a Twin Lakes cabin near ${city}, AR`,
      caption:    'Mountain Home Twin Lakes cabin and vacation events',
      trustBadge: 'Trusted by Twin Lakes Vacation Groups',
      intro:      (city) => `Twin Lakes vacation groups at Mountain Home — Lake Norfork and Lake Bull Shoals cabin weekends, reunion trips, and milestone celebrations — have found that a mobile hibachi chef is the best possible upgrade for any group's lake stay. Here's what they're saying:`,
    },
    cta: { src: '/pics/hibachi-event.jpg', alt: (city) => `Mobile hibachi chef at a ${city} area lake cabin`, caption: 'The Twin Lakes vacation group dinner' },
  },
  'russellville': {
    testimonial: {
      src:        '/pics/hibachi-colorado.jpg',
      alt:        (city) => `Private hibachi at a ${city} home or Lake Dardanelle property`,
      caption:    'Russellville ATU graduation and River Valley events',
      trustBadge: 'Trusted by Russellville Hosts',
      intro:      (city) => `Russellville hosts — ATU graduation families, Lake Dardanelle cabin groups, and Arkansas River Valley corporate teams — have found that private hibachi at home or at the lake delivers an experience no local restaurant can match. Here's what ${city} hosts are saying:`,
    },
    cta: { src: '/pics/hero-3.jpg', alt: (city) => `Private hibachi chef at a ${city} area home or lake property`, caption: 'The Russellville private chef format' },
  },
  'fort-smith': {
    testimonial: {
      src:        '/pics/hibachi-virginia-beach.jpg',
      alt:        (city) => `Private hibachi catering at a ${city}, AR home or corporate venue`,
      caption:    'Fort Smith River Valley corporate and family events',
      trustBadge: 'Trusted by Fort Smith Hosts',
      intro:      (city) => `Fort Smith and the River Valley business community — manufacturing teams, healthcare professionals, and Arkansas-Oklahoma corridor families — have found private hibachi to be the most memorable format for any group event that matters. Here's what ${city} hosts are saying:`,
    },
    cta: { src: '/pics/hibachi-philadelphia.jpg', alt: (city) => `Private hibachi chef at a ${city}, AR home`, caption: 'The Fort Smith private chef format' },
  },
  'jonesboro': {
    testimonial: {
      src:        '/pics/hibachi-hart.jpg',
      alt:        (city) => `Hibachi at home in ${city}, AR`,
      caption:    'Jonesboro A-State graduation and Northeast Arkansas events',
      trustBadge: 'Trusted by Jonesboro Hosts',
      intro:      (city) => `Jonesboro families — Arkansas State graduation hosts, Northeast Arkansas corporate teams, and milestone celebration organizers — have discovered that private hibachi is the one format that handles any size event better than any local restaurant. Here's what ${city} hosts are saying:`,
    },
    cta: { src: '/pics/backyard-hibachi-3.jpg', alt: (city) => `Private hibachi chef at a ${city}, AR home`, caption: 'The Jonesboro private chef format' },
  },
}
...
export const AR_CITY_INTROS = [
  ...
  // 689 — Little Rock
  {
    headline: () => `Little Rock's Executive and Professional Households Have Found a Better Way to Celebrate`,
    opening:  () => `Chenal Valley, Pleasant Valley, and The Heights are home to Little Rock's most accomplished residents — physicians, attorneys, corporate executives, and government professionals who host events where the quality of the experience matters. When the guest list includes professional colleagues and the occasion warrants genuine quality, a private hibachi chef arrives at your home and turns your outdoor space into the evening's venue.`,
    middle:   () => `Private hibachi works equally well for Little Rock's personal milestones. Graduation season — when UALR, UAMS, and local high school ceremonies fill every restaurant table for weeks — becomes manageable when the chef comes to you. Medical school graduations, law school celebrations, and landmark family birthdays all find a better home in a Chenal Valley backyard than at a reservation you had to book months in advance.`,
    closing:  () => `We serve Little Rock, North Little Rock, Conway, Benton, Bryant, Maumelle, and all of Central Arkansas. Little Rock graduation season dates book early — call ahead for May and May weekend availability.`,
  },
  // 690 — Conway
  {
    headline: () => `Three Universities, One Celebration Format That Works for Every Conway Graduation`,
    opening:  () => `Conway is the only city in Arkansas home to three universities on the same academic calendar — University of Central Arkansas, Hendrix College, and Central Baptist College. Every May, families travel from across the state to Conway for graduation weekend. The challenge they all face is the same: Conway's best tables are fully reserved weeks before commencement, and finding a format that works for 20 grandparents, aunts, cousins, and visiting friends at a single table is nearly impossible at a restaurant.`,
    middle:   () => `Private hibachi solves the Conway graduation problem cleanly. Your chef arrives at your Conway home before guests do, sets up completely on your backyard patio, and performs the full teppanyaki dinner for your entire group at once. No splitting into two tables. No waiting for seating. No watching half the family celebrate separately. One chef, one grill, every guest at the same experience for 90–120 minutes.`,
    closing:  () => `We serve Conway, Little Rock, Benton, Russellville, and all of Central Arkansas. UCA and Hendrix graduation season books quickly — secure your May date early.`,
  },
  // 691 — Benton
  {
    headline: () => `Saline County Families Celebrate Bigger Than Any Local Restaurant Can Handle`,
    opening:  () => `Benton and the broader Saline County community have grown fast enough that the local restaurant landscape can't keep pace with what residents expect for their milestone events. Graduation parties for 25 or 30 people, milestone birthday celebrations for extended families, and housewarming dinners for neighbors in the county's newest subdivisions all share the same problem: there's no restaurant format that works for a group that large without splitting tables and limiting conversation.`,
    middle:   () => `Private hibachi is built for exactly that. Your chef arrives at your Benton home with the complete self-contained setup, positions the teppan grill in your backyard or on your patio, and cooks for every guest individually — proteins chosen per person, cooked live in front of the group. The format scales naturally from 10 guests to 30, keeps everyone at the same table for 90–120 minutes, and handles the cleanup completely when dinner ends.`,
    closing:  () => `We serve Benton, Little Rock, Conway, Bryant, Hot Springs, and all of Saline County. Summer and graduation season dates book quickly — confirm your event early.`,
  },
  // 692 — Hot Springs
  {
    headline: () => `Hot Springs Vacation Groups Have Found Their Private Dining Upgrade`,
    opening:  () => `Hot Springs sits at the intersection of two completely different guest markets — the local Garland County community hosting milestone celebrations, and the much larger vacation group market that flows into Lake Hamilton, Lake Ouachita, and Lake Catherine every week of the summer. Both markets share the same limitation: the lakefront dining scene in Hot Springs simply wasn't built to handle groups of 14 to 25 people who want to stay together for two hours without a time limit.`,
    middle:   () => `Private hibachi solves the problem for both. A private chef travels to your Lake Hamilton vacation rental, your Ouachita cabin, or your Hot Springs home — sets up the complete self-contained teppan grill wherever your group is gathered — and performs 90–120 minutes of live teppanyaki without any of the constraints a restaurant puts on a large group. Bachelorette weekends, family reunion trips, and bachelor lake weekends have all discovered that this is the one experience that becomes the defining memory of the entire vacation.`,
    closing:  () => `We serve Hot Springs, Lake Hamilton, Lake Ouachita, Lake Catherine, Benton, Malvern, and all of Garland and surrounding counties. Summer lake season books fast — secure your date early.`,
  },
  // 693 — Mountain Home
  {
    headline: () => `Twin Lakes Vacation Groups Have Found the One Dinner Worth Planning Around`,
    opening:  () => `Mountain Home and the Twin Lakes area — Lake Norfork and Lake Bull Shoals — attract vacation groups from across Arkansas, Missouri, Oklahoma, and Tennessee. Reunion weekends, retirement celebration trips, family cabin weekends, and fishing retreat groups all converge on the same stretch of the Ozarks. And they all face the same challenge: the dining scene around the Twin Lakes area was not designed for large groups who want a special dinner experience without driving 45 minutes into a bigger city.`,
    middle:   () => `A mobile hibachi chef changes that equation entirely. Your chef travels to your Mountain Home-area cabin, sets up completely on the deck or patio, and performs the full teppanyaki experience — fire tricks, live cooking, premium proteins cooked per person — for your entire group without requiring kitchen access or a gas hookup. The cabin deck becomes the restaurant. The vacation becomes something the group talks about for years.`,
    closing:  () => `We serve Mountain Home, Lake Norfork, Lake Bull Shoals, Bull Shoals State Park, Yellville, and all of Baxter and Marion County. Summer and peak foliage season dates book ahead — confirm your Twin Lakes date early.`,
  },
  // 694 — Russellville
  {
    headline: () => `Arkansas Tech Graduation and Lake Dardanelle Groups Have Found Their Format`,
    opening:  () => `Russellville occupies a useful position in the Arkansas landscape: it's the home of Arkansas Tech University, so it generates a concentrated graduation event season every May; it sits on Lake Dardanelle, so it attracts vacation cabin and lake house groups throughout the summer; and it sits at the midpoint between Fort Smith and Little Rock, making it a natural gathering point for Central Arkansas families and River Valley corporate groups. All of these event types share one problem — the Russellville restaurant landscape wasn't built for them at scale.`,
    middle:   () => `Private hibachi is. An ATU graduation party for 22 people doesn't need a restaurant table — it needs a chef who comes to your Russellville home, sets up on your patio, and performs the full dinner for every guest at once. A Lake Dardanelle cabin group doesn't need to drive 40 minutes each way — it needs a mobile chef who arrives at the cabin with the complete self-contained setup. The River Valley corporate team celebrating a good quarter doesn't need a restaurant that seats strangers next to your clients — it needs an exclusive experience at someone's home.`,
    closing:  () => `We serve Russellville, Lake Dardanelle, Clarksville, Morrilton, and all of Pope and Yell County. ATU graduation season and summer lake season book quickly — confirm your date early.`,
  },
  // 695 — Fort Smith
  {
    headline: () => `Fort Smith and the River Valley Have Their Private Hibachi Chef Format`,
    opening:  () => `Fort Smith is the second-largest city in Arkansas and the economic anchor of the River Valley region — a market that includes manufacturing operations, healthcare systems, logistics companies, and a long-established professional community that straddles the Arkansas-Oklahoma line. The event culture here is built around corporate team dinners, graduate celebrations from Westark and the University of Arkansas-Fort Smith, and multi-generational family gatherings for the extended families that have been in Sebastian County for generations. What the city hasn't historically offered is a private hibachi chef who brings the full teppanyaki experience to your home.`,
    middle:   () => `That changes now. We serve Fort Smith and the River Valley with the same fully self-contained private hibachi experience available in Little Rock and Bentonville — your chef arrives at your Fort Smith home with the complete propane grill setup, all ingredients, and every piece of equipment. No kitchen access required. No gas hookup needed. The event performs on your backyard patio, your covered outdoor space, or any outdoor venue that can hold your group, and the chef handles setup and cleanup from start to finish.`,
    closing:  () => `We serve Fort Smith, Greenwood, Van Buren, Alma, Sallisaw, and the full Arkansas-Oklahoma River Valley. Graduation season and summer corporate event season book ahead — confirm your Fort Smith date early.`,
  },
  // 696 — Jonesboro
  {
    headline: () => `Arkansas State Graduation and Northeast Arkansas Families Have Found Their Private Chef Format`,
    opening:  () => `Jonesboro is Northeast Arkansas's largest city and home to Arkansas State University's flagship campus — which means every May, the city is flooded with graduation families from across the region: Memphis suburbs, the Missouri Bootheel, and rural Arkansas communities where a son or daughter graduating from A-State is one of the most significant milestones the family will celebrate for years. Every Jonesboro restaurant knows this week. Reservations are gone for weeks in advance. Large group tables simply aren't available.`,
    middle:   () => `Private hibachi is the format that graduation families in Jonesboro have been missing. Your chef arrives at your Jonesboro home before your guests do, sets up completely on your patio or backyard, and performs the full teppanyaki dinner for every guest at once — grandparents from rural Arkansas, cousins from Memphis, and the graduate's closest friends all at the same table for 90–120 uninterrupted minutes. Beyond graduation season, the Jonesboro business community — regional healthcare systems, agricultural operations, and Northeast Arkansas professional services — uses the format for corporate team events that warrant something more than a crowded restaurant.`,
    closing:  () => `We serve Jonesboro, West Memphis, Paragould, Blytheville, Searcy, and all of Craighead, Greene, and Mississippi County. A-State graduation season and summer dates book ahead — confirm your Jonesboro event early.`,
  },
]
...
export const AR_CITY_CLOSINGS = [
  ...
  // 689 — Little Rock
  {
    headline:     (city) => `Book Your Little Rock Private Hibachi Event`,
    sub:          (city) => `Chenal Valley executive dinners, graduation celebrations, and milestone family events — your private chef comes to you across the Little Rock area`,
    urgency:      'UALR and UAMS graduation season fills weeks in advance — confirm your Little Rock date today.',
    btnPrimary:   'Book Now',
    btnSecondary: 'Get a Quote',
  },
  // 690 — Conway
  {
    headline:     (city) => `Book Your Conway Private Hibachi Event`,
    sub:          (city) => `UCA graduation weekends, family milestones, and Conway suburban celebrations — your private chef arrives fully equipped`,
    urgency:      'UCA and Hendrix graduation season books out early — secure your Conway May date now.',
    btnPrimary:   'Book Now',
    btnSecondary: 'Get a Quote',
  },
  // 691 — Benton
  {
    headline:     (city) => `Book Your Benton Private Hibachi Event`,
    sub:          (city) => `Saline County graduation parties, milestone birthdays, and backyard family events — your private hibachi chef arrives fully set up`,
    urgency:      'Summer and graduation season dates in Benton book quickly — confirm your event today.',
    btnPrimary:   'Book Now',
    btnSecondary: 'Get a Quote',
  },
  // 692 — Hot Springs
  {
    headline:     (city) => `Book Your Hot Springs Lake House Chef`,
    sub:          (city) => `Lake Hamilton vacation rentals, Lake Ouachita cabins, and Hot Springs resort properties — your private hibachi chef arrives fully equipped`,
    urgency:      'Summer lake season books fast — lock your Hot Springs date before it\'s gone.',
    btnPrimary:   'Book Now',
    btnSecondary: 'Get a Quote',
  },
  // 693 — Mountain Home
  {
    headline:     (city) => `Book Your Twin Lakes Private Hibachi Chef`,
    sub:          (city) => `Lake Norfork and Lake Bull Shoals cabin weekends — your mobile hibachi chef sets up wherever your group is staying`,
    urgency:      'Summer and fall foliage season dates at Twin Lakes fill early — confirm your Mountain Home date today.',
    btnPrimary:   'Book Now',
    btnSecondary: 'Get a Quote',
  },
  // 694 — Russellville
  {
    headline:     (city) => `Book Your Russellville Private Hibachi Event`,
    sub:          (city) => `ATU graduation parties, Lake Dardanelle cabin groups, and River Valley milestones — your private chef comes to you`,
    urgency:      'ATU graduation season and summer lake dates fill quickly — confirm your Russellville event today.',
    btnPrimary:   'Book Now',
    btnSecondary: 'Get a Quote',
  },
  // 695 — Fort Smith
  {
    headline:     (city) => `Book Your Fort Smith Private Hibachi Event`,
    sub:          (city) => `River Valley corporate team dinners, UAFS graduation parties, and Fort Smith family milestones — your private chef arrives fully set up`,
    urgency:      'Graduation season and summer dates in Fort Smith book ahead — confirm your event today.',
    btnPrimary:   'Book Now',
    btnSecondary: 'Get a Quote',
  },
  // 696 — Jonesboro
  {
    headline:     (city) => `Book Your Jonesboro Private Hibachi Event`,
    sub:          (city) => `A-State graduation weekends, Northeast Arkansas corporate events, and family milestones — your private chef comes to your Jonesboro home`,
    urgency:      'Arkansas State graduation season books early — secure your Jonesboro May date today.',
    btnPrimary:   'Book Now',
    btnSecondary: 'Get a Quote',
  },
]
...
export const AR_BLOG_POSTS = [
  // Slot 0 — v%3=0: Bentonville, Rogers, Hot Springs, Mountain Home, Russellville
  [
    { slug: 'hibachi-at-home-arkansas-guide',            title: 'Private Hibachi Chef in Arkansas: The Complete Guide to All Five Markets',           excerpt: 'From Bentonville corporate entertaining and Fayetteville graduation weekends to Hot Springs lake house groups and Fort Smith regional milestones — how private hibachi works across Arkansas.', category: 'Guide', readTime: '10 min read' },
    { slug: 'private-hibachi-arkansas-lake-house',       title: 'Private Hibachi at an Arkansas Lake House: Hot Springs, Twin Lakes, and Lake Dardanelle', excerpt: 'How to book a private hibachi chef at your Arkansas lake cabin or vacation rental — Lake Hamilton, Lake Norfork, Lake Bull Shoals, and Lake Dardanelle.', category: 'Guide', readTime: '8 min read' },
    { slug: 'private-hibachi-arkansas-graduation-party', title: 'Private Hibachi for Arkansas Graduation Parties: UA, UCA, ATU, A-State, and NWA High Schools', excerpt: 'When to book and what to expect for graduation season in Fayetteville, Conway, Russellville, Jonesboro, and Northwest Arkansas.', category: 'Guide', readTime: '8 min read' },
  ],
  // Slot 1 — v%3=1: Fayetteville, Springdale, Bella Vista, Fort Smith, Jonesboro
  [
    { slug: 'hibachi-at-home-arkansas-guide',            title: 'Private Hibachi Chef in Arkansas: The Complete Guide to All Five Markets',           excerpt: 'From NWA graduation weekends and Fayetteville University of Arkansas commencement to Fort Smith River Valley corporate events and Jonesboro A-State graduation parties.', category: 'Guide', readTime: '10 min read' },
    { slug: 'private-hibachi-arkansas-graduation-party', title: 'Private Hibachi for Arkansas Graduation Parties: UA, UCA, ATU, A-State, and NWA High Schools', excerpt: 'Everything you need to know about booking a private hibachi chef for graduation season in Fayetteville, Fort Smith, Jonesboro, and Northwest Arkansas high school commencements.', category: 'Guide', readTime: '8 min read' },
    { slug: 'hibachi-catering-corporate-events',         title: 'Why Hibachi Catering Is the Best Choice for Corporate Events',                       excerpt: 'Fort Smith manufacturing teams, Jonesboro regional businesses, and NWA corporate events — why private hibachi beats every other corporate event format.', category: 'Guide', readTime: '5 min read' },
  ],
  // Slot 2 — v%3=2: Little Rock, Conway, Benton
  [
    { slug: 'hibachi-at-home-arkansas-guide',            title: 'Private Hibachi Chef in Arkansas: The Complete Guide to All Five Markets',           excerpt: 'From Little Rock professional households and Conway university graduation weekends to Benton Saline County family milestones and Hot Springs lake house events across Arkansas.', category: 'Guide', readTime: '10 min read' },
    { slug: 'private-hibachi-arkansas-graduation-party', title: 'Private Hibachi for Arkansas Graduation Parties: UCA, UA, ATU, A-State, and NWA High Schools', excerpt: 'UCA Conway graduation, Little Rock private school commencements, and graduation season across Central Arkansas — when to book and what to expect.', category: 'Guide', readTime: '8 min read' },
    { slug: 'hibachi-at-home-vs-restaurant',             title: 'Hibachi at Home vs. Restaurant: Which Is Worth It?',                                excerpt: 'Little Rock and Central Arkansas hibachi restaurants vs. a private chef at your home — the real cost, quality, and convenience comparison.', category: 'Guide', readTime: '5 min read' },
  ],
]
