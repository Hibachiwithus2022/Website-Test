...
const ON_SECTION_VARIANTS = [
  // Theme 0 — Toronto Urban Core
  {
    ...
    experiencePoints:   [
      'No restaurant reservations — your condo terrace, backyard, or patio is the venue',
      'Certified teppanyaki chef performs exclusively for your group',
      'Perfect for Toronto bachelorette weekends, milestone birthdays, and corporate dinners',
      'Full setup, complete cleanup — nothing for the host to manage',
    ],
  ...
  // Theme 1 — GTA Affluent Suburbs
  {
    ...
    experiencePoints:   [
      'No restaurant logistics — your estate backyard or patio is the venue',
      'Certified teppanyaki chef for milestone birthdays, family reunions, and corporate events',
      'Premium proteins including filet mignon and lobster tail available',
  ...
  // Theme 2 — GTA Family & Community
  {
    ...
    experiencePoints:   [
      'Dual-station capacity for graduation groups of 25–60+ guests',
      'Kids, parents, and grandparents all around the same grill',
      'Fresh proteins, full performance, no restaurant logistics',
      'Setup and cleanup included — nothing for the host to manage',
    ],
  ...
  // Theme 3 — Cottage Country & Resort
  {
    ...
    experiencePoints:   [
      'Private chef travels to your cottage, chalet, or lakefront property',
      'Perfect for Victoria Day, Canada Day, and Labour Day long weekends',
      'Fire tricks, live cooking, 90–120 minute performance at your property',
      'Full setup and pack-out — cottage property stays spotless',
    ],
  ...
  // Theme 4 — Niagara Tourism
  {
    ...
    experiencePoints:   [
      'Chef comes to your rental — no packed tourist strip reservations',
      'Perfect for honeymoon dinners, bachelorette weekends, and anniversary getaways',
      'Fire tricks, live cooking, 90–120 minute performance',
      'Full setup and pack-out — vacation property stays spotless',
    ],
  ...
  // Theme 5 — University & Corporate
  {
    ...
    experiencePoints:   [
      'No reservation required — your outdoor venue or backyard is the setting',
      'Certified teppanyaki performance for 90–120 minutes',
      'Dual-station capacity for graduation groups and corporate events of 25–60+',
  ...
  // Theme 6 — Luxury Cottage
  {
    ...
    experiencePoints:   [
      'Private chef travels to your estate cottage, lakefront retreat, or luxury property',
      'Premium proteins — filet mignon, lobster tail, scallops — for the occasion it deserves',
      'Full live fire performance designed around your group',
      'Flawless setup and complete cleanup — your property is immaculate when the chef departs',
    ],
