...
const ON_SECTION_VARIANTS = [
  // Theme 0 — Toronto Urban Core
  {
    ...
    experiencePoints:   [
      { icon: '🏙️', title: 'Your Terrace or Patio Is the Venue', desc: 'No restaurant reservations — your condo terrace, backyard, or patio becomes an exclusive private dining room for your group.' },
      ...
      { icon: '🧹', title: 'Setup & Cleanup Included',            desc: 'Full setup, full service, and complete cleanup. Nothing for the host to manage from arrival to departure.' },
    ],
  ...
  // Theme 1 — GTA Affluent Suburbs
  {
    ...
    experiencePoints:   [
      { icon: '🏡', title: 'Your Estate Space Is the Venue',     desc: 'No restaurant logistics — your estate backyard or terrace becomes an exclusive private dining room for the evening.' },
      { icon: '👨‍🍳', title: 'Private Chef for Every Occasion',   desc: 'A certified teppanyaki chef for milestone birthdays, family reunions, and corporate events — scaled to your group.' },
      { icon: '🥩', title: 'Premium Proteins Available',         desc: 'Filet mignon, lobster tail, and full premium menu options — customize the experience to match the occasion.' },
      { icon: '🧹', title: 'Setup & Cleanup Included',          desc: 'Full setup before the event and complete cleanup after. Nothing for the host to manage.' },
    ],
  ...
  // Theme 2 — GTA Family & Community
  {
    ...
    experiencePoints:   [
      { icon: '👥', title: 'Dual Stations for Large Groups',     desc: 'Two chef stations for graduation groups of 25–60+ — faster service and double the performance energy.' },
      { icon: '👨‍👩‍👧‍👦', title: 'The Whole Family Around the Grill', desc: 'Kids, parents, and grandparents all gathered at the same teppan — multi-generational appeal that few formats can match.' },
  ...
  // Theme 3 — Cottage Country & Resort
  {
    ...
    experiencePoints:   [
      { icon: '🏕️', title: 'Chef at Your Cottage or Chalet',    desc: 'A certified private hibachi chef travels to your cottage, chalet, or lakefront property — no logistics for you to handle.' },
      { icon: '🍁', title: 'Built for Ontario Long Weekends',    desc: 'Victoria Day, Canada Day, and Labour Day — the Ontario cottage calendar\'s most in-demand dates, handled perfectly.' },
      { icon: '🔥', title: 'Fire Tricks & Live Cooking',         desc: '90–120 minutes of live teppanyaki entertainment — fire tricks, proteins cooked to order, right on your cottage deck.' },
  ...
  // Theme 4 — Niagara Tourism
  {
    ...
    experiencePoints:   [
      { icon: '🏖️', title: 'Chef Comes to Your Rental',         desc: 'No packed tourist strip reservations — your chef arrives at your Niagara property with everything needed for a full show.' },
      { icon: '🥂', title: 'Built for Romantic Occasions',       desc: 'Honeymoon dinners, bachelorette weekends, and anniversary getaways — the Niagara experiences guests remember longest.' },
      { icon: '🎭', title: 'Fire Tricks & Live Cooking',         desc: '90–120 minutes of live teppanyaki entertainment — fire tricks, flying shrimp, every plate cooked fresh in front of your guests.' },
      { icon: '🏠', title: 'Vacation Property Stays Spotless',   desc: 'Full setup and complete pack-out included. Your Niagara rental looks exactly as it did when the chef arrived.' },
    ],
  ...
  // Theme 5 — University & Corporate
  {
    ...
    experiencePoints:   [
      { icon: '🏢', title: 'Your Outdoor Venue Is the Setting',  desc: 'No reservation required — your outdoor corporate space or backyard becomes the setting for an exclusive private dinner.' },
      { icon: '🔥', title: '90–120 Minute Live Performance',     desc: 'A certified teppanyaki chef runs the full show — fire tricks, freshly cooked proteins, and live entertainment for your group.' },
      { icon: '👥', title: 'Dual Stations for Large Events',     desc: 'Two chef stations for graduation and corporate groups of 25–60+ — faster service and double the performance energy.' },
      { icon: '🧹', title: 'Setup & Cleanup Included',          desc: 'Full setup before the event and complete cleanup after. Nothing for the host or event planner to manage.' },
    ],
  ...
  // Theme 6 — Luxury Cottage
  {
    ...
    experiencePoints:   [
      { icon: '🏡', title: 'Chef at Your Estate Property',       desc: 'A certified private hibachi chef travels to your estate cottage, lakefront retreat, or luxury property anywhere in Ontario.' },
      { icon: '🥩', title: 'Luxury Proteins for the Occasion',   desc: 'Filet mignon, lobster tail, and scallops — the full premium menu, selected to match the occasion it deserves.' },
      { icon: '🔥', title: 'Live Fire Performance All Yours',    desc: 'A full live teppanyaki show designed around your group — every flame trick, every protein, every moment exclusively yours.' },
      { icon: '✨', title: 'Property Immaculate on Departure',   desc: 'Flawless setup and complete cleanup — your estate property looks exactly as it did before the chef arrived.' },
    ],
...
export function getOnBlogPosts(variant, count) {
  return ON_BLOG_POSTS[variant % ON_BLOG_POSTS.length].slice(0, count)
}
