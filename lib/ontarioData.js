...
const ON_HERO_SUBTITLES = [
  ...
  (city) => `Graduation Celebrations · Family Milestones · Private Dining · Serving ${city} & Greater Toronto`,
...
const ON_LOCAL_HIGHLIGHTS = [
  ...
  (city) => [
    ...
    `Ideal for the graduate's milestone celebration or the corporate team dinner that needs to hold attention for two hours`,
...
const ON_HOW_IT_WORKS = [
  // Theme 0 — Toronto Urban Core
  {
    ...
    steps: [
      ...
      { num: '02', title: 'Confirm Your Menu',            desc: 'Choose your protein selections — standard menu or premium upgrades (filet mignon, lobster tail, Chilean sea bass). We lock in your details and send confirmation.' },
      { num: '03', title: 'Chef Arrives with Everything', desc: 'Your certified teppanyaki chef arrives with the full setup: teppan grill, propane, all proteins, sauces, plates, and utensils.' },
      { num: '04', title: 'Live Cooking Performance',     desc: 'Guests gather at your outdoor space for 90–120 minutes of live hibachi — fire tricks, flying shrimp, freshly grilled food cooked to order.' },
      { num: '05', title: 'Full Cleanup Included',        desc: 'Chef handles all cleanup and packs out completely. Your property stays spotless. You keep the experience.' },
    ],
  },
  // Theme 1 — GTA Affluent Suburbs
  {
    ...
    steps: [
      ...
      { num: '02', title: 'Confirm Your Menu',            desc: 'Choose your protein selections — standard menu or premium upgrades (filet mignon, lobster tail, Chilean sea bass). We lock in your details and send confirmation.' },
      { num: '03', title: 'Chef Arrives with Everything', desc: 'Certified chef arrives with full teppan grill, propane, all ingredients, premium protein options, sauces, plates, and chopsticks.' },
      { num: '04', title: 'The Performance Begins',       desc: 'Guests gather around the grill for a live teppanyaki show — fire tricks, fresh proteins cooked to order, fried rice and vegetables.' },
      { num: '05', title: 'Zero Cleanup for You',         desc: 'Chef packs everything out completely. You hosted the finest dinner in the neighbourhood and didn\'t manage a single detail.' },
    ],
  },
  // Theme 2 — GTA Family & Community
  {
    ...
    steps: [
      ...
      { num: '02', title: 'Confirm Your Menu',          desc: 'Choose your protein selections — standard menu or premium upgrades (filet mignon, lobster tail, Chilean sea bass). We lock in your details and send confirmation.' },
      { num: '03', title: 'Full Setup Arrives',         desc: 'Your chef (or two chefs for large groups) arrives with everything: grills, propane, all proteins, sauces, plates, and utensils.' },
      { num: '04', title: 'Live Cooking for the Crowd', desc: 'Every guest gathers around the grill for a live teppanyaki performance — fire tricks, fresh proteins cooked to order, fried rice and vegetables.' },
      { num: '05', title: 'Chef Handles Cleanup',       desc: 'Complete cleanup done by your chef. Your family keeps the memory. You do none of the work.' },
    ],
  },
  // Theme 3 — Cottage Country & Resort
  {
    headline:   (city) => `How Private Chef Hibachi Works at Your ${city} Cottage`,
    ...
    steps: [
      ...
      { num: '02', title: 'Confirm Your Menu',          desc: 'Choose your protein selections — standard menu or premium upgrades (filet mignon, lobster tail, Chilean sea bass). We lock in your details and send confirmation.' },
      { num: '03', title: 'Chef Travels to You',        desc: 'Certified hibachi chef travels to your cottage or property with full setup: teppan grill, propane, all ingredients, plates, sauces, and utensils.' },
      { num: '04', title: 'Cottage Dinner Show',        desc: 'Guests gather on your deck, patio, or yard for 90–120 minutes of live hibachi — fire tricks, grilled-to-order proteins, the full performance.' },
      { num: '05', title: 'Pack-Out and Done',          desc: 'Chef handles complete cleanup and takes everything with them. Your cottage property stays spotless.' },
    ],
  },
  // Theme 4 — Niagara Tourism
  {
    headline:   (city) => `How Private Chef Hibachi Works at Your ${city} Rental`,
    ...
    steps: [
      ...
      { num: '02', title: 'Confirm Your Menu',         desc: 'Choose your protein selections — standard menu or premium upgrades (filet mignon, lobster tail, Chilean sea bass). We lock in your details and send confirmation.' },
      { num: '03', title: 'Chef Comes to You',         desc: 'Certified hibachi chef arrives with full setup: teppan grill, propane, all ingredients, plates, sauces, and utensils. Nothing for you to prepare.' },
      { num: '04', title: 'Niagara Dinner Show',       desc: 'Guests gather on your patio, deck, or yard for 90–120 minutes of live hibachi — fire tricks, grilled-to-order proteins, the full show.' },
      { num: '05', title: 'Pack-Out and Done',         desc: 'Chef handles complete cleanup. Your vacation property is spotless and you had the best dinner of the trip.' },
    ],
  },
  // Theme 5 — University & Corporate
  {
    ...
    steps: [
      ...
      { num: '02', title: 'Confirm Your Menu',            desc: 'Choose your protein selections — standard menu or premium upgrades (filet mignon, lobster tail, Chilean sea bass). We lock in your details and send confirmation.' },
      { num: '03', title: 'Chef Arrives with Everything', desc: 'Certified chef arrives with full teppan grill, propane, all ingredients, sauces, plates, and chopsticks. No shopping required.' },
      { num: '04', title: 'The Performance Begins',       desc: 'Guests gather around the grill for a live teppanyaki show — fire tricks, fresh proteins cooked to order, fried rice and vegetables.' },
      { num: '05', title: 'Zero Cleanup for You',         desc: 'Chef packs everything out completely. You hosted the best corporate dinner of the year and didn\'t manage a single detail.' },
    ],
  },
  // Theme 6 — Luxury Cottage
  {
    ...
    steps: [
      ...
      { num: '02', title: 'Confirm Your Menu',              desc: 'Choose your protein selections — standard menu or premium upgrades (filet mignon, lobster tail, Chilean sea bass). We lock in your details and send confirmation.' },
      { num: '03', title: 'Chef Travels to Your Property',  desc: 'Your certified teppanyaki chef arrives with everything: premium teppan grill, propane, hand-selected proteins, sauces, plates, and utensils.' },
      { num: '04', title: 'Estate Dining Performance',      desc: 'Guests gather at your lakefront deck or patio for 90–120 minutes of live hibachi — fire tricks, premium proteins, the full luxury experience.' },
      { num: '05', title: 'Complete Cleanup, Nothing Left', desc: 'Chef handles all teardown and cleanup. Your estate property is immaculate when they depart. You keep the memory.' },
    ],
  },
]
...
const ON_SECTION_VARIANTS = [
  ...
  // Theme 3 — Cottage Country & Resort
  {
    ...
    areasHeadline:      (city) => `Private Hibachi Chef at Your ${city} Cottage`,
    areasIntro: [
  ...
  // Theme 4 — Niagara Tourism
  {
    ...
    areasHeadline:      (city) => `Private Hibachi Chef at Your ${city} Property`,
    areasIntro: [
...
const ON_SUPPORT_IMAGES = {
  // Batch 1 — Toronto
  'toronto': {
    testimonial: { src: '/pics/private-hibachi.jpg',       alt: () => `Private hibachi chef at a Toronto ON condo event`,         caption: 'Toronto private dining',                trustBadge: '5.0 Average Rating',                          intro: () => `Toronto hosts — from downtown condos to North York backyards — choose Hibachi Connect when the occasion demands something nobody forgets. Birthday dinners, bachelorette weekends, and private celebrations in Canada's largest city all deserve a chef who brings the full teppanyaki experience to your door. See what Toronto hosts have discovered:` },
  ...
  // Batch 1 — Mississauga
  'mississauga': {
    testimonial: { src: '/pics/hibachi-catering.jpg',      alt: () => `Graduation hibachi party in Mississauga, ON`,               caption: 'Mississauga family celebrations',        trustBadge: 'Trusted by Local Families',                   intro: () => `Mississauga families celebrate milestones — graduations, birthdays, and backyard reunions — with a private hibachi chef who turns any outdoor space into a five-star dining room. From Port Credit to Erin Mills, our certified chefs travel to your home with full setup and complete cleanup. Here's what Mississauga families are saying:` },
  ...
  'richmond-hill': {
    testimonial: { src: '/pics/hibachi-catering-3.jpg',    alt: () => `Private hibachi dinner in Richmond Hill, ON`,               caption: 'Richmond Hill private dining',           trustBadge: 'Highly Rated by Local Hosts',                 intro: () => `Richmond Hill hosts expect quality, and our private hibachi chefs deliver it at every event. From executive backyard dinners to milestone birthday celebrations, Richmond Hill families choose private teppanyaki because nothing else combines live entertainment with a truly elevated dining experience. Here's why they keep coming back:` },
  ...
  // Batch 1 — Markham
  'markham': {
    testimonial: { src: '/pics/hibachi-shot-1.jpg',        alt: () => `Mobile hibachi event in Markham, ON`,                       caption: 'Markham corporate & family events',      trustBadge: 'Hundreds of Private Events',                  intro: () => `Markham hosts — corporate teams, growing families, and milestone celebrants alike — turn to private hibachi when the event needs to stand apart. Our certified chefs travel to your Markham home with the full teppanyaki setup, fire tricks included. Here's what Markham hosts are saying:` },
    cta:         { src: '/pics/hibachi-austin-home.jpg',    alt: () => `Mobile hibachi chef at a Markham ON event`,                  caption: 'The Markham event of the year' },
  },
  // Batch 1 — Vaughan
  'vaughan': {
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg', alt: () => `Hibachi catering event in Vaughan, ON`,                    caption: 'Vaughan catering events',                trustBadge: 'Thousands of Happy Guests',                   intro: () => `Vaughan families and catering hosts choose private hibachi for birthday dinners, graduation parties, and backyard celebrations that leave every guest talking. From Woodbridge to Maple, our chefs arrive with everything — and leave your Vaughan property spotless. See what Vaughan hosts have discovered:` },
    cta:         { src: '/pics/hibachi-dallas-home.jpg',    alt: () => `Hibachi catering chef in Vaughan, ON`,                      caption: 'Vaughan\'s catering standard' },
  },
  // Batch 2 — Brampton
  'brampton': {
    testimonial: { src: '/pics/hibachi-dallas-home.jpg',   alt: () => `Family graduation hibachi in Brampton, ON`,                caption: 'Brampton families celebrate big',        trustBadge: 'Trusted by Local Families',                   intro: () => `Brampton families bring private hibachi to their biggest celebrations — graduation dinners, backyard birthday parties, and holiday gatherings that deserve more than a restaurant reservation. Our certified chefs serve all of Brampton with full setup and zero cleanup required. Here's what Brampton hosts say:` },
    cta:         { src: '/pics/private-hibachi.jpg',        alt: () => `Private hibachi chef in Brampton, ON`,                      caption: 'Your Brampton celebration' },
  },
  // Batch 2 — Oakville
  'oakville': {
    testimonial: { src: '/pics/hibachi-chef-home.jpg',     alt: () => `Private hibachi chef in Oakville, ON`,                     caption: 'Oakville private dining',                trustBadge: 'Unforgettable Private Dining Experiences',    intro: () => `Oakville hosts demand the exceptional — and our private hibachi chefs deliver it at every event. From lakefront estate dinners to upscale backyard celebrations, Oakville families choose private teppanyaki because nothing else matches the combination of live entertainment and premium dining. Here's what Oakville hosts have found:` },
  ...
  // Batch 2 — Burlington
  'burlington': {
    testimonial: { src: '/pics/hibachi-shot-1.jpg',        alt: () => `Private hibachi dinner in Burlington, ON`,                 caption: 'Burlington hosts agree',                 trustBadge: 'Highly Rated by Local Hosts',                 intro: () => `Burlington hosts choose private hibachi when they want a Lakeshore celebration that genuinely stands apart. Birthday dinners, neighbourhood gatherings, and family milestones all become more memorable with a certified teppanyaki chef at your door. Here's why Burlington hosts keep coming back:` },
    cta:         { src: '/pics/backyard-hibachi.jpg',       alt: () => `Private hibachi chef in Burlington, ON`,                    caption: 'Your Burlington evening, elevated' },
  },
  // Batch 2 — Milton
  'milton': {
    testimonial: { src: '/pics/hibachi-catering.jpg',      alt: () => `Family hibachi party in Milton, ON`,                       caption: 'Milton family celebrations',             trustBadge: 'Thousands of Happy Guests',                   intro: () => `Milton families celebrate their milestones — graduation parties, backyard birthdays, and neighbourhood get-togethers — with a private hibachi chef who brings the full entertainment experience to their door. One of our most active GTA communities, and growing fast. Here's why:` },
    cta:         { src: '/pics/backyard-hibachi-2.jpg',     alt: () => `Backyard hibachi chef in Milton, ON`,                       caption: 'Your Milton family event' },
  },
  // Batch 2 — Ajax
  'ajax': {
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg', alt: () => `Mobile hibachi event in Ajax, ON`,                        caption: 'Ajax hosts agree',                       trustBadge: 'Trusted by Local Families',                   intro: () => `Ajax families and Durham Region hosts choose private hibachi when the celebration deserves something genuinely special. From backyard birthday parties to graduation dinners, our certified chefs travel to your Ajax home with everything — grill, ingredients, and entertainment — all included. Here's what Ajax hosts are saying:` },
    cta:         { src: '/pics/hibachi-colorado-home.jpg',  alt: () => `Mobile hibachi chef in Ajax, ON`,                          caption: 'The Ajax event of the year' },
  },
  // Batch 2 — Newmarket
  'newmarket': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',    alt: () => `Backyard hibachi party in Newmarket, ON`,                  caption: 'Newmarket hosts agree',                  trustBadge: 'Highly Rated by Local Hosts',                 intro: () => `Newmarket hosts — from Aurora border to Bradford area — choose private hibachi for backyard celebrations that go far beyond anything a local restaurant can offer. Our chefs serve all of Newmarket and the surrounding York Region with premium teppanyaki and full cleanup included. Here's what Newmarket hosts have discovered:` },
    cta:         { src: '/pics/hibachi-photo-2.jpg',        alt: () => `Backyard hibachi chef in Newmarket, ON`,                   caption: 'Your Newmarket backyard party' },
  },
  // Batch 3 — Muskoka
  'muskoka': {
    testimonial: { src: '/pics/hibachi-event.jpg',          alt: () => `Private hibachi chef at a Muskoka ON lakefront estate`,    caption: 'Muskoka estate hosts agree',             trustBadge: "Ontario's Favourite Hibachi Experience",      intro: () => `Muskoka cottage weekends and lakefront estate gatherings are the ultimate setting for a private hibachi dinner. Our certified chefs travel to your Muskoka property — Bracebridge dock-side patio or Gravenhurst lakefront estate — with the full teppanyaki setup and zero logistics for you. Here's what Muskoka hosts are saying:` },
  ...
  // Batch 3 — Barrie
  'barrie': {
    testimonial: { src: '/pics/backyard-hibachi-3.jpg',    alt: () => `Cottage hibachi party in Barrie, ON`,                     caption: 'Barrie cottage hosts agree',             trustBadge: 'Five-Star Entertainment & Dining',            intro: () => `Barrie serves as the gateway to Ontario's cottage country, and our private hibachi chefs travel throughout the area for backyard parties, cottage weekends, and long-weekend celebrations. Victoria Day through Labour Day, Barrie hosts trust us to deliver an unforgettable teppanyaki experience at their door. Here's why:` },
    cta:         { src: '/pics/hibachi-austin-home.jpg',    alt: () => `Mobile hibachi chef in Barrie, ON`,                        caption: 'Your Barrie cottage weekend' },
  },
  // Batch 3 — Collingwood
  'collingwood': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',    alt: () => `Mobile hibachi at a Collingwood ON chalet`,                caption: 'Collingwood retreat hosts agree',        trustBadge: 'Five-Star Entertainment & Dining',            intro: () => `Collingwood chalet weekends and four-season retreat gatherings deserve a dinner moment nobody forgets. Our private hibachi chefs travel to your Collingwood rental, set up on the deck or patio, and deliver a live teppanyaki show — fire tricks, fresh proteins, and full cleanup when dinner is done. Here's what Collingwood hosts say:` },
  ...
  'niagara-falls': {
    testimonial: { src: '/pics/hibachi-photo-2.jpg',       alt: () => `Vacation rental hibachi in Niagara Falls, ON`,            caption: 'Niagara Falls visitors agree',           trustBadge: 'Hundreds of Private Events',                  intro: () => `Niagara Falls vacation rental weekends and tourism stays become unforgettable with a private hibachi dinner at your property. Bachelorette groups, family trips, and celebration weekends all love the live-fire entertainment — no restaurant reservation required. Here's why Niagara Falls visitors keep coming back:` },
  ...
  'niagara-on-the-lake': {
    testimonial: { src: '/pics/backyard-hibachi.jpg',      alt: () => `Private hibachi at a Niagara-on-the-Lake winery estate`,  caption: 'Niagara-on-the-Lake hosts agree',        trustBadge: 'Unforgettable Private Dining Experiences',    intro: () => `Niagara-on-the-Lake winery estates and luxury inn weekends are the perfect backdrop for a private hibachi dinner. Whether you're hosting a garden dinner party, a wedding-weekend celebration, or an intimate bachelorette evening, our chefs bring the full teppanyaki experience to your property. See what Niagara-on-the-Lake hosts have discovered:` },
  ...
  // Batch 4 — Ottawa
  'ottawa': {
    testimonial: { src: '/pics/hibachi-photo-2.jpg',       alt: () => `Corporate hibachi event in Ottawa, ON`,                   caption: 'Ottawa corporate & graduation hosts agree', trustBadge: '5.0 Average Rating',                         intro: () => `Ottawa professionals, graduation families, and government-sector hosts choose private hibachi for corporate dinners, milestone celebrations, and backyard events that feel genuinely elevated. Our certified chefs travel throughout Ottawa and the National Capital Region with the full teppanyaki setup. Here's what Ottawa hosts are saying:` },
    cta:         { src: '/pics/private-hibachi.jpg',        alt: () => `Private hibachi chef in Ottawa, ON`,                      caption: 'Your Ottawa event, elevated' },
  },
  // Batch 4 — Waterloo
  'waterloo': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',    alt: () => `University graduation hibachi in Waterloo, ON`,            caption: 'Waterloo tech & grad hosts agree',       trustBadge: 'Trusted by Local Families',                   intro: () => `Waterloo's tech community and University of Waterloo graduation families have discovered private hibachi as the celebration format that leaves every guest talking. From Uptown Waterloo dinner parties to suburban backyard graduations, our chefs bring the full experience to your door. Here's what Waterloo hosts say:` },
    cta:         { src: '/pics/hibachi-shot-1.jpg',         alt: () => `Private hibachi chef in Waterloo, ON`,                    caption: 'Your Waterloo graduation event' },
  },
  // Batch 4 — Kitchener
  'kitchener': {
    testimonial: { src: '/pics/hibachi-catering.jpg',      alt: () => `Private hibachi event in Kitchener, ON`,                  caption: 'Kitchener hosts agree',                  trustBadge: 'Hundreds of Private Events',                  intro: () => `Kitchener-Waterloo families and community hosts choose private hibachi for backyard celebrations, graduation dinners, and milestone events that go beyond anything a local restaurant can offer. Our certified chefs serve all of Kitchener with full setup and complete cleanup. Here's why Kitchener hosts keep coming back:` },
    cta:         { src: '/pics/hibachi-colorado-home.jpg',  alt: () => `Private hibachi chef in Kitchener, ON`,                   caption: 'Your Kitchener celebration' },
  },
  // Batch 4 — London
  'london': {
    testimonial: { src: '/pics/backyard-hibachi.jpg',      alt: () => `Graduation hibachi party in London, ON`,                  caption: 'London graduation hosts agree',          trustBadge: 'Trusted by Local Families',                   intro: () => `London families and Western University graduation hosts choose private hibachi when they want a celebration that genuinely stands apart. Backyard graduation dinners, birthday parties, and family milestone events in Forest City all get a certified teppanyaki chef at the door. See what London hosts are saying:` },
    cta:         { src: '/pics/hibachi-austin-home.jpg',    alt: () => `Private hibachi chef in London, ON`,                      caption: 'Your London graduation event' },
  },
  // Batch 4 — Kingston
  'kingston': {
    testimonial: { src: '/pics/hibachi-dallas-home.jpg',   alt: () => `Backyard hibachi party in Kingston, ON`,                  caption: 'Kingston hosts agree',                   trustBadge: 'Highly Rated by Local Hosts',                 intro: () => `Kingston hosts — Queen's University families, longtime locals, and Limestone City milestone celebrants — turn to private hibachi when the occasion calls for something exceptional. Our chefs travel to your Kingston property with the full teppanyaki experience and leave everything cleaner than they found it. Here's what Kingston hosts have discovered:` },
    cta:         { src: '/pics/hibachi-virginia-beach.jpg', alt: () => `Private hibachi chef in Kingston, ON`,                   caption: 'Your Kingston backyard party' },
  },
  // Batch 4 — Hamilton
  'hamilton': {
    testimonial: { src: '/pics/backyard-hibachi-2.jpg',    alt: () => `Family hibachi celebration in Hamilton, ON`,               caption: 'Hamilton family hosts agree',            trustBadge: 'Thousands of Happy Guests',                   intro: () => `Hamilton families bring private hibachi to their backyard celebrations, graduation dinners, and community gatherings — and they keep coming back for the same reason: nothing else delivers this combination of live entertainment and premium dining. Our certified chefs serve all of Hamilton with full setup and zero cleanup. Here's what Hamilton hosts say:` },
...
const ON_SUPPORT_FALLBACKS = [
  // Theme 0 — Toronto Urban Core
  {
    testimonial: { src: '/pics/private-hibachi.jpg',       alt: (city) => `Private hibachi event in ${city}, ON`,               caption: 'Toronto area hosts agree',         trustBadge: '5.0 Average Rating',                          intro: (city) => `${city} hosts choose private hibachi for downtown celebrations, birthday dinners, and backyard events that deserve more than a restaurant can offer. Our certified chefs travel throughout the Toronto area with the full teppanyaki setup and complete cleanup. Here's what ${city} hosts are saying:` },
    cta:         { src: '/pics/hibachi-event.jpg',          alt: (city) => `Private hibachi chef in ${city}, ON`,                 caption: 'Your private Toronto evening' },
  },
  // Theme 1 — GTA Affluent Suburbs
  {
    testimonial: { src: '/pics/hibachi-catering-3.jpg',    alt: (city) => `Private hibachi event in ${city}, ON`,               caption: 'GTA affluent hosts agree',         trustBadge: 'Highly Rated by Local Hosts',                 intro: (city) => `${city} hosts expect quality, and our private hibachi chefs deliver it at every event. From milestone birthday celebrations to executive backyard dinner parties, ${city} families choose private teppanyaki because nothing else matches the live entertainment and elevated dining experience. Here's what they've discovered:` },
    cta:         { src: '/pics/hibachi-chef-home.jpg',      alt: (city) => `Private hibachi chef in ${city}, ON`,                 caption: 'Your GTA estate event, elevated' },
  },
  // Theme 2 — GTA Family & Community
  {
    testimonial: { src: '/pics/hibachi-catering.jpg',      alt: (city) => `Family hibachi party in ${city}, ON`,                caption: 'GTA family hosts agree',           trustBadge: 'Trusted by Local Families',                   intro: (city) => `${city} families celebrate their biggest milestones — graduations, birthdays, and backyard reunions — with a private hibachi chef who brings the full teppanyaki experience to their door. Full setup and complete cleanup included. Here's what ${city} hosts are saying:` },
    cta:         { src: '/pics/backyard-hibachi-2.jpg',     alt: (city) => `Backyard hibachi chef in ${city}, ON`,                caption: 'Your GTA family celebration' },
  },
  // Theme 3 — Cottage Country & Resort
  {
    testimonial: { src: '/pics/hibachi-colorado-home.jpg', alt: (city) => `Cottage hibachi event in ${city}, ON`,               caption: 'Cottage country hosts agree',      trustBadge: 'Five-Star Entertainment & Dining',            intro: (city) => `${city} cottage weekends and resort stays are the ideal setting for a private hibachi dinner. Our certified chefs travel to your property — deck, dock-side patio, or backyard — with everything needed for a full live teppanyaki show. Here's what ${city} cottage hosts have discovered:` },
  ...
  // Theme 4 — Niagara Tourism
  {
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg', alt: (city) => `Vacation rental hibachi in ${city}, ON`,            caption: 'Niagara guests agree',             trustBadge: 'Hundreds of Private Events',                  intro: (city) => `${city} vacation rental weekends and tourism getaways become unforgettable with a private hibachi dinner at your property. Bachelorette groups, family trips, and celebration weekends love the live-fire entertainment — no restaurant required. Here's what ${city} visitors are saying:` },
    cta:         { src: '/pics/hibachi-catering.jpg',       alt: (city) => `Private hibachi chef in ${city}, ON`,                caption: 'The Niagara dinner of the trip' },
  },
  // Theme 5 — University & Corporate
  {
    testimonial: { src: '/pics/hibachi-event.jpg',         alt: (city) => `Corporate hibachi event in ${city}, ON`,             caption: 'Ontario corporate hosts agree',    trustBadge: '5.0 Average Rating',                          intro: (city) => `${city} professionals, graduation families, and community hosts choose private hibachi for corporate events, milestone celebrations, and backyard dinners that stand apart from anything a restaurant can offer. Our chefs bring the full teppanyaki experience to ${city} properties with zero logistics required. Here's what ${city} hosts say:` },
    cta:         { src: '/pics/hibachi-catering-2.jpg',     alt: (city) => `Private hibachi chef in ${city}, ON`,                 caption: 'Your Ontario corporate event' },
  },
  // Theme 6 — Luxury Cottage
  {
    testimonial: { src: '/pics/hibachi-colorado.jpg',      alt: (city) => `Estate cottage hibachi in ${city}, ON`,              caption: 'Ontario estate hosts agree',       trustBadge: "Ontario's Favourite Hibachi Experience",      intro: (city) => `${city} estate hosts and lakefront property owners choose private hibachi for an entertaining experience that matches the setting. Our certified chefs travel to your ${city} property — lakefront retreat or estate backyard — with the full premium teppanyaki setup. Here's what ${city} hosts have found:` },
    cta:         { src: '/pics/hibachi-catering-3.jpg',     alt: (city) => `Private hibachi chef at a ${city} ON estate`,         caption: 'The Ontario estate dining standard' },
  },
]
...
const ON_BLOG_POSTS = [
  // Theme 0 — Toronto Urban Core
  [
    { slug: 'hibachi-bachelorette-toronto',            title: 'Toronto Bachelorette Weekend Hibachi: The Complete GTA Guide' },
    { slug: 'how-much-does-hibachi-cost-toronto',      title: 'How Much Does Private Hibachi Cost in Toronto? (2026 CAD Pricing Guide)' },
    { slug: 'hibachi-anniversary-date-night-toronto',  title: 'Private Hibachi for an Anniversary or Date Night in Toronto' },
  ],
  // Theme 1 — GTA Affluent Suburbs
  [
...
const ON_PROFILE_H1_PREFIXES = [
  ...
  'Private Hibachi Chef in',   // 3  — Markham
  ...
  'Private Hibachi Chef in',   // 9  — Ajax
  'Private Hibachi Chef in',   // 10 — Newmarket
  'Private Hibachi Chef in',   // 11 — Muskoka
  'Hibachi at Home in',        // 12 — Barrie
  'Private Hibachi Chef in',   // 13 — Collingwood
  'Private Hibachi Chef in',   // 14 — Niagara Falls
  'Private Hibachi Chef in',   // 15 — Niagara-on-the-Lake
  'Private Hibachi Chef in',   // 16 — Ottawa
  'Hibachi at Home in',        // 17 — Waterloo
  'Hibachi at Home in',        // 18 — Kitchener
  'Hibachi at Home in',        // 19 — London
  'Private Hibachi Chef in',   // 20 — Kingston
...
const ON_THEME_H1_PREFIXES = [
  ...
  'Private Hibachi Chef in',  // v=4 Niagara Tourism generic
...
const ON_CUSTOM_META = {
  ...
  'markham': {
    title: 'Private Hibachi Chef in Markham, ON | Corporate Tech & Family Milestone Events | Hibachi Connect',
    desc:  'A certified private hibachi chef comes to your Markham property. Perfect for corporate tech events and family milestone celebrations. Full setup, live performance, complete cleanup. From $78/adult CAD.',
  },
  'vaughan': {
  ...
  'ajax': {
    title: 'Private Hibachi Chef in Ajax, ON | Durham Region Family & Graduation Events | Hibachi Connect',
    desc:  'A certified private hibachi chef comes to your Ajax property. Perfect for graduation celebrations, family reunions, and backyard gatherings. Full setup, live performance, complete cleanup. From $78/adult CAD.',
  },
  'newmarket': {
    title: 'Private Hibachi Chef in Newmarket, ON | York Region Estate & Milestone Events | Hibachi Connect',
    desc:  'Book a certified private hibachi chef for your Newmarket backyard or estate property. Perfect for milestone birthdays, graduation celebrations, and family dinners. From $78/adult CAD. Serving Newmarket and York Region.',
  },
  'muskoka': {
  ...
  'barrie': {
    ...
    desc:  'A certified private hibachi chef for your Barrie backyard, cottage, or Lake Simcoe waterfront property. Full setup, live performance, complete cleanup. From $78/adult CAD. Serving Barrie and Georgian Bay.',
  },
  'collingwood': {
    title: 'Private Hibachi Chef in Collingwood, ON | Blue Mountain Chalet & Georgian Bay Dining | Hibachi Connect',
    desc:  'A certified private hibachi chef comes to your Collingwood chalet, cottage, or resort property. Perfect for Blue Mountain retreats and Georgian Bay weekend dinners. From $78/adult CAD.',
  },
  'niagara-falls': {
    title: 'Private Hibachi Chef in Niagara Falls, ON | Vacation Rental & Private Dining | Hibachi Connect',
    desc:  'A certified private hibachi chef at your Niagara Falls vacation rental or inn. Bachelorette weekends, honeymoon dinners, and group getaways. From $78/adult CAD. Serving the full Niagara region.',
  },
  'niagara-on-the-lake': {
  ...
  'waterloo': {
    title: 'Hibachi at Home in Waterloo, ON | University Graduation & Tech Events | Hibachi Connect',
  ...
  'kitchener': {
    title: 'Hibachi at Home in Kitchener, ON | Family Celebrations & Corporate Dinners | Hibachi Connect',
  ...
  'kingston': {
    title: 'Private Hibachi Chef in Kingston, ON | Queen\'s University Graduation & Private Events | Hibachi Connect',
    desc:  'A certified private hibachi chef for your Kingston graduation celebration, backyard dinner, or family event. From $78/adult CAD. Full setup, live teppanyaki performance, complete cleanup. Serving Kingston and surrounding communities.',
  },
  'hamilton': {
...
export const ON_CLOSING_VARIANTS = [
  ...
  {
    headline: (city) => `${city}'s Private Chef Experience — Reserve Your Evening`,
  ...
  // 192 — Cottage Country & Resort
  {
    ...
    sub:      (city) => `A certified private hibachi chef travels to your ${city} cottage — grill, ingredients, full show, complete cleanup. From $78/adult CAD.`,
  ...
  {
    headline: (city) => `${city}'s Private Corporate Dining Experience — Reserve Your Date`,
...
export const ON_CITY_CLOSINGS = [
  ...
  {
    headline: (city) => `Toronto's Private Chef Experience — Reserve Your Evening`,
  ...
  {
    headline: (city) => `Mississauga's Most Memorable Celebration — Reserve Your Date`,
  ...
  {
    headline: (city) => `Richmond Hill's Private Dining Standard — Reserve Your Evening`,
  ...
  {
    headline: (city) => `The Markham Experience Everyone Remembers — Reserve Your Date`,
    sub:      (city) => `A certified private hibachi chef comes to your Markham property. Full setup, live teppanyaki performance, complete cleanup. From $78/adult CAD.`,
  ...
  {
    headline: (city) => `Brampton's Most Memorable Celebration — Reserve Your Date`,
  ...
  {
    headline: (city) => `Oakville's Private Chef Standard — Reserve Your Evening`,
  ...
  {
    headline: (city) => `Burlington's Private Dining Standard — Reserve Your Evening`,
  ...
  {
    headline: (city) => `Milton's Private Hibachi Experience — Reserve Your Date`,
  ...
  {
    headline: (city) => `The Ajax Experience Everyone Remembers — Reserve Your Date`,
    sub:      (city) => `A certified private hibachi chef comes to your Ajax property. Full setup, live teppanyaki performance, complete cleanup. From $78/adult CAD.`,
    urgency:  `Ajax and Durham Region events book 2–3 weeks ahead. Check your date now.`,
  },
  // 206 — Newmarket (profileIdx 10)
  {
    headline: (city) => `Newmarket's Private Hibachi Experience — Reserve Your Date`,
  ...
  {
    headline: (city) => `Your Barrie Cottage Dining Experience — Reserve Your Date`,
    sub:      (city) => `A certified private hibachi chef travels to your Barrie property or cottage. Full setup, live performance, complete cleanup. From $78/adult CAD.`,
  ...
  // 209 — Collingwood (profileIdx 13)
  {
    ...
    sub:      (city) => `A certified private hibachi chef at your Collingwood chalet or Georgian Bay property. Full setup, live performance, complete cleanup. From $78/adult CAD.`,
  ...
  {
    headline: (city) => `The Niagara Falls Dinner Your Group Deserves — Reserve Your Evening`,
    sub:      (city) => `A certified private hibachi chef at your Niagara Falls vacation rental or property. Full setup, live teppanyaki performance, complete cleanup. From $78/adult CAD.`,
  ...
  {
    headline: (city) => `Ottawa's Private Chef Experience — Reserve Your Evening`,
  ...
  {
    headline: (city) => `Waterloo's Private Dining Standard — Reserve Your Date`,
  ...
  {
    headline: (city) => `Kitchener's Most Memorable Celebration — Reserve Your Date`,
  ...
  {
    headline: (city) => `London Ontario's Private Hibachi Celebration — Reserve Your Date`,
  ...
  {
    headline: (city) => `Kingston's Private Hibachi Experience — Reserve Your Date`,
  ...
  {
    headline: (city) => `Hamilton's Most Memorable Celebration — Reserve Your Date`,
...
export const ON_INTRO_VARIANTS = [
  ...
  // 190 — GTA Affluent Suburbs
  {
    headline: (city) => `Hibachi at Home in ${city}: Private Dining for the GTA's Finest Homes`,
    opening:  (city, state) =>
  ...
  // 191 — GTA Family & Community
  {
    headline: (city) => `Hibachi at Home in ${city}: Private Dining for Every Celebration`,
    opening:  (city, state) =>
  ...
  // 193 — Niagara Tourism
  {
    headline: (city) => `Private Chef in ${city}: The Vacation Dinner Your Group Deserves`,
    opening:  (city, state) =>
...
export const ON_CITY_INTROS = [
  ...
  // 199 — Markham (profileIdx 3)
  {
    headline: () => `Private Hibachi Chef in Markham`,
    opening:  () =>
  ...
  // 205 — Ajax (profileIdx 9)
  {
    headline: () => `Private Hibachi Chef in Ajax`,
    opening:  () =>
  ...
  // 206 — Newmarket (profileIdx 10)
  {
    headline: () => `Private Hibachi Chef in Newmarket`,
    opening:  () =>
  ...
  // 209 — Collingwood (profileIdx 13)
  {
    headline: () => `Private Hibachi Chef in Collingwood`,
    opening:  () =>
  ...
  // 210 — Niagara Falls (profileIdx 14)
  {
    headline: () => `Private Hibachi Chef in Niagara Falls`,
    opening:  () =>
  ...
  // 216 — Kingston (profileIdx 20)
  {
    headline: () => `Private Hibachi Chef in Kingston`,
    opening:  () =>
