...
const OR_SUPPORT_IMAGES = {
  'portland': {
    testimonial: { src: '/pics/hero-3.jpg',             alt: () => `Portland backyard hibachi dinner with guests gathered around the grill`, caption: 'Portland dining, elevated', intro: () => `Portland hosts have high standards. Here's what they find:` },
  ...
  'beaverton': {
    testimonial: { src: '/pics/hibachi-event.jpg',      alt: () => `Corporate hibachi event in Beaverton OR`,  caption: 'Beaverton corporate events',    intro: () => `Washington County professionals keep booking us. Here's why:` },
    cta:         { src: '/pics/hibachi-catering.jpg',   alt: () => `Private hibachi chef in Beaverton OR`,                                 caption: 'The Beaverton event standard' },
  },
  'hillsboro': {
    testimonial: { src: '/pics/hibachi-catering.jpg',   alt: () => `Corporate hibachi dinner in Hillsboro OR`, caption: 'Hillsboro corporate dining',    intro: () => `Hillsboro tech corridor teams keep coming back. Here's what they say:` },
    cta:         { src: '/pics/hibachi-event.jpg',      alt: () => `Private hibachi chef in Hillsboro OR`,                                 caption: 'Hillsboro corporate dining standard' },
  },
  'lake-oswego': {
    testimonial: { src: '/pics/private-hibachi.jpg',    alt: () => `Private hibachi dinner at a Lake Oswego OR estate`,  caption: 'Lake Oswego private dining', intro: () => `Lake Oswego hosts expect the exceptional. Here's what they find:` },
  ...
  'salem': {
    testimonial: { src: '/pics/backyard-hibachi-3.jpg', alt: () => `Backyard graduation hibachi party in Salem OR`,       caption: 'Salem graduation season',   intro: () => `Salem families celebrate big. Here's what they say:` },
    cta:         { src: '/pics/hibachi-catering-2.jpg', alt: () => `Private hibachi chef performing in Salem OR`,                          caption: 'Your Salem backyard event' },
  },
  'eugene': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg', alt: () => `Graduation hibachi party in Eugene OR`,    caption: 'Eugene graduation celebrations', intro: () => `Eugene hosts and Duck families say it best:` },
  ...
  'mcminnville': {
    testimonial: { src: '/pics/hibachi-colorado.jpg',   alt: () => `Wine country hibachi gathering in McMinnville OR`, caption: 'McMinnville wine country events', intro: () => `McMinnville wine country hosts keep coming back. Here's why:` },
  ...
  'cannon-beach': {
    testimonial: { src: '/pics/hibachi-catering-3.jpg', alt: () => `Group dinner at a Cannon Beach OR vacation rental`,  caption: 'Cannon Beach vacation rental hibachi', intro: () => `Cannon Beach guests come back every summer. Here's why:` },
  ...
  'lincoln-city': {
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg', alt: () => `Family reunion hibachi at a Lincoln City OR beach house`, caption: 'Lincoln City group rental hibachi', intro: () => `Lincoln City vacation groups keep booking us. Here's why:` },
  ...
  'bend': {
    testimonial: { src: '/pics/private-hibachi.jpg',    alt: () => `Private hibachi chef at a Bend OR vacation rental`,  caption: 'Bend retreat and vacation events', intro: () => `Bend hosts and retreat planners say it best:` },
