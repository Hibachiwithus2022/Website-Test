...
const OR_HERO_SUBTITLES = [
  (city) => `Backyard Dinner Parties · Birthday Celebrations · Corporate Events · Serving All Portland Neighborhoods & the Metro`,
  ...
  (city) => `Graduation Parties · Family Celebrations · Birthday Dinners · Serving ${city} & the Willamette Valley`,
...
const OR_HOW_IT_WORKS = [
  ...
  // Theme 2 — Portland Affluent Suburb
  {
    ...
    steps: [
      ...
      { num: '04', title: 'Zero Cleanup, Perfect Evening', desc: 'Chef packs everything out completely. Your property is immaculate when they leave. You hosted the most memorable event of the year.' },
    ],
  },
  // Theme 3 — Willamette Valley
  {
    ...
    steps: [
      { num: '01', title: 'Book Your Valley Event',         desc: 'Request your date online or by phone. Tell us your guest count and backyard setup. We confirm quickly.' },
  ...
  // Theme 5 — Central Oregon Mountain
  {
    ...
    steps: [
      { num: '01', title: 'Reserve Your Bend Date',         desc: 'Reserve online or by phone — tell us your guest count and vacation rental setup. We confirm fast and coordinate travel to your property.' },
      ...
      { num: '04', title: 'Full Cleanup, Nothing Left',    desc: 'Chef handles all teardown and cleanup. Your vacation property is spotless when they leave. You keep the experience.' },
    ],
  },
]
...
const OR_SECTION_VARIANTS = [
  // Theme 0 — Portland Urban Core
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏡', title: `Your ${city} Deck Is the Venue`,    desc: `No reservation battles — your ${city} backyard or cedar deck becomes an exclusive private dining room for your guests.` },
      ...
      { icon: '📍', title: 'All of Portland Metro Served',      desc: 'Beaverton, Hillsboro, Lake Oswego, Gresham, Tualatin, and every neighbourhood from Alberta Arts to Sellwood.' },
      { icon: '✨', title: 'Premium Fire Show, Zero Cleanup',   desc: 'Premium proteins cooked live on the teppan, a full fire show for your guests, and complete cleanup when dinner is done.' },
    ],
  ...
  // Theme 1 — Portland Corporate / Tech
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏢', title: `Your ${city} Venue, Your Rules`,    desc: `No reservation required — your ${city} corporate outdoor space or backyard becomes the setting for an exclusive private dinner.` },
      { icon: '📍', title: 'Washington County & Metro',         desc: 'Corporate events and residential backyards throughout Beaverton, Hillsboro, Tigard, and the full Portland metro.' },
      { icon: '🔥', title: 'Exclusive Live Performance',        desc: `A certified teppanyaki chef performs exclusively for your ${city} group — 90–120 minutes of fire tricks, cooking, and team entertainment.` },
      { icon: '🧹', title: 'Zero Corporate Logistics',          desc: 'Your chef arrives early, sets up completely, and packs out after dinner. No event coordination burden for you to carry.' },
    ],
  ...
  // Theme 2 — Portland Affluent Suburb
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏡', title: `Your ${city} Terrace Is the Venue`,   desc: `No reservation battles — your ${city} private terrace, lakefront deck, or garden becomes an exclusive dining room for the evening.` },
      { icon: '🔥', title: 'One Chef, One Unforgettable Show',    desc: 'Every guest at the same grill, the same chef, the same moment — the shared experience is what makes estate hibachi unforgettable.' },
      { icon: '⏱️', title: '90–120 Minute Estate Performance',    desc: `A certified teppanyaki chef runs a full cooking show keeping every ${city} guest engaged from first flame to last plate.` },
      { icon: '🥩', title: 'Premium Protein Upgrades',            desc: 'Filet mignon, lobster tail, and other premium upgrades available — customize the menu to match the milestone occasion.' },
    ],
  ...
  // Theme 3 — Willamette Valley
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏡', title: `Chef at Your ${city} Property`,      desc: `A certified private hibachi chef comes to your ${city} backyard, estate, or wine country rental — no logistics for you to manage.` },
      { icon: '🔥', title: 'Full Live Show in the Valley',       desc: `All ${city} guests gathered at the same outdoor grill for the complete teppanyaki performance — fire tricks, proteins cooked to order.` },
      { icon: '🎓', title: 'Graduation & Wine Country Events',   desc: 'Graduation parties, anniversary dinners, and Willamette vineyard gatherings — the valley calendar handled perfectly.' },
      { icon: '🧹', title: 'Complete Teardown Included',         desc: 'Full setup before the event and complete cleanup after. Your property is spotless when the chef leaves — not a detail for you to manage.' },
    ],
  ...
  // Theme 4 — Oregon Coast
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏖️', title: `Chef at Your ${city} Rental`,         desc: `Skip the Highway 101 restaurant battle — your chef arrives at your ${city} vacation rental with everything needed for a full teppanyaki show.` },
      { icon: '🔥', title: 'Live Show on the Coast Deck',         desc: `All guests gathered on your ${city} deck or patio for the full performance — fire tricks, flying shrimp, proteins cooked to order.` },
      ...
      { icon: '🏠', title: 'Oregon Rental Stays Spotless',        desc: 'Full setup and complete pack-out included. Your Oregon Coast rental looks exactly as it did when the chef arrived.' },
    ],
  ...
  // Theme 5 — Central Oregon Mountain
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏔️', title: `Chef at Your ${city} Cabin`,         desc: `A certified private hibachi chef travels to your ${city} cabin, resort house, or vacation rental — no logistics for you to handle.` },
      { icon: '🥩', title: 'Premium Proteins, Cascade Views',   desc: `Choose your proteins — chicken, steak, shrimp, salmon, filet mignon, lobster tail — all cooked live on the teppan under ${city}'s open sky.` },
      { icon: '👥', title: 'Retreats & Groups of Any Size',     desc: `Intimate ${city} groups of 8–20 or larger corporate retreat gatherings up to 60 — one or two stations sized to your exact count.` },
      { icon: '✨', title: 'Mountain Property Stays Spotless',   desc: 'Flawless setup, full service throughout, and complete cleanup. You enjoy the evening; we handle every last logistical detail.' },
    ],
...
const OR_CITY_IMAGE_MAP = {
  ...
  'cannon-beach':   { src: '/pics/mobile-hibachi-2.jpg',     alt: () => `Mobile hibachi chef setting up at a Cannon Beach OR rental` },
...
const OR_SUPPORT_IMAGES = {
  'portland': {
    testimonial: { src: '/pics/hero-3.jpg',             alt: () => `Portland backyard hibachi dinner with guests gathered around the grill`, caption: 'Portland dining, elevated', trustBadge: 'Five-Star Entertainment & Dining', intro: () => `Portland hosts — from Hawthorne backyard dinners to Pearl District rooftop events — choose private hibachi when the occasion demands something truly memorable. Our certified chefs travel to your Portland property with the full teppanyaki setup and complete cleanup. Here's what Portland hosts are saying:` },
    cta:         { src: '/pics/hibachi-catering-3.jpg', alt: () => `Private hibachi chef performing in Portland OR`,                        caption: 'Your Portland event starts here' },
  },
  'beaverton': {
    testimonial: { src: '/pics/hibachi-event.jpg',      alt: () => `Corporate hibachi event in Beaverton OR`,  caption: 'Beaverton corporate events',    trustBadge: 'Trusted by Local Families', intro: () => `Beaverton's Washington County families and tech professionals have made private hibachi their go-to for backyard celebrations, milestone birthdays, and team dinners. Our chefs bring the full teppanyaki experience directly to your Beaverton home or venue — setup, performance, and cleanup included. Here's what our Beaverton guests have to say:` },
    cta:         { src: '/pics/hibachi-catering.jpg',   alt: () => `Private hibachi chef in Beaverton OR`,                                 caption: 'The Beaverton event standard' },
  },
  'hillsboro': {
    testimonial: { src: '/pics/hibachi-catering.jpg',   alt: () => `Corporate hibachi dinner in Hillsboro OR`, caption: 'Hillsboro corporate dining',    trustBadge: 'Hundreds of Private Events', intro: () => `Hillsboro's Silicon Forest tech professionals and Intel-area families have discovered that private hibachi is the perfect upgrade for corporate team dinners and backyard celebrations alike. We handle every detail — certified chef, premium proteins, full teppanyaki setup — so you can focus on the people around the grill. See what Hillsboro hosts are saying:` },
    cta:         { src: '/pics/hibachi-event.jpg',      alt: () => `Private hibachi chef in Hillsboro OR`,                                 caption: 'Hillsboro corporate dining standard' },
  },
  'lake-oswego': {
    testimonial: { src: '/pics/private-hibachi.jpg',    alt: () => `Private hibachi dinner at a Lake Oswego OR estate`,  caption: 'Lake Oswego private dining', trustBadge: 'Unforgettable Private Dining Experiences', intro: () => `Lake Oswego's lakefront properties and upscale backyard settings are the perfect stage for a private hibachi dinner — and our certified chefs bring the full teppanyaki experience right to your estate. From intimate estate dinners to larger lakeside gatherings, every detail is handled for you. Here's what Lake Oswego hosts find when they book with us:` },
    cta:         { src: '/pics/hibachi-chef-home.jpg',  alt: () => `Private hibachi chef at a Lake Oswego OR home`,                        caption: 'The Lake Oswego private dining standard' },
  },
  'salem': {
    testimonial: { src: '/pics/backyard-hibachi-3.jpg', alt: () => `Backyard graduation hibachi party in Salem OR`,       caption: 'Salem graduation season',   trustBadge: 'Thousands of Happy Guests', intro: () => `Salem's Willamette Valley families and state-capital community have made private hibachi a centerpiece of graduation parties, community milestones, and warm-weather backyard gatherings. Our certified chefs travel to your Salem property with everything needed for a full teppanyaki dinner — and leave your backyard spotless. Here's what Salem families are saying:` },
    cta:         { src: '/pics/hibachi-catering-2.jpg', alt: () => `Private hibachi chef performing in Salem OR`,                          caption: 'Your Salem backyard event' },
  },
  'eugene': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg', alt: () => `Graduation hibachi party in Eugene OR`,    caption: 'Eugene graduation celebrations', trustBadge: 'Highly Rated by Local Hosts', intro: () => `Eugene's University of Oregon graduation season brings families together for celebrations that deserve more than a restaurant reservation — and private hibachi at your backyard or Springfield-area property delivers exactly that. Our certified chefs handle all the setup, cook a show-stopping teppanyaki dinner for your group, and clean up completely before they leave. Duck families and Eugene hosts agree:` },
    cta:         { src: '/pics/hibachi-shot-1.jpg',     alt: () => `Private hibachi chef at a Eugene OR graduation party`,                 caption: 'Eugene graduation season standard' },
  },
  'mcminnville': {
    testimonial: { src: '/pics/hibachi-colorado.jpg',   alt: () => `Wine country hibachi gathering in McMinnville OR`, caption: 'McMinnville wine country events', trustBadge: "Oregon's Favorite Hibachi Experience", intro: () => `McMinnville's wine country setting makes it one of Oregon's most scenic spots for a private outdoor dinner, and our hibachi chefs are built for exactly this kind of gathering — vineyard properties, farmhouse backyards, and estate celebrations throughout the Willamette Valley. Everything arrives with your chef: grill, ingredients, and a live teppanyaki performance your guests won't stop talking about. Here's what McMinnville hosts keep telling us:` },
    cta:         { src: '/pics/hibachi-colorado-home.jpg', alt: () => `Private hibachi chef at a McMinnville OR wine country property`,    caption: 'Your McMinnville wine country dinner' },
  },
  'cannon-beach': {
    testimonial: { src: '/pics/hibachi-catering-3.jpg', alt: () => `Group dinner at a Cannon Beach OR vacation rental`,  caption: 'Cannon Beach vacation rental hibachi', trustBadge: '5.0 Average Rating', intro: () => `Cannon Beach vacation rental groups have made private hibachi their go-to dinner for beach weekends, bachelorette parties, and summer family reunions along the Oregon Coast. Our mobile chefs travel to your rental with the full teppanyaki setup — no restaurant wait, no driving, just a live cooking show steps from Haystack Rock. Here's what guests are saying about their Cannon Beach hibachi night:` },
    cta:         { src: '/pics/hibachi-virginia-beach.jpg', alt: () => `Mobile hibachi chef setting up at an Oregon Coast rental`,         caption: 'The Cannon Beach dinner of the summer' },
  },
  'lincoln-city': {
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg', alt: () => `Family reunion hibachi at a Lincoln City OR beach house`, caption: 'Lincoln City group rental hibachi', trustBadge: 'Trusted by Local Families', intro: () => `Lincoln City beach house weekends are better with a private hibachi chef — and vacation groups from family reunions to bachelorette parties have been booking us as the centerpiece of their Oregon Coast getaway. Our mobile chefs travel to your rental with everything needed for a full teppanyaki dinner, then handle every bit of the cleanup so your evening stays relaxed. Here's what Lincoln City vacation groups have to say:` },
    cta:         { src: '/pics/mobile-hibachi-2.jpg',   alt: () => `Mobile hibachi chef at a Lincoln City OR vacation rental`,             caption: 'Your Lincoln City vacation dinner' },
  },
  'bend': {
    testimonial: { src: '/pics/private-hibachi.jpg',    alt: () => `Private hibachi chef at a Bend OR vacation rental`,  caption: 'Bend retreat and vacation events', trustBadge: 'Hundreds of Private Events', intro: () => `Bend's high desert resort lifestyle and booming vacation rental scene have made it one of Oregon's top markets for private hibachi — from Mt. Bachelor ski weekends to summer bachelorette parties and affluent visitor retreats. Our certified chefs travel to your Bend vacation property or short-term rental with the complete teppanyaki setup, delivering a live performance your group will be talking about long after the weekend is over. Bend retreat hosts and visitors agree:` },
    cta:         { src: '/pics/hibachi-colorado-home.jpg', alt: () => `Private hibachi setup at a Bend OR mountain retreat property`,      caption: 'The Bend retreat dinner' },
  },
}
...
const OR_SUPPORT_FALLBACKS = [
  { // Theme 0 — Portland Urban
    testimonial: { src: '/pics/hibachi-catering-3.jpg', alt: (city) => `Portland metro hibachi event in ${city}, OR`,      caption: 'Portland metro hosts agree',          trustBadge: 'Five-Star Entertainment & Dining', intro: (city) => `${city} hosts in the Portland metro area have made private hibachi their first choice for milestone celebrations, neighborhood gatherings, and backyard dinners that go beyond the ordinary. Our certified chefs bring the full teppanyaki experience to your ${city} property — grill, premium proteins, live performance, and zero cleanup left behind. Here's what ${city} hosts are saying:` },
    cta:         { src: '/pics/hero-3.jpg',             alt: (city) => `Private hibachi chef in ${city}, OR`,              caption: 'Your Portland metro event' },
  },
  { // Theme 1 — Corporate / Tech
    testimonial: { src: '/pics/hibachi-catering.jpg',   alt: (city) => `Corporate hibachi event in ${city}, OR`,           caption: 'Washington County hosts agree',        trustBadge: 'Highly Rated by Local Hosts', intro: (city) => `${city}'s tech professionals and Silicon Forest families have turned private hibachi into the standout choice for corporate team dinners, client events, and weekend gatherings in Washington County. We handle every detail — certified chef, premium ingredients, full teppanyaki setup — so the only thing you need to do is enjoy the show. Here's what ${city} hosts keep telling us:` },
  ...
  { // Theme 2 — Affluent Suburb
    testimonial: { src: '/pics/private-hibachi.jpg',    alt: (city) => `Private hibachi event in ${city}, OR`,             caption: 'Portland west side hosts agree',       trustBadge: 'Unforgettable Private Dining Experiences', intro: (city) => `${city} hosts set a high bar for entertaining, and private hibachi rises to meet it every time — a certified chef, hand-selected proteins, and a live teppanyaki performance staged right in your own backyard. From intimate dinner parties to larger family milestones, our chefs deliver the complete experience and leave no trace behind. Here's what ${city} hosts find when they book with us:` },
    cta:         { src: '/pics/hibachi-chef-home.jpg',  alt: (city) => `Private hibachi chef in ${city}, OR`,              caption: 'Your private dining event' },
  },
  { // Theme 3 — Willamette Valley
    testimonial: { src: '/pics/hibachi-colorado.jpg',   alt: (city) => `Willamette Valley hibachi event in ${city}, OR`,   caption: 'Willamette Valley hosts agree',        trustBadge: "Oregon's Favorite Hibachi Experience", intro: (city) => `${city} families in the Willamette Valley have found that private hibachi is the perfect fit for graduation season, community milestones, and warm-weather backyard celebrations surrounded by Oregon's beautiful wine country landscape. Our certified chefs travel to your ${city} property with everything needed — grill, ingredients, and a full live performance. Here's what Willamette Valley hosts are saying:` },
    cta:         { src: '/pics/hibachi-catering-2.jpg', alt: (city) => `Private hibachi chef in ${city}, OR`,              caption: 'Your Willamette Valley celebration' },
  },
  { // Theme 4 — Oregon Coast
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg', alt: (city) => `Oregon Coast hibachi in ${city}, OR`,          caption: 'Oregon Coast vacation guests agree',   trustBadge: '5.0 Average Rating', intro: (city) => `${city} vacation rental groups have made private hibachi one of the most-requested experiences along the Oregon Coast — a live teppanyaki dinner at your beach house that turns a great getaway into an unforgettable one. Our mobile chefs travel to your rental with the full setup, serve groups of all sizes, and leave the space cleaner than they found it. Here's what Oregon Coast guests are saying about their ${city} hibachi night:` },
    cta:         { src: '/pics/mobile-hibachi-2.jpg',   alt: (city) => `Mobile hibachi chef in ${city}, OR`,               caption: 'The Oregon Coast beach house dinner' },
  },
  { // Theme 5 — Central Oregon Mountain
    testimonial: { src: '/pics/hibachi-colorado-home.jpg', alt: (city) => `Central Oregon retreat hibachi in ${city}, OR`, caption: 'Central Oregon retreat hosts agree',   trustBadge: 'Thousands of Happy Guests', intro: (city) => `${city}'s high desert outdoor lifestyle and thriving vacation rental scene make it one of Central Oregon's top spots for a private hibachi experience — from bachelorette weekends and mountain retreats to affluent visitor gatherings near the Cascades. Our certified chefs travel to your ${city} vacation property with the full teppanyaki setup, cook a show-stopping dinner for your group, and handle all cleanup before they leave. Central Oregon retreat hosts and visitors agree:` },
...
const OR_MAJOR_CITIES = {
  // ── Theme 0 — Portland Urban Core ──────────────────────────────────────────
  'portland':     { v: 0, profileIdx: 0, nearby: ['Beaverton', 'Hillsboro', 'Lake Oswego', 'Gresham', 'Tigard', 'Tualatin'] },
  // ── Theme 1 — Portland Corporate / Tech ────────────────────────────────────
  'beaverton':    { v: 1, profileIdx: 1, nearby: ['Hillsboro', 'Portland', 'Lake Oswego', 'Tigard', 'Tualatin'] },
  'hillsboro':    { v: 1, profileIdx: 2, nearby: ['Beaverton', 'Portland', 'Forest Grove', 'Tigard', 'Aloha'] },
  // ── Theme 2 — Portland Affluent Suburb ─────────────────────────────────────
  'lake-oswego':  { v: 2, profileIdx: 3, nearby: ['Portland', 'West Linn', 'Tualatin', 'Wilsonville', 'Beaverton'] },
  // ── Theme 3 — Willamette Valley ─────────────────────────────────────────────
  'salem':        { v: 3, profileIdx: 4, nearby: ['Silverton', 'Keizer', 'McMinnville', 'Eugene', 'Portland'] },
  'eugene':       { v: 3, profileIdx: 5, nearby: ['Springfield', 'Corvallis', 'Salem', 'McMinnville'] },
  'mcminnville':  { v: 3, profileIdx: 6, nearby: ['Newberg', 'Carlton', 'Salem', 'Portland', 'Eugene'] },
  // ── Theme 4 — Oregon Coast ──────────────────────────────────────────────────
  'cannon-beach': { v: 4, profileIdx: 7, nearby: ['Seaside', 'Astoria', 'Manzanita', 'Lincoln City'] },
  'lincoln-city': { v: 4, profileIdx: 8, nearby: ['Depoe Bay', 'Newport', 'Seaside', 'Cannon Beach'] },
  // ── Theme 5 — Central Oregon Mountain ──────────────────────────────────────
  'bend':         { v: 5, profileIdx: 9, nearby: ['Redmond', 'Sisters', 'Sunriver', 'La Pine'] },
}
...
export function getOregonCityData(citySlug, cityName) {
  ...
  return {
    ...
    nearbyMajorCities: ['Portland', 'Bend', 'Eugene', 'Salem', 'McMinnville'].filter(c => c.toLowerCase().replace(/ /g, '-') !== citySlug),
