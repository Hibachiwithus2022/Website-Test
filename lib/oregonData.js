...
const OR_SECTION_VARIANTS = [
  // Theme 0 — Portland Urban Core
  {
    ...
    experiencePoints:   [
      { icon: '🏡', title: 'Your Portland Space Is the Venue',  desc: 'No reservation battles — your backyard or deck becomes an exclusive private dining room for your guests.' },
  ...
  // Theme 1 — Portland Corporate / Tech
  {
    ...
    experiencePoints:   [
      { icon: '🏢', title: 'Your Venue, Your Rules',            desc: 'No reservation required — your outdoor corporate space or backyard becomes the setting for an exclusive private dinner.' },
      ...
      { icon: '🔥', title: 'Exclusive Live Performance',        desc: 'A certified teppanyaki chef performs exclusively for your group — 90–120 minutes of fire tricks, cooking, and entertainment.' },
      { icon: '🧹', title: 'Setup & Cleanup Included',         desc: 'Your chef arrives early, sets up completely, and packs out after dinner. Zero logistics for you to manage.' },
    ],
  ...
  // Theme 2 — Portland Affluent Suburb
  {
    ...
    experiencePoints:   [
      { icon: '🏡', title: 'Your Terrace or Garden Is the Venue', desc: 'No reservation battles — your private terrace or garden becomes an exclusive dining room for the evening.' },
      ...
      { icon: '⏱️', title: '90–120 Minute Performance',           desc: 'A certified teppanyaki chef runs a full cooking show keeping every guest engaged from first flame to last plate.' },
      { icon: '🥩', title: 'Premium Protein Upgrades',            desc: 'Filet mignon, lobster tail, and other premium upgrades available — customize the menu to match the occasion.' },
    ],
  ...
  // Theme 3 — Willamette Valley
  {
    ...
    experiencePoints:   [
      { icon: '🏡', title: 'Chef at Your Valley Property',       desc: 'A certified private hibachi chef comes to your backyard, estate, or wine country property — no logistics to manage.' },
      { icon: '🔥', title: 'Full Live Show Outdoors',            desc: 'All guests gathered at the same outdoor grill for the complete teppanyaki performance — fire tricks, proteins cooked to order.' },
      { icon: '🎓', title: 'Graduation & Vineyard Events',       desc: 'Graduation parties, anniversary dinners, and vineyard gatherings — the Willamette Valley calendar, handled perfectly.' },
      { icon: '🧹', title: 'Setup & Cleanup Included',          desc: 'Full setup before the event and complete cleanup after. You host without a single logistical detail to manage.' },
    ],
  ...
  // Theme 4 — Oregon Coast
  {
    ...
    experiencePoints:   [
      { icon: '🏖️', title: 'Chef at Your Coast Rental',          desc: 'Skip the coastal restaurant battle — your chef arrives at your rental with everything needed for a full teppanyaki show.' },
      { icon: '🔥', title: 'Live Show at Your Property',          desc: 'All guests gathered outdoors for the full performance — fire tricks, flying shrimp, proteins cooked to order.' },
      ...
      { icon: '🏠', title: 'Property Stays Spotless',             desc: 'Full setup and complete pack-out included. Your Oregon Coast rental looks exactly as it did when the chef arrived.' },
    ],
  ...
  // Theme 5 — Central Oregon Mountain
  {
    ...
    experiencePoints:   [
      { icon: '🏔️', title: 'Chef at Your Mountain Property',    desc: 'A certified private hibachi chef travels to your Bend cabin, resort house, or vacation rental — no logistics for you to handle.' },
      ...
      { icon: '👥', title: 'From Intimate to Large Groups',     desc: 'Intimate groups of 8–20 or larger retreat gatherings up to 60 — one or two stations sized to your exact guest count.' },
