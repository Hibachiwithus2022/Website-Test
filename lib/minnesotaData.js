...
const MN_CITY_IMAGE_MAP = {
  ...
  'woodbury':     { src: '/pics/hibachi-catering.jpg',       alt: (city) => `Private hibachi chef at a Woodbury, MN home celebration` },
  // Batch 4
...
const MN_SUPPORT_IMAGES = {
  ...
  // Batch 2 city-specific support (prevent cityImg ↔ fallback conflicts)
  'eden-prairie': {
    testimonial: { src: '/pics/hibachi-pool-party.jpg',   alt: (city) => `Happy guests at a private hibachi dinner in Eden Prairie, MN`,          caption: '' },
    cta:         { src: '/pics/hibachi-catering.jpg',     alt: (city) => `Private hibachi chef experience in Eden Prairie, Minnesota` },
  },
  'minneapolis': {
    testimonial: { src: '/pics/hibachi-catering-3.jpg',   alt: (city) => `Private hibachi chef at a Minneapolis, MN corporate event`,            caption: '' },
    cta:         { src: '/pics/hibachi-pool-party.jpg',   alt: (city) => `Private hibachi team dinner in Minneapolis, Minnesota` },
  },
  'maple-grove': {
    testimonial: { src: '/pics/hibachi-event.jpg',        alt: (city) => `Happy guests at a Maple Grove, MN graduation party hibachi event`,     caption: '' },
    cta:         { src: '/pics/hibachi-catering.jpg',     alt: (city) => `Backyard hibachi chef at a Maple Grove, Minnesota graduation party` },
  },
  // Batch 4 city-specific support (prevent cityImg ↔ T5 fallback conflicts)
  'stillwater': {
    testimonial: { src: '/pics/mobile-hibachi-2.jpg',     alt: (city) => `Guests at a Stillwater, MN St. Croix vacation rental hibachi event`,   caption: '' },
    cta:         { src: '/pics/hibachi-in-garage.jpg',    alt: (city) => `Mobile hibachi chef at a Stillwater, Minnesota river rental event` },
  },
  'brainerd': {
    testimonial: { src: '/pics/traveling-hibachi.jpg',    alt: (city) => `Mobile hibachi chef traveling to a Brainerd Lakes cabin event`,        caption: '' },
    cta:         { src: '/pics/hibachi-in-garage.jpg',    alt: (city) => `Mobile hibachi chef at a Brainerd, MN cabin or resort event` },
  },
}
...
const MN_SUPPORT_FALLBACKS = [
  ...
  { testimonial: { src: '/pics/backyard-hibachi.jpg',     alt: (city) => `Backyard hibachi chef in ${city}, MN`, caption: '' }, cta: { src: '/pics/hibachi-pool-party.jpg',   alt: (city) => `Hibachi at home in ${city}, Minnesota` } },  // T2
  { testimonial: { src: '/pics/hibachi-catering-3.jpg',   alt: (city) => `Private hibachi in ${city}, MN`,       caption: '' }, cta: { src: '/pics/hibachi-pool-party.jpg',   alt: (city) => `Hibachi at home in ${city}, Minnesota` } },  // T3
...
// ── H1 prefixes ────────────────────────────────────────────────────────────────
// Distribution: At Home=7(41%), Private Chef=3(18%), Catering=2(12%), Mobile=3(18%), Backyard=2(12%)
const MN_PROFILE_H1_PREFIXES = [
  'Hibachi at Home in',      // 0: Edina (luxury estate)
  'Hibachi at Home in',      // 1: Wayzata (lake estate)
  'Hibachi at Home in',      // 2: Minnetonka (affluent residential)
  'Private Hibachi Chef in', // 3: Rochester (milestone/medical market)
  'Mobile Hibachi Chef in',  // 4: Duluth (vacation rental destination)
  'Private Hibachi Chef in', // 5: Minneapolis (corporate/urban)
  'Private Hibachi Chef in', // 6: Bloomington (corporate corridor)
  'Hibachi at Home in',      // 7: Eden Prairie (affluent residential)
  'Backyard Hibachi in',     // 8: Maple Grove (suburban/graduation culture)
  'Hibachi at Home in',      // 9: Plymouth (suburban residential)
  'Hibachi at Home in',      // 10: St. Paul (home dinner party market)
  'Hibachi at Home in',      // 11: Woodbury (affluent east metro)
  'Backyard Hibachi in',     // 12: Eagan (suburban/graduation culture)
  'Hibachi Catering in',     // 13: Burnsville (south metro catering)
  'Hibachi Catering in',     // 14: Lakeville (growing south metro)
  'Mobile Hibachi Chef in',  // 15: Stillwater (St. Croix destination)
  'Mobile Hibachi Chef in',  // 16: Brainerd (lakes country destination)
]

const MN_THEME_H1_PREFIXES = [
  'Hibachi at Home in',      // T0: Luxury
  'Private Hibachi Chef in', // T1: Urban/Corporate
  'Hibachi at Home in',      // T2: Suburban/Family
  'Hibachi at Home in',      // T3: River & Lakes
  'Private Hibachi Chef in', // T4: Medical/Rochester
  'Mobile Hibachi Chef in',  // T5: Destination/Duluth
]
...
const MN_CUSTOM_META = {
  ...
  'rochester': {
    title: 'Private Hibachi Chef in Rochester, MN | Mayo Clinic Area Events',
    desc:  'Private hibachi chef for Rochester graduation dinners, family milestones, and fellowship celebrations near Mayo Clinic. Full teppan setup at your home. Book today.',
  },
  'duluth': {
    title: 'Mobile Hibachi Chef in Duluth, MN | Canal Park & North Shore',
    desc:  'Mobile hibachi chef for Duluth vacation rentals, Canal Park events, and North Shore cabin dinners on Lake Superior. Fully self-contained setup. Book today.',
  },
  // Batch 2
  'minneapolis': {
    title: 'Private Hibachi Chef in Minneapolis, MN | Twin Cities Corporate & Home Events',
    desc:  'Private hibachi chef for Minneapolis corporate events, team dinners, and home celebrations. North Loop, Uptown, Loring Park. Serves groups of 10–80+. Book today.',
  },
  'bloomington': {
    title: 'Private Hibachi Chef in Bloomington, MN | Corporate Events Near MOA',
    desc:  'Private hibachi chef for Bloomington corporate events, client appreciation dinners, and home celebrations near Mall of America. Full setup, complete cleanup. Book today.',
  },
  'eden-prairie': {
    title: 'Hibachi at Home in Eden Prairie, MN | Private Estate Chef',
    desc:  'Private hibachi chef for Eden Prairie estate dinners, corporate client events, and family celebrations near Round Lake. Premium proteins, full teppan performance. Book today.',
  },
  'maple-grove': {
    title: 'Backyard Hibachi in Maple Grove, MN | Graduation Party Chef',
    desc:  'Backyard hibachi chef for Maple Grove graduation parties, milestone birthdays, and neighborhood events. Full setup and complete cleanup. Northwest Twin Cities. Book today.',
  },
  'plymouth': {
    title: 'Hibachi at Home in Plymouth, MN | Private Hibachi Chef',
    desc:  'Private hibachi chef for Plymouth home events, graduation parties, and family milestones near Medicine Lake. Full teppan performance in your backyard. Book today.',
  },
  // Batch 3
  'st-paul': {
  ...
  'woodbury': {
    ...
    desc:  'Private hibachi chef for Woodbury home events, family milestone dinners, and backyard celebrations in the east Twin Cities metro. Full setup and cleanup. Book today.',
  },
  'eagan': {
    title: 'Backyard Hibachi in Eagan, MN | Graduation Party Chef',
    desc:  'Backyard hibachi chef for Eagan graduation parties, family milestones, and neighborhood events in the south Twin Cities metro. Full setup, complete cleanup. Book today.',
  },
  'burnsville': {
    title: 'Hibachi Catering in Burnsville, MN | South Metro Private Chef',
    desc:  'Hibachi catering for Burnsville backyard parties, graduation celebrations, and family events near Crystal Lake. Full teppan setup and cleanup included. Book today.',
  },
  'lakeville': {
    title: 'Hibachi Catering in Lakeville, MN | South Metro Events',
    desc:  'Hibachi catering for Lakeville graduation parties, milestone birthdays, and family events. Full teppan chef, all proteins, complete cleanup. South metro. Book today.',
  },
  // Batch 4
  'stillwater': {
    title: 'Mobile Hibachi Chef in Stillwater, MN | St. Croix River Rentals',
    desc:  'Mobile hibachi chef for Stillwater vacation rentals, river property dinners, and weekend getaway events along the St. Croix. Self-contained setup. Book today.',
  },
  'brainerd': {
    title: 'Mobile Hibachi Chef in Brainerd, MN | Lakes Country Cabin Events',
    desc:  'Mobile hibachi chef for Brainerd Lakes cabin events, resort stays, and family reunion dinners. Fully self-contained propane setup. Minnesota lake country. Book today.',
  },
}
