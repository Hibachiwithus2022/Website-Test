...
const DE_SECTION_VARIANTS = [
  // Theme 0 — Wilmington Corporate
  {
    ...
    experiencePoints:   [
      ...
      'Greater Wilmington and all of northern Delaware fully served',
  ...
  // Theme 2 — Party Beach / Bachelorette
  {
    ...
    experiencePoints:   [
      'Chef comes directly to your rental — no Route 1 restaurant battles',
  ...
  // Theme 3 — Coastal Family / Vacation Home
  {
    ...
    experiencePoints:   [
      'Private chef comes to your vacation rental or coastal home',
      'Premium proteins, live fire performance, full service',
      'Intimate groups of 8–20 or larger family gatherings up to 60',
