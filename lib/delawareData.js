...
const DE_SECTION_VARIANTS = [
  // Theme 0 — Wilmington Corporate
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏠', title: `Your ${city} Space Is the Venue`,    desc: `No restaurant reservation required — your ${city} outdoor space becomes an exclusive private dining room for your group.` },
      ...
      { icon: '📍', title: 'All of Northern Delaware Served',    desc: `Wilmington, Hockessin, Greenville, Newark, Bear, Pike Creek — wherever your ${city} property is, we come to you.` },
  ...
  // Theme 1 — Brandywine Affluent / Suburban
  {
    ...
    experiencePoints:   (city) => [
      ...
      { icon: '🎓', title: 'Built for Graduation Season',       desc: `The Brandywine Valley's highest-demand window — when every ${city} restaurant is fully booked, we come to your backyard.` },
      { icon: '🧹', title: 'Arrive & Disappear Spotless',       desc: 'Your chef arrives fully equipped, sets up completely, cooks the entire dinner, and packs out after. You host without lifting a finger.' },
    ],
  ...
  // Theme 2 — Party Beach / Bachelorette
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏖️', title: `Chef at Your ${city} Rental`,       desc: `Skip the Route 1 reservation battle — your chef comes directly to your ${city} property with everything needed for a full teppanyaki show.` },
      { icon: '🔥', title: 'Fire Tricks at the Deck',           desc: 'All guests gathered at the same outdoor grill for the full performance — fire tricks, flying shrimp, proteins cooked to order.' },
      { icon: '🎭', title: '90–120 Minute Beach House Show',    desc: `The volcano, the flaming grill, every plate cooked fresh at your ${city} rental — no restaurant can replicate this.` },
      { icon: '🏠', title: 'Rental Stays Spotless',             desc: 'Full setup before the event and complete pack-out after. Your Delaware beach rental looks exactly as it did when the chef arrived.' },
    ],
  ...
  // Theme 3 — Coastal Family / Vacation Home
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏡', title: `Chef at Your ${city} Property`,    desc: `A certified private hibachi chef comes directly to your ${city} vacation rental or coastal home — no logistics for you to manage.` },
      { icon: '🥩', title: 'Premium Proteins, Live Fire',      desc: 'Choose your proteins — chicken, steak, shrimp, salmon, filet mignon, lobster tail — all cooked live on the teppan at the water\'s edge.' },
      { icon: '👥', title: 'Scales from 8 to 60 Guests',      desc: `Intimate ${city} dinners of 8–20 or larger family gatherings up to 60 — one or two stations sized to your exact guest count.` },
      { icon: '✨', title: 'Vacation Stays Immaculate',        desc: 'Flawless setup, full service throughout, and complete cleanup. You enjoy the coastal evening; we handle everything else.' },
    ],
  ...
  // Theme 4 — Central & Southern Delaware
  {
    ...
    experiencePoints:   (city) => [
      { icon: '👥', title: `Two Stations for ${city} Groups`,  desc: `Two chef stations running simultaneously for ${city} groups of 25–60+ — faster service and double the performance energy.` },
...
const DE_CITY_IMAGE_MAP = {
  // Theme 0 — Wilmington Corporate
  'wilmington':      { src: '/pics/hibachi-wilmington.jpg',     alt: (city) => `Private hibachi chef at a Wilmington, DE corporate event` },
...
const DE_SUPPORT_IMAGES = {
  'wilmington': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',     alt: (city) => `Corporate hibachi event in Wilmington, DE`,          caption: 'Wilmington corporate dining',         trustBadge: '5.0 Average Rating',                          intro: (city) => `Wilmington professionals, corporate teams, and families all choose Hibachi Connect when the event needs to be truly memorable. From Trolley Square gatherings to Brandywine riverfront celebrations, our certified chefs bring the full teppanyaki experience to your door. See what Wilmington hosts have discovered:` },
  ...
  'newark': {
    testimonial: { src: '/pics/hibachi-at-home.jpg',        alt: (city) => `Graduation hibachi event in Newark, DE`,             caption: 'Newark graduation season',            trustBadge: 'Trusted by Local Families',                   intro: (city) => `Newark families and University of Delaware graduates choose private hibachi when they want a celebration that genuinely stands apart. Backyard graduation dinners, birthday parties, and family milestones — our chefs show up, perform, and leave without a trace. See what Newark and UD-area hosts are saying:` },
  ...
  'rehoboth-beach': {
    testimonial: { src: '/pics/hibachi-photo-1.jpg',        alt: (city) => `Bachelorette hibachi at a Rehoboth Beach rental`,    caption: 'Rehoboth beach house hibachi',         trustBadge: 'Hundreds of Private Events',                  intro: (city) => `Rehoboth Beach vacation rentals and beach house weekends are the perfect setting for private hibachi. Whether it's a bachelorette group, a family reunion, or friends looking for something genuinely unforgettable — our chefs travel to your rental, bring everything, and deliver a dinner nobody forgets. See why Rehoboth guests return every summer:` },
  ...
  'dover': {
    testimonial: { src: '/pics/hibachi-shot-2.jpg',         alt: (city) => `Graduation hibachi party in Dover, DE`,              caption: 'Dover graduation season',             trustBadge: 'Thousands of Happy Guests',                   intro: (city) => `Dover families turn to private hibachi when the occasion calls for something far more memorable than a restaurant reservation. Graduation dinners, backyard birthday celebrations, and family milestones — our chefs arrive with everything and leave your space spotless. See what Dover hosts have been saying:` },
    cta:         { src: '/pics/hibachi-event.jpg',           alt: (city) => `Private hibachi chef at a Dover DE event`,           caption: 'Dover\'s backyard party standard' },
  },
  'hockessin': {
    testimonial: { src: '/pics/hibachi-chef-at-home.jpg',   alt: (city) => `Private hibachi dinner party in Hockessin, DE`,      caption: 'Hockessin private dining events',     trustBadge: 'Highly Rated by Local Hosts',                 intro: (city) => `Hockessin hosts expect quality, and our private chefs deliver it at every event. From intimate backyard dinners to milestone birthday celebrations, Hockessin families choose hibachi because nothing else combines live entertainment with a truly elevated dining experience. Here's what they find:` },
  ...
  'greenville': {
    testimonial: { src: '/pics/hibachi-chef-2.jpg',         alt: (city) => `Estate hibachi dinner in Greenville, DE`,            caption: 'Greenville estate entertaining',       trustBadge: 'Unforgettable Private Dining Experiences',    intro: (city) => `Greenville hosts demand the exceptional — and our private hibachi chefs deliver it at every event. Estate dinners, luxury backyard gatherings, and milestone celebrations in Delaware's most prestigious neighborhoods are our specialty. See what Greenville hosts have discovered:` },
  ...
  'lewes': {
    testimonial: { src: '/pics/mobile-hibachi.jpg',         alt: (city) => `Private hibachi dinner at a Lewes DE beach house`,   caption: 'Lewes vacation home hibachi',          trustBadge: "Delaware's Favorite Hibachi Experience",      intro: (city) => `Lewes vacation homes and waterfront properties are the perfect setting for a private hibachi dinner. Summer guests, holiday weekends, and family reunion weekends all become more memorable when a certified chef brings the full teppanyaki experience to your rental. Here's why Lewes hosts keep coming back:` },
    cta:         { src: '/pics/hibachi-colorado.jpg',        alt: (city) => `Private hibachi chef in Lewes, DE`,                  caption: 'The Lewes coastal dinner' },
  },
  'bethany-beach': {
    testimonial: { src: '/pics/hibachi-austin-home.jpg',    alt: (city) => `Family reunion hibachi at a Bethany Beach rental`,   caption: 'Bethany Beach family vacations',       trustBadge: 'Five-Star Entertainment & Dining',            intro: (city) => `Bethany Beach family vacations deserve a dinner moment nobody forgets. Our private chefs travel to your beach rental, set up on your deck or patio, and deliver a full hibachi show — fire tricks, fresh proteins, and a performance your guests will talk about long after the weekend ends. See why Bethany Beach families book us year after year:` },
  ...
  'dewey-beach': {
    testimonial: { src: '/pics/hibachi-photo-1.jpg',        alt: (city) => `Bachelorette hibachi weekend in Dewey Beach, DE`,    caption: 'Dewey Beach bachelorette weekends',    trustBadge: 'Hundreds of Private Events',                  intro: (city) => `Dewey Beach weekends and bachelorette groups come to us when they want the best dinner of the trip — without ever leaving the rental. Fire tricks, fresh proteins, and a chef who keeps the energy high all night. Here's what Dewey Beach groups are saying:` },
  ...
  'bear': {
    testimonial: { src: '/pics/hibachi-catering-3.jpg',     alt: (city) => `Backyard hibachi party in Bear, DE`,                 caption: 'Bear backyard hibachi events',         trustBadge: 'Trusted by Local Families',                   intro: (city) => `Bear families celebrate in the backyard, and private hibachi turns any outdoor space into a five-star dining room. Birthday parties, graduation dinners, and neighborhood celebrations all become unforgettable when a certified teppanyaki chef shows up at your door. Here's what Bear hosts are saying:` },
  ...
  'middletown': {
    testimonial: { src: '/pics/hibachi-event.jpg',          alt: (city) => `Backyard graduation party in Middletown, DE`,        caption: 'Middletown graduation celebrations',   trustBadge: 'Thousands of Happy Guests',                   intro: (city) => `Middletown families know the difference between a good party and an unforgettable one — and private hibachi is the difference. Graduation celebrations, backyard birthdays, and family milestones all deserve a chef who brings the full experience to your door. Here's what Middletown hosts say:` },
  ...
  'pike-creek': {
    testimonial: { src: '/pics/hibachi-at-home.jpg',        alt: (city) => `Private hibachi dinner in Pike Creek, DE`,           caption: 'Pike Creek private dining events',     trustBadge: 'Highly Rated by Local Hosts',                 intro: (city) => `Pike Creek hosts choose private hibachi when they want a dinner experience that goes beyond anything a local restaurant can offer. From neighborhood birthday parties to intimate family celebrations, our chefs arrive fully equipped and leave with everything they brought. Here's what Pike Creek hosts have found:` },
  ...
  'smyrna': {
    testimonial: { src: '/pics/hibachi-catering.jpg',       alt: (city) => `Backyard hibachi party in Smyrna, DE`,               caption: 'Smyrna backyard celebrations',         trustBadge: 'Five-Star Entertainment & Dining',            intro: (city) => `Smyrna families bring private hibachi to their backyard celebrations, graduation parties, and holiday dinners — and they keep coming back for the same reason: nothing else comes close. Our chefs travel to your home with full setup and zero cleanup required. Here's what Smyrna hosts say:` },
...
const DE_SUPPORT_FALLBACKS = [
  // Theme 0 — Wilmington Corporate
  {
    testimonial: { src: '/pics/hibachi-catering.jpg',       alt: (city) => `Corporate hibachi event in ${city}, DE`,             caption: 'Delaware professionals agree',         trustBadge: '5.0 Average Rating',                          intro: (city) => `${city} professionals and families choose private hibachi for corporate events, milestone birthdays, and team celebrations — an experience that turns any outdoor space into an exclusive private dining room. Our certified chefs bring the full setup and leave your property exactly as they found it. Here's what ${city} hosts are saying:` },
  ...
  {
    testimonial: { src: '/pics/hibachi-dallas-home.jpg',    alt: (city) => `Backyard hibachi event in ${city}, DE`,              caption: 'Brandywine Valley hosts agree',        trustBadge: 'Highly Rated by Local Hosts',                 intro: (city) => `${city} hosts choose private hibachi when they want their backyard celebration to feel like something genuinely different. Birthday dinners, neighborhood gatherings, and family milestones are our specialty — and our chefs handle everything from setup through cleanup. Here's what ${city} hosts have discovered:` },
    cta:         { src: '/pics/backyard-hibachi-2.jpg',      alt: (city) => `Private hibachi chef in ${city}, DE`,                caption: 'Your backyard, upgraded' },
  },
  // Theme 2 — Party Beach
  {
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg', alt: (city) => `Beach house hibachi in ${city}, DE`,                 caption: 'Delaware beach guests agree',          trustBadge: 'Hundreds of Private Events',                  intro: (city) => `${city} vacation rentals and beach weekends become unforgettable with a private hibachi chef on your deck or patio. Bachelorette groups, family reunions, and summer weekend celebrations all love the live-fire entertainment and fresh teppanyaki dining. Here's why ${city} guests keep coming back:` },
    cta:         { src: '/pics/hibachi-photo-2.jpg',         alt: (city) => `Mobile hibachi chef in ${city}, DE`,                 caption: 'The Delaware shore dinner upgrade' },
  },
  // Theme 3 — Coastal Family
  {
    testimonial: { src: '/pics/hibachi-colorado.jpg',       alt: (city) => `Vacation rental hibachi in ${city}, DE`,             caption: 'Delaware coastal hosts agree',         trustBadge: "Delaware's Favorite Hibachi Experience",      intro: (city) => `${city} vacation guests discover something new every summer: nothing elevates a beach rental weekend quite like a private hibachi dinner. Our chefs travel to your property with the full setup and deliver fresh teppanyaki with fire tricks your guests will talk about for years. Here's what ${city} hosts are saying:` },
    cta:         { src: '/pics/traveling-hibachi.jpg',       alt: (city) => `Private hibachi chef in ${city}, DE`,                caption: 'The Delaware coastal dinner' },
  },
  // Theme 4 — Central/Southern Delaware
  {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',     alt: (city) => `Family hibachi gathering in ${city}, DE`,            caption: 'Central Delaware families celebrate',  trustBadge: 'Trusted by Local Families',                   intro: (city) => `${city} families celebrate their milestones — graduations, birthdays, and backyard reunions — with a private hibachi chef who brings the entire experience to their door. Real food, real entertainment, full cleanup included. Here's what ${city} families are saying:` },
...
const DE_CUSTOM_META = {
  ...
  'newark': {
    title: 'Hibachi Catering in Newark, DE | UD Graduation Parties & Private Events | Hibachi Connect',
    desc:  'Book hibachi catering in Newark, DE for University of Delaware graduation parties, backyard birthdays, and milestone events. Certified chef, full setup & cleanup. From $60/adult.',
  },
  'dover': {
    title: 'Hibachi Catering in Dover, DE | Graduation Parties & Private Events | Hibachi Connect',
    desc:  'Book hibachi catering in Dover, DE for graduation parties, family milestones, and community events. Certified teppanyaki chef, full setup & cleanup. From $60/adult. Serving all of central Delaware.',
  },
  'hockessin': {
    title: 'Private Hibachi Chef in Hockessin, DE | Brandywine Valley Backyard Dining | Hibachi Connect',
    desc:  'A certified private hibachi chef at your Hockessin, DE backyard or estate. Premium proteins, live teppanyaki, complete cleanup. Perfect for graduation parties and milestone occasions. From $60/adult.',
  },
  'dewey-beach': {
    title: 'Mobile Hibachi in Dewey Beach, DE | Beach House Private Chef | Hibachi Connect',
    desc:  'A certified mobile hibachi chef comes to your Dewey Beach vacation rental. Full setup, live show, complete cleanup — no Route 1 reservations required. From $60/adult. Book your beach date now.',
  },
  'bear': {
    title: 'Backyard Hibachi in Bear, DE | Private Teppanyaki Chef at Home | Hibachi Connect',
    desc:  'Book a backyard hibachi chef in Bear, DE. Live teppanyaki at your home, full setup & cleanup. Perfect for graduation parties, neighborhood gatherings, and family celebrations. From $60/adult.',
  },
  'fenwick-island': {
    title: 'Hibachi at Home in Fenwick Island, DE | Beach House Private Chef | Hibachi Connect',
    desc:  'A certified hibachi chef comes to your Fenwick Island vacation rental or beach house. Perfect for family reunions, beach weekends, and group dinners. Full setup & cleanup. From $60/adult.',
  },
  'ocean-view': {
    title: 'Hibachi at Home in Ocean View, DE | Vacation Rental Private Chef | Hibachi Connect',
    desc:  'Book a private hibachi chef for your Ocean View, DE vacation rental or beach property. Family reunions, beach weekends, and group dinners. Full setup & cleanup. From $60/adult.',
  },
  'milton': {
    title: 'Hibachi at Home in Milton, DE | Private Teppanyaki Chef | Hibachi Connect',
    desc:  'A certified private hibachi chef comes to your Milton, DE home or vacation property. Live teppanyaki, full setup & cleanup. Serving Milton and all of Sussex County. From $60/adult.',
  },
  'selbyville': {
    title: 'Hibachi at Home in Selbyville, DE | Private Hibachi Chef | Hibachi Connect',
    desc:  'Book a private hibachi chef in Selbyville, DE for beach house events and family celebrations. Full setup & cleanup, live teppanyaki performance. From $60/adult. Serving all of southern Delaware.',
  },
  'milford': {
    title: 'Hibachi at Home in Milford, DE | Backyard Hibachi Chef | Hibachi Connect',
    desc:  'Book a private hibachi chef for your Milford, DE backyard or outdoor space. Family reunions, graduation parties, and milestone events. Full setup & cleanup. From $60/adult.',
  },
  'georgetown': {
    title: 'Hibachi at Home in Georgetown, DE | Private Teppanyaki Chef | Hibachi Connect',
    desc:  'A certified hibachi chef comes to your Georgetown, DE home for graduation parties, family gatherings, and community celebrations. Full setup & cleanup. From $60/adult.',
  },
  'seaford': {
    title: 'Hibachi at Home in Seaford, DE | Private Hibachi Chef | Hibachi Connect',
    desc:  'Book a private hibachi chef in Seaford, DE for backyard events and family celebrations. Live teppanyaki, full setup & cleanup. Serving Seaford and all of southern Delaware. From $60/adult.',
  },
}
