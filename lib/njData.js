...
const NJ_SUPPORT_IMAGES = {
  'jersey-city': {
    testimonial: { src: '/pics/hibachi-photo-2.jpg',      alt: (city) => `Guests at a Jersey City rooftop hibachi event`,   caption: 'Jersey City rooftop hibachi',         trustBadge: 'Trusted by Local Families', intro: (city) => `Jersey City rooftop events and downtown celebrations have made private hibachi one of the most-requested dinner formats along the Hudson. Our certified chefs travel to your rooftop, terrace, or backyard with the full teppanyaki setup — fire tricks, fresh proteins, and complete cleanup. Here's what Jersey City hosts are saying:` },
  ...
  'hoboken': {
    testimonial: { src: '/pics/hibachi-at-home.jpg',      alt: (city) => `Bachelorette hibachi event in Hoboken, NJ`,       caption: 'Hoboken groups love private hibachi',  trustBadge: 'Hundreds of Private Events', intro: (city) => `Hoboken's vibrant social scene — from bachelorette weekends to rooftop send-offs — has made private hibachi a staple for groups who want something beyond the usual bar crawl. One square mile of density means our chefs are never far away, and the live teppanyaki show always steals the night. See why Hoboken keeps calling us back:` },
  ...
  'princeton': {
    testimonial: { src: '/pics/backyard-hibachi-3.jpg',   alt: (city) => `Princeton graduation hibachi dinner`,             caption: 'Princeton graduation season',         trustBadge: 'Five-Star Entertainment & Dining', intro: (city) => `Princeton graduation season fills every restaurant in town — but the best celebrations happen at home, where a certified hibachi chef can perform for 20 or 60 guests on your own schedule. University families and academic households across Mercer County trust us for backyard dinners that match the milestone. Here's what Princeton hosts have to say:` },
  ...
  'cherry-hill': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',   alt: (city) => `Family hibachi celebration in Cherry Hill, NJ`,  caption: 'South Jersey families celebrate here', trustBadge: 'Thousands of Happy Guests', intro: (city) => `Cherry Hill families across South Jersey have turned private hibachi into the go-to format for birthdays, sweet sixteens, and backyard milestones that everyone actually remembers. Our certified chefs bring the full teppanyaki experience — fire, flair, fresh proteins, and zero cleanup — directly to your Cherry Hill home. Here's what South Jersey hosts are sharing:` },
  ...
  'edison': {
    testimonial: { src: '/pics/hibachi-shot-1.jpg',       alt: (city) => `Large family hibachi gathering in Edison, NJ`,   caption: 'Edison families go big',              trustBadge: "New Jersey's Favorite Hibachi Experience", intro: (city) => `Edison's multicultural community brings together some of the most spirited and large-scale celebrations in the Garden State — milestone birthdays, engagement parties, and extended family dinners where 40 guests is just the starting point. We run dual-station setups regularly in Edison, matching the energy and scale your event deserves. Here's what Edison families are saying:` },
    cta:         { src: '/pics/hibachi-event.jpg',        alt: (city) => `Dual-station hibachi event in Edison, NJ`,       caption: 'Two stations, 50 guests, one night' },
  },
  'morristown': {
    testimonial: { src: '/pics/hero-4.jpg',               alt: (city) => `Corporate hibachi event in Morristown, NJ`,      caption: 'Morris County professionals',         trustBadge: 'Highly Rated by Local Hosts', intro: (city) => `Morristown's professional community and Morris County's affluent suburbs have embraced private hibachi as the premier format for corporate team dinners, milestone gatherings, and upscale backyard events. Our chefs bring the full production to your venue — live fire, premium proteins, and seamless service from arrival to cleanup. Here's what Morristown professionals have to say:` },
  ...
  'montclair': {
    testimonial: { src: '/pics/hibachi-dallas.jpg',       alt: (city) => `Dinner party hibachi in Montclair, NJ`,          caption: 'Montclair dinner parties done right',  trustBadge: 'Unforgettable Private Dining Experiences', intro: (city) => `Montclair's arts-forward community and discerning dinner party culture demand something more imaginative than a standard restaurant night — and private hibachi delivers the performance, the food, and the conversation starter all in one. Our certified chefs work seamlessly in Montclair backyards and open-plan spaces, leaving guests genuinely impressed. Here's what Montclair hosts are telling us:` },
  ...
  'asbury-park': {
    testimonial: { src: '/pics/hibachi-shot-2.jpg',       alt: (city) => `Bachelorette hibachi weekend in Asbury Park, NJ`,caption: 'Asbury Park groups come back every summer', trustBadge: '5.0 Average Rating', intro: (city) => `Asbury Park's Shore energy — bachelorette weekends, beach house gatherings, and summer social events — is the perfect backdrop for a private hibachi chef who brings the show directly to your rental. The Jersey Shore crowd comes for the fire tricks and stays for the food; by the end of the night everyone's already planning next summer's booking. See what Asbury Park groups are saying:` },
  ...
  'cape-may': {
    testimonial: { src: '/pics/hibachi-wilmington.jpg',   alt: (city) => `Private hibachi on a Cape May porch`,            caption: 'Cape May vacation rental hibachi',    trustBadge: 'Trusted by Local Families', intro: (city) => `Cape May's Victorian charm and packed vacation rental season make it one of the Shore's most beloved spots for a private hibachi night on the porch or in the backyard. Summer families, bachelorette groups, and return visitors all tell us the same thing — a hibachi chef transforms a regular Shore dinner into the highlight of the whole trip. Here's what Cape May guests are sharing:` },
  ...
  'red-bank': {
    testimonial: { src: '/pics/hibachi-texas-home.jpg',   alt: (city) => `Private hibachi dinner in Red Bank, NJ`,         caption: 'Red Bank\'s private dining scene',    trustBadge: 'Hundreds of Private Events', intro: (city) => `Red Bank's riverfront sophistication and thriving private dining scene set the bar high — and our certified hibachi chefs consistently clear it. Monmouth County hosts appreciate the full-service approach: premium proteins sourced fresh, a live teppanyaki performance that anchors the evening, and complete cleanup so the host never lifts a finger. Here's what Red Bank hosts have to say:` },
...
const NJ_SUPPORT_FALLBACKS = [
  // Theme 0 — North Jersey
  {
    testimonial: { src: '/pics/hibachi-austin-home-3.jpg', alt: (city) => `Private hibachi event in ${city}, NJ`,  caption: 'North Jersey clients rave',       trustBadge: 'Highly Rated by Local Hosts', intro: (city) => `North Jersey communities like ${city} sit at the intersection of NYC energy and Garden State living — which means hosts here know exactly what a high-caliber private experience looks like. Our certified chefs travel throughout the region bringing the full teppanyaki setup: fire performance, fresh proteins, and end-to-end service. Here's what ${city} hosts are saying:` },
    cta:         { src: '/pics/hibachi-home-austin.jpg',   alt: (city) => `Private hibachi chef in ${city}, NJ`,   caption: 'Your ${city} evening starts here' },
  },
  // Theme 1 — Affluent Suburban
  {
    testimonial: { src: '/pics/hibachi-austin-2.jpg',      alt: (city) => `Hibachi backyard event in ${city}, NJ`, caption: 'NJ suburban hosts agree',         trustBadge: 'Five-Star Entertainment & Dining', intro: (city) => `${city}'s affluent suburban setting is exactly where private hibachi thrives — spacious backyards, guests who appreciate quality, and a desire for something more memorable than another restaurant reservation. Our chefs arrive with the complete setup, deliver a live performance, and handle every bit of cleanup. Here's what ${city} hosts experience:` },
    cta:         { src: '/pics/hibachi-austin-3.jpg',      alt: (city) => `Private hibachi chef in ${city}, NJ`,   caption: 'Your ${city} backyard, upgraded' },
  },
  // Theme 2 — Shore
  {
    testimonial: { src: '/pics/hibachi-catering.jpg',      alt: (city) => `Shore house hibachi in ${city}, NJ`,    caption: 'Jersey Shore hosts agree',        trustBadge: 'Thousands of Happy Guests', intro: (city) => `${city} Shore house weekends are already the highlight of the summer — and a private hibachi chef makes the Saturday night dinner the moment everyone talks about on the drive home. Our chefs are experienced with vacation rental setups all along the Jersey Shore, bringing the full teppanyaki show to your deck or backyard. Here's what ${city} groups are saying:` },
    cta:         { src: '/pics/hibachi-photo-2.jpg',       alt: (city) => `Private hibachi chef in ${city}, NJ`,   caption: 'The ${city} shore dinner upgrade' },
  },
  // Theme 3 — Central / Family
  {
    testimonial: { src: '/pics/hibachi-texas-home-2.jpg',  alt: (city) => `Family hibachi gathering in ${city}, NJ`, caption: 'Central NJ families celebrate',   trustBadge: "New Jersey's Favorite Hibachi Experience", intro: (city) => `Central NJ families in ${city} know how to mark a milestone — and private hibachi has become the celebration format of choice for graduations, birthdays, and multi-generational gatherings across Middlesex and Mercer counties. Our chefs handle groups from 10 to 60 guests with equal care, delivering a live performance that keeps every generation at the table. Here's what ${city} families are sharing:` },
    cta:         { src: '/pics/hibachi-dallas-tyler-2.jpg',alt: (city) => `Private hibachi chef in ${city}, NJ`,   caption: 'Your ${city} family event, elevated' },
  },
  // Theme 4 — Upscale Shore / South Jersey
  {
    testimonial: { src: '/pics/hibachi-at-home.jpg',       alt: (city) => `Upscale private hibachi in ${city}, NJ`, caption: 'South Jersey & Shore hosts agree', trustBadge: 'Unforgettable Private Dining Experiences', intro: (city) => `${city} sits in the sweet spot between upscale South Jersey living and Jersey Shore culture — making private hibachi a natural fit for vacation guests, summer celebrations, and year-round dinner parties that demand something exceptional. Our certified chefs bring every element of the teppanyaki experience to your property with full cleanup included. Here's what ${city} guests remember:` },
