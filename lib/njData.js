...
const NJ_MAJOR_CITIES = {
  ...
  // ── Theme 1 — Affluent Suburban ─────────────────────────────────────────────
  'morristown':     { v: 1, profileIdx: 5, nearby: ['Madison','Chatham','Florham Park','Morris Plains','Parsippany','Whippany','Randolph'] },
  ...
  'bridgewater':    { v: 1, nearby: ['Somerville','Bound Brook','Warren','Raritan','Hillsborough','Manville','Branchburg'] },
  ...
  'point-pleasant': { v: 2, nearby: ['Brielle','Manasquan','Bay Head','Brick','Wall Township','Sea Girt','Lavallette'] },
  ...
  'toms-river':     { v: 3, nearby: ['Brick','Beachwood','Lakewood','Lacey Township','Berkeley Township','Seaside Heights','Island Heights'] },
