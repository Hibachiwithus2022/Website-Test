...
const NC_SUPPORT_FALLBACKS = [
  // v=0 Charlotte/Urban
  { testimonial: { src: '/pics/hibachi-chef-2.jpg',      alt: (city) => `Private chef at ${city}, NC event`, caption: 'Charlotte Metro' },
    cta:         { src: '/pics/hibachi-dallas.jpg',      alt: (city) => `Hibachi event in the ${city}, NC area` } },
  // v=1 Triangle/Suburban
  { testimonial: { src: '/pics/backyard-hibachi.jpg',    alt: (city) => `Backyard hibachi party in the ${city} area`, caption: 'Research Triangle' },
    cta:         { src: '/pics/hibachi-at-home.jpg',     alt: (city) => `Private hibachi at home in ${city}, NC` } },
  // v=2 Mountain
  { testimonial: { src: '/pics/hibachi-colorado.jpg',    alt: (city) => `Mountain cabin hibachi event near ${city}, NC`, caption: 'Western NC Mountains' },
    cta:         { src: '/pics/hibachi-shot-1.jpg',      alt: (city) => `Private hibachi chef near ${city}, NC mountains` } },
  // v=3 Coastal
  { testimonial: { src: '/pics/hibachi-virginia-beach.jpg', alt: (city) => `Coastal vacation hibachi near ${city}, NC`, caption: 'Coastal NC' },
    cta:         { src: '/pics/mobile-hibachi-2.jpg',    alt: (city) => `Mobile hibachi setup at ${city}, NC beach house` } },
  // v=4 Lake/Resort
  { testimonial: { src: '/pics/hibachi-dallas-home.jpg', alt: (city) => `Lake house hibachi event in the ${city} area`, caption: 'Lake Norman & NC Lakes' },
    cta:         { src: '/pics/hibachi-event.jpg',       alt: (city) => `Hibachi event at ${city}, NC property` } },
]

const NC_SUPPORT_IMAGES = {
  charlotte: {
    testimonial: { src: '/pics/hibachi-catering-3.jpg', alt: (city) => `Upscale hibachi catering event in ${city}, NC`, caption: 'Charlotte, NC', intro: (city) => `Charlotte's corporate and residential communities have embraced private hibachi as the go-to evening for teams and celebrations.` },
    cta:         { src: '/pics/hibachi-dallas.jpg',     alt: (city) => `Private hibachi in Charlotte, NC` },
  },
  raleigh: {
    testimonial: { src: '/pics/backyard-hibachi-3.jpg', alt: (city) => `Backyard hibachi party in Raleigh, NC`, caption: 'Raleigh, NC', intro: (city) => `The Research Triangle's backyard hibachi scene is one of the most active in North Carolina.` },
    cta:         { src: '/pics/hibachi-at-home.jpg',    alt: (city) => `Private hibachi at home in Raleigh, NC` },
  },
  durham: {
    testimonial: { src: '/pics/hibachi-austin-home.jpg', alt: (city) => `Residential hibachi event in Durham, NC`, caption: 'Durham, NC', intro: (city) => `Durham's food culture extends naturally to private hibachi — the Bull City hosts some of our best-reviewed events.` },
    cta:         { src: '/pics/hibachi-photo-2.jpg',     alt: (city) => `Private hibachi in Durham, NC` },
  },
  asheville: {
    testimonial: { src: '/pics/hibachi-shot-1.jpg',       alt: (city) => `Mountain cabin hibachi event near Asheville, NC`, caption: 'Asheville Mountain Area', intro: (city) => `Asheville's cabin rental and bachelorette culture has made it one of our most active mountain markets.` },
    cta:         { src: '/pics/hibachi-catering-austin.jpg', alt: (city) => `Private hibachi near Asheville, NC` },
  },
  'outer-banks': {
    testimonial: { src: '/pics/hibachi-photo-1.jpg',      alt: (city) => `Beach house hibachi at the Outer Banks, NC`, caption: 'Outer Banks, NC', intro: (city) => `OBX family reunions and bachelorette weekends are among our largest and most celebrated events.` },
    cta:         { src: '/pics/hibachi-dallas-home.jpg',  alt: (city) => `Outer Banks beach house hibachi event` },
  },
  wilmington: {
    testimonial: { src: '/pics/hibachi-pic-62.jpg',       alt: (city) => `Wilmington, NC coastal hibachi event`, caption: 'Wilmington, NC', intro: (city) => `Wilmington's year-round outdoor lifestyle makes private hibachi a natural fit for Cape Fear Coast entertaining.` },
    cta:         { src: '/pics/hibachi-dallas-2.jpg',     alt: (city) => `Private hibachi in Wilmington, NC` },
  },
  greensboro: {
    testimonial: { src: '/pics/hibachi-shot-2.jpg',       alt: (city) => `Piedmont Triad hibachi event in Greensboro, NC`, caption: 'Greensboro, NC', intro: (city) => `Greensboro's strong residential community and university culture make it a natural market for private hibachi.` },
    cta:         { src: '/pics/hibachi-austin-3.jpg',     alt: (city) => `Private hibachi in Greensboro, NC` },
  },
  cary: {
    testimonial: { src: '/pics/hibachi-austin-home-3.jpg', alt: (city) => `Suburban backyard hibachi in Cary, NC`, caption: 'Cary, NC', intro: (city) => `Cary's affluent tech-professional community has made backyard hibachi one of the most-requested events in the Triangle.` },
    cta:         { src: '/pics/hibachi-pic-32.jpg',        alt: (city) => `Private hibachi at home in Cary, NC` },
  },
  'winston-salem': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',   alt: (city) => `Forsyth County hibachi catering event in Winston-Salem, NC`, caption: 'Winston-Salem, NC', intro: (city) => `Winston-Salem's arts district and residential neighborhoods are an excellent setting for private hibachi entertaining.` },
    cta:         { src: '/pics/hibachi-dallas-tyler.jpg',  alt: (city) => `Private hibachi in Winston-Salem, NC` },
  },
  'lake-norman': {
    testimonial: { src: '/pics/hibachi-austin-2.jpg',     alt: (city) => `Lake house hibachi event at Lake Norman, NC`, caption: 'Lake Norman, NC', intro: (city) => `Lake Norman's outdoor entertaining culture is among the best in the state — private hibachi is the natural fit for lake house evenings.` },
    cta:         { src: '/pics/hibachi-pic-4.jpg',         alt: (city) => `Private hibachi at Lake Norman, NC` },
  },
  'carolina-beach': {
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg', alt: (city) => `Coastal NC vacation hibachi at Carolina Beach`, caption: 'Carolina Beach, NC', intro: (city) => `Carolina Beach vacation groups love private hibachi — the beach house deck setup is perfect.` },
...
const NC_MAJOR_CITIES = {
  ...
  // ── Charlotte Metro ───────────────────────────────────────────────────────
  fayetteville:       { v: 0, intro: 33, nearby: ['Hope Mills', 'Spring Lake', 'Linden', 'Eastover', 'Godwin', 'Wade', 'Saint Pauls', 'Raeford', 'Shannon', 'Parkton'] },
  hickory:            { v: 4, intro: 37, nearby: ['Conover', 'Newton', 'Statesville', 'Morganton', 'Lenoir', 'Catawba', 'Claremont', 'Maiden', 'Granite Falls', 'Valdese'] },
  ...
  boone:              { v: 2, intro: 35, nearby: ['Blowing Rock', 'Banner Elk', 'Beech Mountain', 'Lenoir', 'Newland', 'Elk Park', 'Vilas', 'Seven Devils', 'West Jefferson', 'Jefferson'] },
  'blowing-rock':     { v: 2, intro: 35, nearby: ['Boone', 'Banner Elk', 'Linville', 'Beech Mountain', 'Valle Crucis', 'Sugar Mountain', 'Newland', 'Lenoir', 'Grandfather Mountain area', 'Collettsville'] },
  ...
  // ── Long Tail ─────────────────────────────────────────────────────────────
  pinehurst:          { v: 4, intro: 37, nearby: ['Southern Pines', 'Aberdeen', 'Sanford', 'Carthage', 'Vass', 'Cameron', 'West End', 'Robbins', 'Eagle Springs', 'Moore County'] },
  ...
  'new-bern':         { v: 3, intro: 36, nearby: ['Havelock', 'Morehead City', 'Kinston', 'Bridgeton', 'Vanceboro', 'River Bend', 'Trent Woods', 'Arapahoe', 'Oriental', 'Cherry Point'] },
  ...
  jacksonville:       { v: 0, intro: 33, nearby: ['Onslow County', 'Swansboro', 'Sneads Ferry', 'Holly Ridge', 'Camp Lejeune', 'Piney Green', 'Richlands', 'Hubert', 'Surf City', 'Maysville'] },
}
