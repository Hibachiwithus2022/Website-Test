...
const MI_NEARBY_MAJOR = [
  ...
  ['Birmingham', 'Troy', 'Royal Oak', 'Ann Arbor', 'Novi'],  // v=3 West Michigan (placeholder — update Batch 3)
  ['Ann Arbor', 'Canton', 'Troy', 'Royal Oak', 'Bloomfield Hills'],  // v=4 Lake Shore (placeholder — update Batch 4)
  ['Ann Arbor', 'Troy', 'Royal Oak', 'Birmingham', 'Bloomfield Hills'],  // v=5 Northern MI (placeholder — update Batch 4)
]
