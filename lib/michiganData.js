...
const MI_NEARBY_MAJOR = [
  ...
  ['Birmingham', 'Troy', 'Royal Oak', 'Bloomfield Hills', 'Novi'],  // v=2 Detroit Suburban (placeholder — update Batch 2)
  ['Birmingham', 'Troy', 'Royal Oak', 'Bloomfield Hills', 'Novi'],  // v=3 West Michigan (placeholder — update Batch 3)
  ['Birmingham', 'Troy', 'Royal Oak', 'Bloomfield Hills', 'Novi'],  // v=4 Lake Shore (placeholder — update Batch 4)
  ['Birmingham', 'Troy', 'Royal Oak', 'Bloomfield Hills', 'Novi'],  // v=5 Northern MI (placeholder — update Batch 4)
]
