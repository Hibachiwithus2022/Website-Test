...
export const STATE_LINK_DATA = {
  ...
  michigan: {
    ...
    featuredCities: [
      ...
      { city: 'Royal Oak',        slug: 'royal-oak',        desc: 'Young professional backyard events & bachelorette weekends' },
      { city: 'Novi',             slug: 'novi',             desc: 'Diverse community graduation parties & milestone celebrations' },
    ],
    secondaryCities: [],
    contextualSentence: 'We serve Metro Detroit and beyond — Bloomfield Hills estate dinners, Birmingham private gatherings, Troy corporate events, Royal Oak backyard celebrations, and Novi graduation and milestone parties throughout Oakland County.',
  },
