...
export const STATE_LINK_DATA = {
  ...
  tennessee: {
    ...
    featuredCities: [
      ...
      { city: 'Brentwood',   slug: 'brentwood',   desc: 'Tennessee\'s premier executive suburb' },
      { city: 'Franklin',    slug: 'franklin',    desc: 'Westhaven, Cool Springs & Leiper\'s Fork estates' },
    ],
    secondaryCities: [
      { city: 'Nolensville', slug: 'nolensville' },
      { city: 'Spring Hill', slug: 'spring-hill' },
    ],
    contextualSentence: 'We serve all of Middle Tennessee — Nashville, Brentwood, Franklin, Nolensville, Spring Hill, and surrounding Williamson County communities.',
  },
