...
export const STATE_LINK_DATA = {
  ...
  louisiana: {
    ...
    secondaryCities: [],
    contextualSentence: 'We serve all of Louisiana — New Orleans vacation rental groups and Garden District dinner parties, Baton Rouge LSU graduation weekends, Lafayette oil and gas team events, Shreveport and Bossier City milestones, and Lake Charles energy sector celebrations.',
  },
  alabama: {
    stateName: 'Alabama',
    stateAbbr: 'AL',
