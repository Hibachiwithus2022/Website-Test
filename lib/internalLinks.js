...
export const STATE_LINK_DATA = {
  ...
  illinois: {
    ...
    featuredCities: [
      ...
      { city: 'Highland Park', slug: 'highland-park', desc: 'Ravinia season & Lake Michigan backyard events' },
      { city: 'Winnetka',     slug: 'winnetka',     desc: 'Hubbard Woods estate & Tower Road lakefront events' },
    ],
    secondaryCities: [],
    contextualSentence: 'We serve all of Illinois — Chicago, the North Shore corridor, and every community across Chicagoland.',
  },
