...
export const STATE_LINK_DATA = {
  ...
  maryland: {
    ...
    featuredCities: [
      ...
      { city: 'Chevy Chase', slug: 'chevy-chase', desc: 'DC-adjacent private dining & diplomatic events' },
      { city: 'Rockville',   slug: 'rockville',   desc: 'South Asian graduation parties & MCPS milestone events' },
      { city: 'Gaithersburg', slug: 'gaithersburg', desc: 'MCPS graduation parties & I-270 corridor events' },
    ],
    secondaryCities: [],
    contextualSentence: 'We serve all of Maryland — DC corridor estate dinners in Bethesda, Potomac, and Chevy Chase, South Asian graduation parties throughout Rockville and Gaithersburg, and the Chesapeake Bay waterfront and Eastern Shore vacation communities.',
  },
