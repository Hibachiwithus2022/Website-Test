...
export const STATE_LINK_DATA = {
  ...
  california: {
    ...
    featuredCities: [
      { city: 'Beverly Hills',   slug: 'beverly-hills',   desc: 'Rodeo Drive estate events & Bel Air luxury celebrations' },
      { city: 'Malibu',          slug: 'malibu',          desc: 'Carbon Beach estate dinners & PCH coastal events' },
      { city: 'Newport Beach',   slug: 'newport-beach',   desc: 'Balboa Island & Fashion Island-area coastal events' },
      { city: 'Napa',            slug: 'napa',            desc: 'Napa Valley vineyard estate dinners & wine country events' },
      { city: 'Santa Barbara',   slug: 'santa-barbara',   desc: 'Santa Barbara wine country & coastal estate celebrations' },
      { city: 'La Jolla',        slug: 'la-jolla',        desc: 'La Jolla Cove estate events & coastal San Diego' },
    ],
    secondaryCities: [
      { city: 'Santa Monica',    slug: 'santa-monica' },
      { city: 'Calabasas',       slug: 'calabasas' },
      { city: 'Manhattan Beach', slug: 'manhattan-beach' },
      { city: 'Pasadena',        slug: 'pasadena' },
      { city: 'Laguna Beach',    slug: 'laguna-beach' },
      { city: 'Irvine',          slug: 'irvine' },
      { city: 'Atherton',        slug: 'atherton' },
      { city: 'Palo Alto',       slug: 'palo-alto' },
      { city: 'San Francisco',   slug: 'san-francisco' },
      { city: 'Palm Springs',    slug: 'palm-springs' },
    ],
    contextualSentence: 'We serve all of California — Beverly Hills, Malibu, Newport Beach, La Jolla, Napa Valley, Santa Barbara, Silicon Valley, and every coastal and wine country community.',
  },
  ...
  illinois: {
    ...
    stateSlug: 'illinois',
    featuredCities: [
      { city: 'Chicago',      slug: 'chicago',      desc: 'Gold Coast estate events & River North corporate dinners' },
      { city: 'Naperville',   slug: 'naperville',   desc: 'Graduation capital of DuPage County' },
      { city: 'Evanston',     slug: 'evanston',     desc: 'Northwestern graduation season & North Shore lakefront' },
      { city: 'Schaumburg',   slug: 'schaumburg',   desc: 'Motorola & Zurich corporate corridor' },
      { city: 'Lake Forest',  slug: 'lake-forest',  desc: 'Onwentsia estate events & North Shore lakefront' },
      { city: 'Oak Brook',    slug: 'oak-brook',    desc: 'McDonald\'s & Fortune 500 corporate campus' },
    ],
    secondaryCities: [
      { city: 'Highland Park', slug: 'highland-park' },
      { city: 'Winnetka',      slug: 'winnetka' },
      { city: 'Hinsdale',      slug: 'hinsdale' },
      { city: 'Wheaton',       slug: 'wheaton' },
      { city: 'Northbrook',    slug: 'northbrook' },
      { city: 'Barrington',    slug: 'barrington' },
    ],
    contextualSentence: 'We serve all of Illinois — Chicago, the North Shore, Naperville, Oak Brook, Schaumburg, and every community across Chicagoland and downstate.',
  },
  ...
  arkansas: {
    ...
    stateSlug: 'arkansas',
    featuredCities: [
      { city: 'Bentonville',  slug: 'bentonville',  desc: 'Walmart corporate ecosystem, executive home entertaining & NWA supplier events' },
      { city: 'Rogers',       slug: 'rogers',       desc: 'Pinnacle Hills graduation parties, corporate team dinners & large celebrations' },
      { city: 'Fayetteville', slug: 'fayetteville', desc: 'University of Arkansas graduation weekends & Razorback family events' },
      { city: 'Little Rock',  slug: 'little-rock',  desc: 'Chenal Valley executive dinners, corporate events & Central AR milestones' },
      { city: 'Hot Springs',  slug: 'hot-springs',  desc: 'Lake Hamilton vacation rentals, lake houses & bachelor/bachelorette weekends' },
      { city: 'Fort Smith',   slug: 'fort-smith',   desc: 'River Valley corporate events & Western Arkansas milestone celebrations' },
    ],
    secondaryCities: [
      { city: 'Springdale',    slug: 'springdale'    },
      { city: 'Bella Vista',   slug: 'bella-vista'   },
      { city: 'Conway',        slug: 'conway'        },
      { city: 'Benton',        slug: 'benton'        },
      { city: 'Mountain Home', slug: 'mountain-home' },
      { city: 'Russellville',  slug: 'russellville'  },
      { city: 'Jonesboro',     slug: 'jonesboro'     },
    ],
    contextualSentence: 'We serve all of Arkansas — Bentonville and Rogers corporate and executive events, Fayetteville University of Arkansas graduation weekends, Hot Springs lake house and vacation rental events, Little Rock professional household celebrations, and milestone events across every Arkansas community.',
  },
  louisiana: {
    stateName: 'Louisiana',
    stateAbbr: 'LA',
    stateSlug: 'louisiana',
    featuredCities: [
      { city: 'New Orleans',  slug: 'new-orleans',  desc: 'Garden District estates, vacation rentals & bachelorette/reunion group events' },
      { city: 'Baton Rouge',  slug: 'baton-rouge',  desc: 'LSU graduation weekends, Bocage professional dinners & milestone celebrations' },
      { city: 'Lafayette',    slug: 'lafayette',    desc: 'Oil & gas team events, UL graduation parties & Acadiana family milestones' },
      { city: 'Shreveport',   slug: 'shreveport',   desc: 'Barksdale military families, Red River corridor corporate events & milestones' },
      { city: 'Lake Charles', slug: 'lake-charles', desc: 'Energy sector team celebrations, lake house weekends & SW Louisiana milestones' },
      { city: 'Metairie',     slug: 'metairie',     desc: 'Jefferson Parish graduation weekends & New Orleans metro home celebrations' },
    ],
    secondaryCities: [
      { city: 'Kenner',       slug: 'kenner'       },
      { city: 'Mandeville',   slug: 'mandeville'   },
      { city: 'Covington',    slug: 'covington'    },
      { city: 'Bossier City', slug: 'bossier-city' },
      { city: 'Gonzales',     slug: 'gonzales'     },
      { city: 'Prairieville', slug: 'prairieville' },
      { city: 'Youngsville',  slug: 'youngsville'  },
      { city: 'Broussard',    slug: 'broussard'    },
      { city: 'Hammond',      slug: 'hammond'      },
    ],
    contextualSentence: 'We serve all of Louisiana — New Orleans vacation rental groups and Garden District dinner parties, Baton Rouge LSU graduation weekends, Lafayette oil and gas team events, Shreveport and Bossier City milestones, Metairie and the Northshore, and Lake Charles energy sector celebrations.',
  },
  alabama: {
    stateName: 'Alabama',
    stateAbbr: 'AL',
    stateSlug: 'alabama',
    featuredCities: [
      { city: 'Birmingham',     slug: 'birmingham',     desc: 'Corporate events, UAB professional milestones & metro graduation parties' },
      { city: 'Mountain Brook', slug: 'mountain-brook', desc: 'Estate private dining & English Village-area landmark celebrations' },
      { city: 'Vestavia Hills', slug: 'vestavia-hills', desc: 'Graduation capital of the Birmingham estate market' },
      { city: 'Hoover',         slug: 'hoover',         desc: 'Greystone & Ross Bridge backyard graduation parties' },
      { city: 'Huntsville',     slug: 'huntsville',     desc: 'Aerospace & defense professional household events' },
      { city: 'Gulf Shores',    slug: 'gulf-shores',    desc: 'Beach house hibachi & Gulf Coast vacation rental events' },
    ],
    secondaryCities: [
      { city: 'Homewood',       slug: 'homewood'       },
      { city: 'Madison',        slug: 'madison'        },
      { city: 'Tuscaloosa',     slug: 'tuscaloosa'     },
      { city: 'Auburn',         slug: 'auburn'         },
      { city: 'Montgomery',     slug: 'montgomery'     },
      { city: 'Mobile',         slug: 'mobile'         },
      { city: 'Fairhope',       slug: 'fairhope'       },
      { city: 'Daphne',         slug: 'daphne'         },
      { city: 'Orange Beach',   slug: 'orange-beach'   },
    ],
    contextualSentence: 'We serve all of Alabama — Birmingham estate and corporate events, Huntsville aerospace-family dinners, Gulf Shores and Orange Beach beach house events, and graduation parties across every Alabama community.',
  },
}
...
export const CITY_LINK_DATA = {
  ...
  'highland-park': {
    ...
    stateAbbr: 'TX',
    nearbyMajorCities: [
      { city: 'University Park', slug: 'university-park' },
    ...
    otherStateCities: [
      ...
      { city: 'Colleyville', slug: 'colleyville' },
    ],
    contextualSentence: 'Not in Highland Park? We serve University Park, Dallas, Plano, Fort Worth, Southlake, Westlake, and Colleyville — all of DFW.',
  },
  ...
  'university-park': {
    ...
    contextualSentence: 'Not in University Park? We serve Highland Park, Dallas, Plano, Fort Worth, Southlake, Westlake, and Colleyville — all of DFW.',
  },
  ...
  southlake: {
    ...
    contextualSentence: 'Not in Southlake? We serve Westlake, Colleyville, Fort Worth, Dallas, Highland Park, University Park, and Plano — all of DFW.',
  },
  ...
  westlake: {
    ...
    contextualSentence: 'Not in Westlake? We serve Southlake, Colleyville, Fort Worth, Dallas, Highland Park, and University Park — all of the DFW luxury market.',
  },
  ...
  colleyville: {
    ...
    contextualSentence: 'Not in Colleyville? We serve Southlake, Westlake, Fort Worth, Dallas, Highland Park, University Park, and Plano — all of DFW.',
  },
  ...
  dallas: {
    ...
    contextualSentence: 'Not in Dallas? We serve Highland Park, University Park, Plano, Fort Worth, Southlake, Westlake, and Colleyville — all of DFW.',
  },
  ...
  'fort-worth': {
    ...
    contextualSentence: 'Not in Fort Worth? We serve Dallas, Southlake, Westlake, Colleyville, Highland Park, University Park, and Plano — all of DFW.',
  },
  ...
  plano: {
    ...
    contextualSentence: 'Not in Plano? We serve Dallas, Highland Park, University Park, Fort Worth, Southlake, Westlake, and Colleyville — all of DFW.',
  },
  ...
  frisco: {
    ...
    contextualSentence: 'Not in Frisco? We serve Dallas, Plano, McKinney, Allen, Fort Worth, Highland Park, and University Park — all of greater DFW.',
  },
  ...
  mckinney: {
    ...
    contextualSentence: 'Not in McKinney? We serve Frisco, Allen, Dallas, Plano, Fort Worth, and all of North Collin County.',
  },
  ...
  allen: {
    ...
    contextualSentence: 'Not in Allen? We serve McKinney, Frisco, Plano, Dallas, Fort Worth, and all of Collin County.',
  },
  ...
  arlington: {
    ...
    contextualSentence: 'Not in Arlington? We serve Dallas, Fort Worth, Southlake, Colleyville, Plano, and all of the DFW metro.',
  },
  ...
  houston: {
    ...
    contextualSentence: 'Not in Houston? We serve The Woodlands, Katy, Sugar Land, and all of Greater Houston.',
  },
  ...
  'the-woodlands': {
    ...
    contextualSentence: 'Not in The Woodlands? We serve Houston, Katy, Sugar Land, and all of Greater Houston.',
  },
  ...
  katy: {
    ...
    contextualSentence: 'Not in Katy? We serve Houston, Sugar Land, The Woodlands, and all of Greater Houston.',
  },
  ...
  'sugar-land': {
    ...
    contextualSentence: 'Not in Sugar Land? We serve Houston, Katy, The Woodlands, and all of Fort Bend County.',
  },
  ...
  pearland: {
    ...
    nearbyMajorCities: [
      { city: 'Houston',      slug: 'houston'      },
      { city: 'Sugar Land',   slug: 'sugar-land'   },
      { city: 'Friendswood',  slug: 'friendswood'  },
    ],
    otherStateCities: [
      { city: 'Katy',          slug: 'katy'          },
      { city: 'The Woodlands', slug: 'the-woodlands' },
    ...
    contextualSentence: 'Not in Pearland? We serve Houston, Sugar Land, Friendswood, Katy, and all of Greater Houston.',
  },
  ...
  friendswood: {
    ...
    contextualSentence: 'Not in Friendswood? We serve Houston, Pearland, Sugar Land, and all of the Clear Lake area.',
  },
  ...
  austin: {
    ...
    otherStateCities: [
      { city: 'Lakeway',      slug: 'lakeway'      },
      { city: 'San Antonio',  slug: 'san-antonio'  },
      { city: 'Dallas',       slug: 'dallas'       },
    ],
    contextualSentence: 'Not in Austin? We serve Round Rock, Cedar Park, Georgetown, Lakeway, San Antonio, and all of the Austin metro.',
  },
  ...
  'round-rock': {
    ...
    contextualSentence: 'Not in Round Rock? We serve Austin, Cedar Park, Georgetown, Lakeway, and all of Williamson County.',
  },
  ...
  'cedar-park': {
    ...
    contextualSentence: 'Not in Cedar Park? We serve Austin, Round Rock, Lakeway, Georgetown, and all of the 183-A corridor.',
  },
  ...
  georgetown: {
    ...
    contextualSentence: 'Not in Georgetown? We serve Austin, Round Rock, Cedar Park, Lakeway, and all of Williamson County.',
  },
  ...
  lakeway: {
    ...
    contextualSentence: 'Not in Lakeway? We serve Austin, Cedar Park, Round Rock, Georgetown, and all of Lake Travis.',
  },
  ...
  'san-antonio': {
    ...
    contextualSentence: 'Not in San Antonio? We serve Austin, Houston, Dallas, and all of the San Antonio metro — Boerne, New Braunfels, Schertz, and Kyle.',
  },
  ...
  boerne: {
    ...
    contextualSentence: 'Not in Boerne? We serve San Antonio, New Braunfels, Austin, and all of the Texas Hill Country.',
  },
  ...
  'new-braunfels': {
    ...
    contextualSentence: 'Not in New Braunfels? We serve San Antonio, Boerne, Austin, Kyle, and all of the Central Texas Hill Country.',
  },
  ...
  schertz: {
    ...
    contextualSentence: 'Not in Schertz? We serve San Antonio, New Braunfels, Austin, and all of the San Antonio metro.',
  },
  ...
  kyle: {
    ...
    contextualSentence: 'Not in Kyle? We serve Austin, San Antonio, New Braunfels, Georgetown, and all of Hays County.',
  },
  ...
  galveston: {
    ...
    contextualSentence: 'Not in Galveston? We serve Houston, Katy, Sugar Land, and all of the Texas Gulf Coast.',
  },
  ...
  'corpus-christi': {
    ...
    otherStateCities: [
      { city: 'Galveston', slug: 'galveston' },
      { city: 'Austin',    slug: 'austin'    },
      { city: 'Dallas',    slug: 'dallas'    },
    ],
    contextualSentence: 'Not in Corpus Christi? We serve San Antonio, Houston, Galveston, and all of the Coastal Bend.',
  },
  ...
  fredericksburg: {
    ...
    contextualSentence: 'Not in Fredericksburg? We serve San Antonio, Austin, Boerne, and all of the Texas Hill Country wine country.',
  },
  ...
  waco: {
    ...
    contextualSentence: 'Not in Waco? We serve Austin, Dallas, Fort Worth, and all of Central Texas.',
  },

  // ── Arkansas (Batch 1) ─────────────────────────────────────────────────────
  'bentonville': {
    cityName: 'Bentonville', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Rogers',       slug: 'rogers'       },
      { city: 'Fayetteville', slug: 'fayetteville' },
      { city: 'Bella Vista',  slug: 'bella-vista'  },
      { city: 'Springdale',   slug: 'springdale'   },
    ],
    otherStateCities: [
      { city: 'Little Rock', slug: 'little-rock' },
      { city: 'Fort Smith',  slug: 'fort-smith'  },
    ],
    contextualSentence: 'Not in Bentonville? We serve all of Northwest Arkansas — Rogers, Fayetteville, Springdale, Bella Vista, and every Benton and Washington County community.',
  },
  'rogers': {
    cityName: 'Rogers', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Bentonville',  slug: 'bentonville'  },
      { city: 'Fayetteville', slug: 'fayetteville' },
      { city: 'Springdale',   slug: 'springdale'   },
    ],
    otherStateCities: [
    ...
    contextualSentence: 'Not in Rogers? We serve all of Northwest Arkansas — Bentonville, Fayetteville, Springdale, Bella Vista, and the full Pinnacle Hills corridor.',
  },
  'fayetteville': {
    cityName: 'Fayetteville', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Springdale',  slug: 'springdale'  },
      { city: 'Rogers',      slug: 'rogers'      },
      { city: 'Bentonville', slug: 'bentonville' },
    ...
    contextualSentence: 'Not in Fayetteville? We serve all of Northwest Arkansas — Springdale, Rogers, Bentonville, Bella Vista, and every Washington and Benton County community.',
  },
  'springdale': {
    cityName: 'Springdale', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Fayetteville', slug: 'fayetteville' },
      { city: 'Rogers',       slug: 'rogers'       },
      { city: 'Bentonville',  slug: 'bentonville'  },
    ...
    contextualSentence: 'Not in Springdale? We serve all of Northwest Arkansas — Fayetteville, Rogers, Bentonville, Bella Vista, and the surrounding NWA communities.',
  },
  'bella-vista': {
    cityName: 'Bella Vista', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Bentonville',  slug: 'bentonville'  },
      { city: 'Rogers',       slug: 'rogers'       },
      { city: 'Fayetteville', slug: 'fayetteville' },
    ...
    contextualSentence: 'Not in Bella Vista? We serve all of Northwest Arkansas — Bentonville, Rogers, Fayetteville, Springdale, and every Benton County community.',
  },

  // ── Arkansas (Batch 2) ─────────────────────────────────────────────────────
  'little-rock': {
    cityName: 'Little Rock', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Conway',      slug: 'conway'      },
      { city: 'Benton',      slug: 'benton'      },
      { city: 'Hot Springs', slug: 'hot-springs' },
    ],
    otherStateCities: [
      { city: 'Bentonville', slug: 'bentonville' },
      { city: 'Fort Smith',  slug: 'fort-smith'  },
    ],
    contextualSentence: 'Not in Little Rock? We serve all of Central Arkansas — Conway, Benton, Bryant, Maumelle, and every Pulaski, Saline, and Faulkner County community.',
  },
  'conway': {
    cityName: 'Conway', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Little Rock',  slug: 'little-rock'  },
      { city: 'Benton',       slug: 'benton'       },
      { city: 'Russellville', slug: 'russellville' },
    ...
    contextualSentence: 'Not in Conway? We serve all of Central Arkansas — Little Rock, Benton, Bryant, Russellville, and every Faulkner and Pulaski County community.',
  },
  'benton': {
    cityName: 'Benton', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Little Rock', slug: 'little-rock' },
      { city: 'Conway',      slug: 'conway'      },
      { city: 'Hot Springs', slug: 'hot-springs' },
    ...
    contextualSentence: 'Not in Benton? We serve all of Saline County and Central Arkansas — Little Rock, Conway, Bryant, Hot Springs, and every surrounding community.',
  },
  'hot-springs': {
    cityName: 'Hot Springs', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Little Rock', slug: 'little-rock' },
      { city: 'Benton',      slug: 'benton'      },
    ],
    ...
    contextualSentence: 'Not in Hot Springs? We serve all of Garland County — Lake Hamilton, Lake Ouachita, Lake Catherine, Malvern, and every surrounding community.',
  },
  'mountain-home': {
    cityName: 'Mountain Home', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Little Rock', slug: 'little-rock' },
      { city: 'Fayetteville', slug: 'fayetteville' },
    ],
    ...
    contextualSentence: 'Not in Mountain Home? We serve all of the Twin Lakes area — Lake Norfork, Lake Bull Shoals, Yellville, Gassville, and all of Baxter and Marion County.',
  },
  'russellville': {
    cityName: 'Russellville', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Conway',     slug: 'conway'     },
      { city: 'Little Rock', slug: 'little-rock' },
      { city: 'Fort Smith', slug: 'fort-smith' },
    ...
    contextualSentence: 'Not in Russellville? We serve all of Pope County — Lake Dardanelle, Clarksville, Morrilton, and the full Arkansas River Valley corridor.',
  },
  'fort-smith': {
    cityName: 'Fort Smith', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Fayetteville', slug: 'fayetteville' },
      { city: 'Springdale',   slug: 'springdale'   },
      { city: 'Russellville', slug: 'russellville' },
    ...
    contextualSentence: 'Not in Fort Smith? We serve all of Sebastian County — Greenwood, Van Buren, Alma, and the full Arkansas-Oklahoma River Valley.',
  },
  'jonesboro': {
    cityName: 'Jonesboro', stateSlug: 'arkansas', stateName: 'Arkansas', stateAbbr: 'AR',
    nearbyMajorCities: [
      { city: 'Little Rock', slug: 'little-rock' },
      { city: 'Fayetteville', slug: 'fayetteville' },
    ],
    ...
    contextualSentence: 'Not in Jonesboro? We serve all of Craighead County — Paragould, West Memphis, Blytheville, Searcy, and all of Northeast Arkansas.',
  },

  // ── Louisiana ──────────────────────────────────────────────────────────────
  'new-orleans': {
    cityName: 'New Orleans', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'Baton Rouge',  slug: 'baton-rouge'  },
    ...
    contextualSentence: 'Not in New Orleans? We serve all of Greater New Orleans — Metairie, Kenner, the Northshore (Mandeville, Covington, Slidell), and all of Jefferson, Orleans, and St. Tammany Parish.',
  },
  'baton-rouge': {
    cityName: 'Baton Rouge', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
    ...
    contextualSentence: 'Not in Baton Rouge? We serve all of the metro — Gonzales, Prairieville, Zachary, Denham Springs, Central, Baker, and all of East Baton Rouge and Livingston Parish.',
  },
  'lafayette': {
    cityName: 'Lafayette', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'Baton Rouge', slug: 'baton-rouge' },
      { city: 'Lake Charles', slug: 'lake-charles' },
    ],
    otherStateCities: [
      { city: 'Houston',   slug: 'houston'   },
      { city: 'Nashville', slug: 'nashville' },
    ],
    contextualSentence: 'Not in Lafayette? We serve all of Acadiana — Youngsville, Broussard, Carencro, Scott, New Iberia, Breaux Bridge, and all of Lafayette and Iberia Parish.',
  },
  'shreveport': {
    cityName: 'Shreveport', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'Baton Rouge', slug: 'baton-rouge' },
      { city: 'New Orleans', slug: 'new-orleans' },
    ],
    ...
    contextualSentence: 'Not in Shreveport? We serve all of the metro — Bossier City, Benton, Haughton, Minden, and all of Caddo, Bossier, and Webster Parish.',
  },
  'lake-charles': {
    cityName: 'Lake Charles', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'Lafayette',   slug: 'lafayette'   },
      { city: 'Baton Rouge', slug: 'baton-rouge' },
    ],
    otherStateCities: [
      { city: 'Houston',  slug: 'houston'  },
      { city: 'Beaumont', slug: 'beaumont' },
    ],
    contextualSentence: 'Not in Lake Charles? We serve all of Southwest Louisiana — Sulphur, Westlake, Moss Bluff, DeQuincy, and all of Calcasieu Parish.',
  },
  'metairie': {
    cityName: 'Metairie', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'New Orleans', slug: 'new-orleans' },
      { city: 'Kenner',      slug: 'kenner'      },
    ],
    ...
    contextualSentence: 'Not in Metairie? We serve all of Jefferson Parish and Greater New Orleans — Kenner, Harahan, River Ridge, and all surrounding communities.',
  },
  'kenner': {
    cityName: 'Kenner', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'New Orleans', slug: 'new-orleans' },
      { city: 'Metairie',    slug: 'metairie'    },
    ],
    otherStateCities: [
      { city: 'Houston',   slug: 'houston'   },
      { city: 'Nashville', slug: 'nashville' },
    ],
    contextualSentence: 'Not in Kenner? We serve all of Jefferson Parish and Greater New Orleans — Metairie, Harahan, River Ridge, and all surrounding communities.',
  },
  'mandeville': {
    cityName: 'Mandeville', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'New Orleans', slug: 'new-orleans' },
      { city: 'Covington',   slug: 'covington'   },
    ],
    ...
    contextualSentence: 'Not in Mandeville? We serve all of the Northshore — Covington, Madisonville, Abita Springs, Slidell, and all of St. Tammany Parish.',
  },
  'covington': {
    cityName: 'Covington', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'New Orleans', slug: 'new-orleans' },
      { city: 'Mandeville',  slug: 'mandeville'  },
    ],
    ...
    contextualSentence: 'Not in Covington? We serve all of the Northshore — Mandeville, Madisonville, Bush, Slidell, and all of St. Tammany Parish.',
  },
  'bossier-city': {
    cityName: 'Bossier City', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'Shreveport', slug: 'shreveport' },
    ],
    otherStateCities: [
      { city: 'Dallas',    slug: 'dallas'    },
      { city: 'Nashville', slug: 'nashville' },
    ],
    contextualSentence: 'Not in Bossier City? We serve all of the Shreveport-Bossier metro — Benton, Haughton, Minden, and all of Bossier, Caddo, and Webster Parish.',
  },
  'gonzales': {
    cityName: 'Gonzales', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'Baton Rouge', slug: 'baton-rouge' },
      { city: 'New Orleans', slug: 'new-orleans' },
    ],
    ...
    contextualSentence: 'Not in Gonzales? We serve all of Ascension Parish — Prairieville, Sorrento, St. Amant, and the full Baton Rouge-to-New Orleans corridor.',
  },
  'prairieville': {
    cityName: 'Prairieville', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'Baton Rouge', slug: 'baton-rouge' },
      { city: 'Gonzales',    slug: 'gonzales'    },
    ],
    ...
    contextualSentence: 'Not in Prairieville? We serve all of Ascension Parish — Gonzales, Sorrento, St. Amant, and the full Baton Rouge corridor.',
  },
  'youngsville': {
    cityName: 'Youngsville', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'Lafayette', slug: 'lafayette' },
      { city: 'Broussard', slug: 'broussard' },
    ],
    ...
    contextualSentence: 'Not in Youngsville? We serve all of Lafayette Parish — Broussard, Carencro, Scott, and all of Acadiana.',
  },
  'broussard': {
    cityName: 'Broussard', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'Lafayette',  slug: 'lafayette'  },
      { city: 'Youngsville', slug: 'youngsville' },
    ],
    ...
    contextualSentence: 'Not in Broussard? We serve all of Lafayette and Iberia Parish — Youngsville, Carencro, Scott, New Iberia, and all of Acadiana.',
  },
  'hammond': {
    cityName: 'Hammond', stateSlug: 'louisiana', stateName: 'Louisiana', stateAbbr: 'LA',
    nearbyMajorCities: [
      { city: 'New Orleans', slug: 'new-orleans' },
      { city: 'Baton Rouge', slug: 'baton-rouge' },
    ],
    ...
    contextualSentence: 'Not in Hammond? We serve all of Tangipahoa Parish — Ponchatoula, Amite, and the full I-12 corridor between New Orleans and Baton Rouge.',
  },
  ...
  // ── ILLINOIS — Batch 1 ────────────────────────────────────────────────────────
  chicago: {
    cityName: 'Chicago', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
    ...
    contextualSentence: 'Not in Chicago proper? We serve all of Chicagoland — the Gold Coast, North Shore, Evanston, Highland Park, Lake Forest, and Winnetka.',
  },
  evanston: {
    cityName: 'Evanston', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Chicago',       slug: 'chicago'       },
      { city: 'Highland Park', slug: 'highland-park' },
      { city: 'Winnetka',      slug: 'winnetka'      },
    ...
    contextualSentence: 'Not in Evanston? We serve the entire North Shore — Highland Park, Winnetka, Lake Forest, and all of Chicagoland.',
  },
  'lake-forest': {
    cityName: 'Lake Forest', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Highland Park', slug: 'highland-park' },
      { city: 'Evanston',      slug: 'evanston'      },
      { city: 'Winnetka',      slug: 'winnetka'      },
    ...
    contextualSentence: 'Not in Lake Forest? We serve the entire North Shore — Highland Park, Evanston, Winnetka, and all of Chicagoland.',
  },
  'highland-park': {
    cityName: 'Highland Park', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Lake Forest',   slug: 'lake-forest'   },
      { city: 'Evanston',      slug: 'evanston'      },
      { city: 'Winnetka',      slug: 'winnetka'      },
    ...
    contextualSentence: 'Not in Highland Park? We serve the entire Ravinia corridor and North Shore — Lake Forest, Evanston, Winnetka, and all of Chicagoland.',
  },
  winnetka: {
    cityName: 'Winnetka', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Evanston',      slug: 'evanston'      },
      { city: 'Highland Park', slug: 'highland-park' },
      { city: 'Lake Forest',   slug: 'lake-forest'   },
    ...
    contextualSentence: 'Not in Winnetka? We serve the entire North Shore — Evanston, Highland Park, Lake Forest, and all of Chicagoland.',
  },

  // ── ILLINOIS — Batch 2 ────────────────────────────────────────────────────────
  naperville: {
    cityName: 'Naperville', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Wheaton',       slug: 'wheaton'       },
      { city: 'Downers Grove', slug: 'downers-grove' },
      { city: 'Hinsdale',      slug: 'hinsdale'      },
      { city: 'Oak Brook',     slug: 'oak-brook'     },
    ],
    otherStateCities: [
      { city: 'Chicago',       slug: 'chicago'       },
      { city: 'Wheaton',       slug: 'wheaton'       },
    ...
    contextualSentence: 'Not in Naperville? We serve all of DuPage County — Wheaton, Downers Grove, Hinsdale, Oak Brook, and the greater Chicagoland area.',
  },
  hinsdale: {
    cityName: 'Hinsdale', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Oak Brook',     slug: 'oak-brook'     },
      { city: 'Downers Grove', slug: 'downers-grove' },
    ...
    contextualSentence: 'Not in Hinsdale? We serve all of the western suburbs — Oak Brook, Naperville, Downers Grove, and greater Chicagoland.',
  },
  'oak-brook': {
    cityName: 'Oak Brook', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Hinsdale',      slug: 'hinsdale'      },
      { city: 'Downers Grove', slug: 'downers-grove' },
    ...
    contextualSentence: 'Not in Oak Brook? We serve the entire Illinois corporate corridor — Schaumburg, Hinsdale, Naperville, and all of Chicagoland.',
  },
  wheaton: {
    cityName: 'Wheaton', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Naperville',    slug: 'naperville'    },
      { city: 'Downers Grove', slug: 'downers-grove' },
      { city: 'Hinsdale',      slug: 'hinsdale'      },
    ...
    contextualSentence: 'Not in Wheaton? We serve all of DuPage County — Naperville, Downers Grove, Hinsdale, and greater Chicagoland.',
  },
  'downers-grove': {
    cityName: 'Downers Grove', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Naperville',    slug: 'naperville'    },
      { city: 'Hinsdale',      slug: 'hinsdale'      },
      { city: 'Oak Brook',     slug: 'oak-brook'     },
    ...
    contextualSentence: 'Not in Downers Grove? We serve all of DuPage County — Naperville, Hinsdale, Wheaton, Oak Brook, and all of Chicagoland.',
  },

  // ── ILLINOIS — Batch 3 ────────────────────────────────────────────────────────
  schaumburg: {
    cityName: 'Schaumburg', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Barrington',    slug: 'barrington'    },
      { city: 'Northbrook',    slug: 'northbrook'    },
      { city: 'Oak Brook',     slug: 'oak-brook'     },
    ...
    contextualSentence: 'Not in Schaumburg? We serve the entire Illinois corporate corridor — Oak Brook, Northbrook, and all of Chicagoland.',
  },
  barrington: {
    cityName: 'Barrington', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Schaumburg',    slug: 'schaumburg'    },
      { city: 'Lake Forest',   slug: 'lake-forest'   },
      { city: 'Northbrook',    slug: 'northbrook'    },
    ...
    contextualSentence: 'Not in Barrington? We serve the entire Northwest Suburbs and North Shore — Lake Forest, Northbrook, Schaumburg, and all of Chicagoland.',
  },
  northbrook: {
    cityName: 'Northbrook', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Highland Park', slug: 'highland-park' },
      { city: 'Evanston',      slug: 'evanston'      },
      { city: 'Schaumburg',    slug: 'schaumburg'    },
    ...
    contextualSentence: 'Not in Northbrook? We serve the entire North Shore and northern Cook County — Highland Park, Evanston, Schaumburg, and all of Chicagoland.',
  },
  'orland-park': {
    cityName: 'Orland Park', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Northbrook',    slug: 'northbrook'    },
      { city: 'Schaumburg',    slug: 'schaumburg'    },
    ],
    ...
    contextualSentence: 'Not in Orland Park? We serve the entire Southwest Suburbs and all of Chicagoland — Naperville, Northbrook, Schaumburg, and more.',
  },

  // ── ILLINOIS — Batch 4 ────────────────────────────────────────────────────────
  champaign: {
    cityName: 'Champaign', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Bloomington',   slug: 'bloomington'   },
      { city: 'Peoria',        slug: 'peoria'        },
    ],
    ...
    contextualSentence: 'Not in Champaign? We serve all of central Illinois — Bloomington, Peoria, and every Illinois community.',
  },
  bloomington: {
    cityName: 'Bloomington', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Champaign',     slug: 'champaign'     },
      { city: 'Peoria',        slug: 'peoria'        },
    ],
    otherStateCities: [
      { city: 'Chicago',       slug: 'chicago'       },
    ...
    contextualSentence: 'Not in Bloomington? We serve all of central Illinois — Champaign, Peoria, and every Illinois community.',
  },
  peoria: {
    cityName: 'Peoria', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Bloomington',   slug: 'bloomington'   },
      { city: 'Champaign',     slug: 'champaign'     },
    ],
    ...
    contextualSentence: 'Not in Peoria? We serve all of central Illinois — Bloomington, Champaign, and every Illinois community.',
  },
  rockford: {
    cityName: 'Rockford', stateSlug: 'illinois', stateName: 'Illinois', stateAbbr: 'IL',
    nearbyMajorCities: [
      { city: 'Schaumburg',    slug: 'schaumburg'    },
      { city: 'Chicago',       slug: 'chicago'       },
    ],
    ...
    contextualSentence: 'Not in Rockford? We serve all of northern Illinois — Chicago, Schaumburg, Northbrook, and every Chicagoland community.',
  },

  // ── California ────────────────────────────────────────────────────────────
  'beverly-hills': {
    cityName: 'Beverly Hills', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Malibu',        slug: 'malibu'        },
      { city: 'Santa Monica',  slug: 'santa-monica'  },
      { city: 'Calabasas',     slug: 'calabasas'     },
      { city: 'Pasadena',      slug: 'pasadena'      },
    ],
    otherStateCities: [
      { city: 'Newport Beach',   slug: 'newport-beach'   },
      { city: 'Laguna Beach',    slug: 'laguna-beach'    },
      { city: 'La Jolla',        slug: 'la-jolla'        },
    ],
    contextualSentence: 'Not in Beverly Hills? We serve all of California — Malibu, Santa Monica, Calabasas, Newport Beach, Laguna Beach, Napa, and every California market.',
  },
  'malibu': {
    cityName: 'Malibu', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Beverly Hills',  slug: 'beverly-hills'  },
      { city: 'Santa Monica',   slug: 'santa-monica'   },
      { city: 'Calabasas',      slug: 'calabasas'      },
    ],
    otherStateCities: [
      { city: 'Newport Beach',  slug: 'newport-beach'  },
      { city: 'Laguna Beach',   slug: 'laguna-beach'   },
      { city: 'Santa Barbara',  slug: 'santa-barbara'  },
    ],
    contextualSentence: 'Not in Malibu? We serve all of California — Beverly Hills, Santa Monica, Calabasas, Newport Beach, Santa Barbara, and every California coastal and estate market.',
  },
  'santa-monica': {
    cityName: 'Santa Monica', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Malibu',          slug: 'malibu'          },
      { city: 'Manhattan Beach', slug: 'manhattan-beach' },
      { city: 'Beverly Hills',   slug: 'beverly-hills'   },
    ...
    contextualSentence: 'Not in Santa Monica? We serve all of California — Malibu, Manhattan Beach, Beverly Hills, Newport Beach, and every California coastal and LA-area community.',
  },
  'calabasas': {
    cityName: 'Calabasas', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Malibu',        slug: 'malibu'        },
      { city: 'Beverly Hills', slug: 'beverly-hills' },
      { city: 'Santa Monica',  slug: 'santa-monica'  },
    ...
    contextualSentence: 'Not in Calabasas? We serve all of California — Malibu, Beverly Hills, Santa Monica, and every Los Angeles area luxury and estate community.',
  },
  'manhattan-beach': {
    cityName: 'Manhattan Beach', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Santa Monica',  slug: 'santa-monica'  },
      { city: 'Pasadena',      slug: 'pasadena'      },
      { city: 'Beverly Hills', slug: 'beverly-hills' },
    ...
    otherStateCities: [
      { city: 'Newport Beach',  slug: 'newport-beach'  },
      { city: 'Laguna Beach',   slug: 'laguna-beach'   },
      { city: 'Huntington Beach', slug: 'huntington-beach' },
    ],
    contextualSentence: 'Not in Manhattan Beach? We serve all of California — Santa Monica, Beverly Hills, Newport Beach, Laguna Beach, and every South Bay and coastal California community.',
  },
  'pasadena': {
    cityName: 'Pasadena', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Beverly Hills',   slug: 'beverly-hills'   },
      { city: 'Manhattan Beach', slug: 'manhattan-beach' },
      { city: 'Santa Monica',    slug: 'santa-monica'    },
    ...
    contextualSentence: 'Not in Pasadena? We serve all of California — Beverly Hills, Santa Monica, Newport Beach, Irvine, and every Los Angeles and California community.',
  },
  'newport-beach': {
    cityName: 'Newport Beach', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Laguna Beach',    slug: 'laguna-beach'    },
      { city: 'Irvine',          slug: 'irvine'          },
      { city: 'Huntington Beach',slug: 'huntington-beach'},
      { city: 'Dana Point',      slug: 'dana-point'      },
    ],
    otherStateCities: [
      { city: 'Beverly Hills',   slug: 'beverly-hills'   },
      { city: 'Malibu',          slug: 'malibu'          },
    ...
    contextualSentence: 'Not in Newport Beach? We serve all of Orange County and California — Laguna Beach, Irvine, Huntington Beach, Dana Point, Beverly Hills, and La Jolla.',
  },
  'laguna-beach': {
    cityName: 'Laguna Beach', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Newport Beach',   slug: 'newport-beach'   },
      { city: 'Dana Point',      slug: 'dana-point'      },
      { city: 'Irvine',          slug: 'irvine'          },
    ...
    contextualSentence: 'Not in Laguna Beach? We serve all of Orange County and California — Newport Beach, Dana Point, Irvine, Beverly Hills, and La Jolla.',
  },
  'irvine': {
    cityName: 'Irvine', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Newport Beach',    slug: 'newport-beach'    },
      { city: 'Huntington Beach', slug: 'huntington-beach' },
      { city: 'Laguna Beach',     slug: 'laguna-beach'     },
    ...
    contextualSentence: 'Not in Irvine? We serve all of Orange County and California — Newport Beach, Huntington Beach, Laguna Beach, Beverly Hills, and every California market.',
  },
  'huntington-beach': {
    cityName: 'Huntington Beach', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Newport Beach',   slug: 'newport-beach'   },
      { city: 'Irvine',          slug: 'irvine'          },
      { city: 'Laguna Beach',    slug: 'laguna-beach'    },
    ...
    contextualSentence: 'Not in Huntington Beach? We serve all of Orange County and California — Newport Beach, Irvine, Laguna Beach, Manhattan Beach, and every California beach community.',
  },
  'dana-point': {
    cityName: 'Dana Point', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Laguna Beach',    slug: 'laguna-beach'    },
      { city: 'Newport Beach',   slug: 'newport-beach'   },
      { city: 'Irvine',          slug: 'irvine'          },
    ...
    contextualSentence: 'Not in Dana Point? We serve all of Orange County and California — Laguna Beach, Newport Beach, Irvine, and every California coastal community.',
  },
  // ── Batch 6 — Central Coast / Desert / Mountain ────────────────────────────
  'santa-barbara': {
    cityName: 'Santa Barbara', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'San Luis Obispo', slug: 'san-luis-obispo' },
      { city: 'Malibu',          slug: 'malibu'          },
      { city: 'Napa',            slug: 'napa'            },
    ],
    otherStateCities: [
    ...
    contextualSentence: 'Not in Santa Barbara? We serve all of coastal and Central Coast California — Malibu, San Luis Obispo, Napa, and every California coastal community.',
  },
  'san-luis-obispo': {
    cityName: 'San Luis Obispo', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Santa Barbara',   slug: 'santa-barbara'   },
      { city: 'Napa',            slug: 'napa'            },
      { city: 'Healdsburg',      slug: 'healdsburg'      },
    ],
    otherStateCities: [
      { city: 'Beverly Hills',   slug: 'beverly-hills'   },
      { city: 'Malibu',          slug: 'malibu'          },
    ...
    contextualSentence: 'Not in San Luis Obispo? We serve all of the Central Coast and California — Santa Barbara, Napa, and every California community.',
  },
  'palm-springs': {
    cityName: 'Palm Springs', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Palm Desert',     slug: 'palm-desert'     },
      { city: 'La Jolla',        slug: 'la-jolla'        },
      { city: 'Malibu',          slug: 'malibu'          },
    ],
    otherStateCities: [
    ...
    contextualSentence: 'Not in Palm Springs? We serve all of the Coachella Valley and California — Palm Desert, La Jolla, and every California destination community.',
  },
  'palm-desert': {
    cityName: 'Palm Desert', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Palm Springs',    slug: 'palm-springs'    },
      { city: 'La Jolla',        slug: 'la-jolla'        },
      { city: 'Newport Beach',   slug: 'newport-beach'   },
    ...
    contextualSentence: 'Not in Palm Desert? We serve all of the Coachella Valley and California — Palm Springs, La Jolla, and every California luxury community.',
  },
  'south-lake-tahoe': {
    cityName: 'South Lake Tahoe', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Truckee',         slug: 'truckee'         },
      { city: 'Napa',            slug: 'napa'            },
      { city: 'San Francisco',   slug: 'san-francisco'   },
    ],
    otherStateCities: [
    ...
    contextualSentence: 'Not in South Lake Tahoe? We serve all of the Sierra Nevada and California — Truckee, Napa, San Francisco, and every California destination community.',
  },
  'truckee': {
    cityName: 'Truckee', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'South Lake Tahoe', slug: 'south-lake-tahoe' },
      { city: 'Napa',             slug: 'napa'             },
      { city: 'Healdsburg',       slug: 'healdsburg'       },
    ],
    otherStateCities: [
    ...
    contextualSentence: 'Not in Truckee? We serve all of the Sierra Nevada and California — South Lake Tahoe, Napa, and every California mountain and destination community.',
  },
  // ── Batch 5 — Wine Country / Sacramento ───────────────────────────────────
  'napa': {
    cityName: 'Napa', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Healdsburg',      slug: 'healdsburg'      },
      { city: 'Sonoma',          slug: 'sonoma'          },
      { city: 'Santa Barbara',   slug: 'santa-barbara'   },
    ],
    otherStateCities: [
      { city: 'Beverly Hills',   slug: 'beverly-hills'   },
    ...
    contextualSentence: 'Not in Napa? We serve all of California wine country — Healdsburg, Sonoma, Santa Barbara, and every California destination community.',
  },
  'healdsburg': {
    cityName: 'Healdsburg', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Napa',            slug: 'napa'            },
      { city: 'Sonoma',          slug: 'sonoma'          },
      { city: 'Santa Barbara',   slug: 'santa-barbara'   },
    ...
    contextualSentence: 'Not in Healdsburg? We serve all of Sonoma County and California wine country — Napa, Sonoma, Santa Barbara, and every California destination community.',
  },
  'sonoma': {
    cityName: 'Sonoma', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Napa',            slug: 'napa'            },
      { city: 'Healdsburg',      slug: 'healdsburg'      },
      { city: 'Santa Barbara',   slug: 'santa-barbara'   },
    ...
    contextualSentence: 'Not in Sonoma? We serve all of California wine country — Napa, Healdsburg, Santa Barbara, and every California destination community.',
  },
  'folsom': {
    cityName: 'Folsom', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Granite Bay',     slug: 'granite-bay'     },
      { city: 'Atherton',        slug: 'atherton'        },
      { city: 'San Francisco',   slug: 'san-francisco'   },
    ],
    otherStateCities: [
    ...
    contextualSentence: 'Not in Folsom? We serve all of the Sacramento foothill region and California — Granite Bay, Roseville, and every California community.',
  },
  'granite-bay': {
    cityName: 'Granite Bay', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Folsom',          slug: 'folsom'          },
      { city: 'Atherton',        slug: 'atherton'        },
      { city: 'San Francisco',   slug: 'san-francisco'   },
    ],
    otherStateCities: [
    ...
    contextualSentence: 'Not in Granite Bay? We serve all of Placer County and California — Folsom, Roseville, and every California premium community.',
  },
  // ── Batch 4 — Silicon Valley / Bay Area ───────────────────────────────────
  'atherton': {
    cityName: 'Atherton', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Palo Alto',       slug: 'palo-alto'       },
      { city: 'Los Gatos',       slug: 'los-gatos'       },
      { city: 'San Francisco',   slug: 'san-francisco'   },
    ],
    otherStateCities: [
      { city: 'Beverly Hills',   slug: 'beverly-hills'   },
      { city: 'Malibu',          slug: 'malibu'          },
      { city: 'Rancho Santa Fe', slug: 'rancho-santa-fe' },
    ],
    contextualSentence: 'Not in Atherton? We serve all of Silicon Valley and California — Palo Alto, Los Gatos, San Francisco, and every California luxury estate community.',
  },
  'palo-alto': {
    cityName: 'Palo Alto', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Atherton',        slug: 'atherton'        },
      { city: 'Los Gatos',       slug: 'los-gatos'       },
      { city: 'San Francisco',   slug: 'san-francisco'   },
    ...
    contextualSentence: 'Not in Palo Alto? We serve all of Silicon Valley and California — Atherton, Los Gatos, San Francisco, and every California luxury community.',
  },
  'los-gatos': {
    cityName: 'Los Gatos', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Palo Alto',       slug: 'palo-alto'       },
      { city: 'Atherton',        slug: 'atherton'        },
    ...
    contextualSentence: 'Not in Los Gatos? We serve all of Silicon Valley and California — Palo Alto, Atherton, San Jose, and every California premium community.',
  },
  'san-francisco': {
    cityName: 'San Francisco', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Palo Alto',       slug: 'palo-alto'       },
      { city: 'Atherton',        slug: 'atherton'        },
      { city: 'San Jose',        slug: 'san-jose'        },
    ...
    contextualSentence: 'Not in San Francisco? We serve all of the Bay Area and California — Palo Alto, Atherton, San Jose, and every California city.',
  },
  'san-jose': {
    cityName: 'San Jose', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'San Francisco',   slug: 'san-francisco'   },
      { city: 'Palo Alto',       slug: 'palo-alto'       },
      { city: 'Los Gatos',       slug: 'los-gatos'       },
    ...
    contextualSentence: 'Not in San Jose? We serve all of Silicon Valley and California — San Francisco, Palo Alto, Los Gatos, and every California city.',
  },
  // ── Batch 3 — San Diego North ─────────────────────────────────────────────
  'la-jolla': {
    cityName: 'La Jolla', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Coronado',        slug: 'coronado'        },
      { city: 'Del Mar',         slug: 'del-mar'         },
      { city: 'Carlsbad',        slug: 'carlsbad'        },
    ],
    otherStateCities: [
      { city: 'Beverly Hills',   slug: 'beverly-hills'   },
    ...
    contextualSentence: 'Not in La Jolla? We serve all of San Diego County and California — Coronado, Del Mar, Rancho Santa Fe, and every California coastal community.',
  },
  'coronado': {
    cityName: 'Coronado', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'La Jolla',        slug: 'la-jolla'        },
      { city: 'Del Mar',         slug: 'del-mar'         },
    ],
    ...
    contextualSentence: 'Not in Coronado? We serve all of San Diego County and California — La Jolla, Del Mar, Rancho Santa Fe, and every California coastal community.',
  },
  'del-mar': {
    cityName: 'Del Mar', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'La Jolla',        slug: 'la-jolla'        },
      { city: 'Rancho Santa Fe', slug: 'rancho-santa-fe' },
      { city: 'Carlsbad',        slug: 'carlsbad'        },
    ...
    contextualSentence: 'Not in Del Mar? We serve all of North San Diego County and California — La Jolla, Rancho Santa Fe, Carlsbad, and every California coastal community.',
  },
  'rancho-santa-fe': {
    cityName: 'Rancho Santa Fe', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Del Mar',         slug: 'del-mar'         },
      { city: 'La Jolla',        slug: 'la-jolla'        },
      { city: 'Carlsbad',        slug: 'carlsbad'        },
    ...
    contextualSentence: 'Not in Rancho Santa Fe? We serve all of San Diego County and California — Del Mar, La Jolla, Carlsbad, and every California luxury community.',
  },
  'carlsbad': {
    cityName: 'Carlsbad', stateSlug: 'california', stateName: 'California', stateAbbr: 'CA',
    nearbyMajorCities: [
      { city: 'Del Mar',         slug: 'del-mar'         },
      { city: 'Rancho Santa Fe', slug: 'rancho-santa-fe' },
      { city: 'La Jolla',        slug: 'la-jolla'        },
    ...
    contextualSentence: 'Not in Carlsbad? We serve all of North San Diego County and California — Del Mar, Rancho Santa Fe, La Jolla, and every California coastal community.',
  },

  // ── Alabama ───────────────────────────────────────────────────────────────
  'birmingham': {
    cityName: 'Birmingham', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Mountain Brook', slug: 'mountain-brook' },
      { city: 'Vestavia Hills', slug: 'vestavia-hills' },
      { city: 'Hoover',         slug: 'hoover'         },
      { city: 'Huntsville',     slug: 'huntsville'     },
    ],
    otherStateCities: [
      { city: 'Montgomery', slug: 'montgomery' },
      { city: 'Mobile',     slug: 'mobile'     },
    ],
    contextualSentence: 'Not in Birmingham? We serve all of Alabama — Mountain Brook and Vestavia Hills estate events, Huntsville aerospace-family dinners, Gulf Shores beach house events, and every Alabama community.',
  },
  'mountain-brook': {
    cityName: 'Mountain Brook', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
    ...
    contextualSentence: 'Not in Mountain Brook? We serve all of Alabama — Birmingham, Vestavia Hills, Hoover, Huntsville, and every Alabama estate and milestone market.',
  },
  'vestavia-hills': {
    cityName: 'Vestavia Hills', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Birmingham',     slug: 'birmingham'     },
      { city: 'Mountain Brook', slug: 'mountain-brook' },
      { city: 'Hoover',         slug: 'hoover'         },
    ...
    contextualSentence: 'Not in Vestavia Hills? We serve all of Alabama — Birmingham, Mountain Brook, Hoover, Huntsville, and every Alabama graduation and milestone market.',
  },
  'hoover': {
    cityName: 'Hoover', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Birmingham',     slug: 'birmingham'     },
      { city: 'Vestavia Hills', slug: 'vestavia-hills' },
      { city: 'Mountain Brook', slug: 'mountain-brook' },
    ...
    contextualSentence: 'Not in Hoover? We serve all of Alabama — Birmingham, Vestavia Hills, Mountain Brook, Huntsville, Gulf Shores, and every Alabama market.',
  },
  'huntsville': {
    cityName: 'Huntsville', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Madison',        slug: 'madison'        },
      { city: 'Birmingham',     slug: 'birmingham'     },
      { city: 'Vestavia Hills', slug: 'vestavia-hills' },
    ...
    otherStateCities: [
      { city: 'Montgomery',  slug: 'montgomery'  },
      { city: 'Gulf Shores', slug: 'gulf-shores' },
    ],
    contextualSentence: 'Not in Huntsville? We serve all of Alabama — Birmingham, Mountain Brook, Vestavia Hills, Montgomery, Gulf Shores, and every Alabama aerospace and estate market.',
  },
  'homewood': {
    cityName: 'Homewood', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Birmingham',     slug: 'birmingham'     },
      { city: 'Mountain Brook', slug: 'mountain-brook' },
      { city: 'Vestavia Hills', slug: 'vestavia-hills' },
    ...
    contextualSentence: 'Not in Homewood? We serve all of Alabama — Birmingham, Mountain Brook, Vestavia Hills, Hoover, Huntsville, and every Alabama market.',
  },
  'madison': {
    cityName: 'Madison', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Huntsville',     slug: 'huntsville'     },
      { city: 'Birmingham',     slug: 'birmingham'     },
    ],
    ...
    contextualSentence: 'Not in Madison? We serve all of Alabama — Huntsville, Birmingham, and every North Alabama engineering-family and milestone market.',
  },
  'tuscaloosa': {
    cityName: 'Tuscaloosa', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Birmingham',     slug: 'birmingham'     },
      { city: 'Hoover',         slug: 'hoover'         },
    ],
    ...
    contextualSentence: 'Not in Tuscaloosa? We serve all of Alabama — Birmingham, Auburn, Montgomery, Gulf Shores, and every Alabama university and celebration market.',
  },
  'auburn': {
    cityName: 'Auburn', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Birmingham', slug: 'birmingham' },
      { city: 'Montgomery', slug: 'montgomery' },
    ],
    ...
    contextualSentence: 'Not in Auburn? We serve all of Alabama — Birmingham, Tuscaloosa, Montgomery, Gulf Shores, and every Alabama graduation weekend and celebration market.',
  },
  'montgomery': {
    cityName: 'Montgomery', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Birmingham',  slug: 'birmingham'  },
      { city: 'Tuscaloosa', slug: 'tuscaloosa'   },
      { city: 'Auburn',     slug: 'auburn'       },
    ...
    contextualSentence: 'Not in Montgomery? We serve all of Alabama — Birmingham, Tuscaloosa, Auburn, Huntsville, Gulf Shores, and every Alabama market.',
  },
  'mobile': {
    cityName: 'Mobile', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Fairhope',    slug: 'fairhope'    },
      { city: 'Daphne',     slug: 'daphne'      },
      { city: 'Gulf Shores', slug: 'gulf-shores' },
    ...
    contextualSentence: 'Not in Mobile? We serve all of Alabama\'s Gulf Coast and Mobile Bay area — Fairhope, Daphne, Gulf Shores, Orange Beach, and every Eastern Shore and coastal Alabama community.',
  },
  'fairhope': {
    cityName: 'Fairhope', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Mobile',       slug: 'mobile'       },
      { city: 'Daphne',       slug: 'daphne'       },
      { city: 'Gulf Shores',  slug: 'gulf-shores'  },
    ...
    contextualSentence: 'Not in Fairhope? We serve all of Alabama\'s Eastern Shore and Gulf Coast — Mobile, Daphne, Gulf Shores, Orange Beach, and every Mobile Bay and coastal community.',
  },
  'daphne': {
    cityName: 'Daphne', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Mobile',       slug: 'mobile'       },
      { city: 'Fairhope',     slug: 'fairhope'     },
      { city: 'Gulf Shores',  slug: 'gulf-shores'  },
    ...
    contextualSentence: 'Not in Daphne? We serve all of Alabama\'s Eastern Shore and Gulf Coast — Mobile, Fairhope, Gulf Shores, Orange Beach, and every Mobile Bay community.',
  },
  'gulf-shores': {
    cityName: 'Gulf Shores', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Orange Beach', slug: 'orange-beach' },
      { city: 'Fairhope',     slug: 'fairhope'     },
      { city: 'Mobile',       slug: 'mobile'       },
    ...
    contextualSentence: 'Not in Gulf Shores? We serve all of Alabama\'s Gulf Coast — Orange Beach, Fairhope, Daphne, Mobile, and every Alabama coastal community.',
  },
  'orange-beach': {
    cityName: 'Orange Beach', stateSlug: 'alabama', stateName: 'Alabama', stateAbbr: 'AL',
    nearbyMajorCities: [
      { city: 'Gulf Shores',  slug: 'gulf-shores'  },
      { city: 'Fairhope',     slug: 'fairhope'     },
      { city: 'Mobile',       slug: 'mobile'       },
    ...
    contextualSentence: 'Not in Orange Beach? We serve all of Alabama\'s Gulf Coast — Gulf Shores, Fairhope, Daphne, Mobile, and every Alabama coastal and bay-view community.',
  },
}
