...
// `private-hibachi-moab-zion-national-park` is intentionally NOT featured here — its natural
// slot (index 1) is shared with Theme 1 (Wasatch Front Family / Lehi, Provo, Orem), where a
// Moab/Zion vacation-rental post would be a geographic mismatch. It's still fully live and
// linked from the Utah guide, the Park City guide, and the /blog index.
const UT_BLOG_POSTS = [
  // Theme 0 — Salt Lake Valley Executive (variant 0; also serves Theme 3 Mountain Resort)
  [
    { slug: 'hibachi-at-home-utah-guide',           title: 'Private Hibachi Chef in Utah: The Complete Guide to All Five Markets',    excerpt: 'From Salt Lake Valley executive dinners to Park City ski estates and Moab vacation rentals — how private hibachi works across Utah.', date: '2026-07-22' },
  ...
  [
    { slug: 'private-hibachi-park-city-ski-vacation', title: 'Private Hibachi Chef in Park City: The Ski Vacation & Sundance Season Guide', excerpt: 'Sundance season dinners, bachelor and bachelorette weekends, and corporate retreats — how to book a private hibachi chef in Park City.', date: '2026-07-25' },
