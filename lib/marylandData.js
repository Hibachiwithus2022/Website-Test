...
const MD_NEARBY_MAJOR = [
  ...
  ['Bethesda', 'Rockville', 'Gaithersburg', 'Baltimore', 'Columbia'],                     // v=4 Capital/Southern (placeholder)
  ['Bethesda', 'Rockville', 'Baltimore', 'Columbia', 'Gaithersburg'],                     // v=5 Eastern Shore (placeholder)
]
