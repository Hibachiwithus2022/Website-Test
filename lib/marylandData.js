...
const MD_SECTION_VARIANTS = [
  // Theme 0 — DC Corridor Luxury
  {
    ...
    experiencePoints:      (city) => [
      { icon: '🏛️', title: `Your ${city} Estate Is the Venue`,      desc: `A certified teppanyaki chef performing exclusively at your ${city} estate — no restaurant setting can match the privacy and prestige.` },
      { icon: '🥩', title: 'Premium Proteins, Live Fire',            desc: 'Filet mignon, lobster tail, wagyu, and Chilean sea bass — cooked live on the teppan at your property. The DC Metro estate standard.' },
      { icon: '🤫', title: 'Complete Discretion',                    desc: 'Your event stays at your property. No shared dining rooms, no strangers, no valet lines. Just your guests, your chef, and your evening.' },
      { icon: '✨', title: 'Full Show, Zero Cleanup',                desc: `Premium performance, hand-selected proteins, and complete teardown. Your ${city} estate is spotless when the chef leaves.` },
    ],
  ...
  // Theme 1 — Montgomery County Diverse & Tech
  {
    ...
    experiencePoints:      (city) => [
      { icon: '👨‍🍳', title: `Certified Chef at Your ${city} Backyard`, desc: `Your certified teppanyaki chef sets up at your ${city} home and performs exclusively for your guests — the whole group at one grill, one chef, one evening.` },
      { icon: '👥', title: 'Dual Stations for Large Groups',            desc: 'Graduation parties of 40–80 guests? We bring two chefs and two grills so everyone eats at the same time — no staggered service, no long waits.' },
      { icon: '🎉', title: 'Every Community Celebration',              desc: 'Graduation dinners, Diwali celebrations, Eid gatherings, bar and bat mitzvah dinners — every milestone Montgomery County marks with full intention.' },
      { icon: '✨', title: 'Full Setup and Complete Cleanup',           desc: `We arrive, set up, perform, and leave your ${city} backyard exactly as we found it. You host — we handle everything else.` },
    ],
  ...
  // Theme 2 — Howard County & Inner Suburbs
  {
    ...
    experiencePoints:      (city) => [
      { icon: '👨‍🍳', title: `Private Chef at Your ${city} Home`,        desc: `A certified teppanyaki chef sets up at your ${city} property and performs exclusively for your guests — the full live teppanyaki show in your own backyard.` },
      { icon: '👥', title: 'Dual Stations for Milestone Gatherings',    desc: 'Howard County graduation parties run large — dual-station setups serve 25–80 guests simultaneously, with no staggered service and no long waits.' },
      { icon: '🎉', title: 'Howard County Milestone Culture',           desc: 'Graduation dinners, b\'nai mitzvah celebrations, family reunions, and the community occasions that Howard County\'s diverse, accomplished community marks with full intention.' },
      { icon: '✨', title: 'Complete Setup and Cleanup',                desc: `Your ${city} property is spotless when we leave. You stay with your guests — we handle every detail from setup through final cleanup.` },
    ],
  ...
  // Theme 3 — Baltimore Metro
  {
    ...
    experiencePoints:      (city) => [
      { icon: '👨‍🍳', title: `Private Chef at Your ${city} Venue`,      desc: `A certified teppanyaki chef at your ${city} backyard, rooftop, or outdoor space — performing exclusively for your group from first flame to final plate.` },
      { icon: '💼', title: 'Corporate and Professional Events',         desc: 'Johns Hopkins, UMMC, Towson University, and the Baltimore professional community — corporate team dinners and client appreciation events are a strong Baltimore market.' },
      { icon: '🎓', title: 'University Graduation Season',             desc: 'Towson, UMBC, Johns Hopkins, Loyola, Morgan State — Baltimore\'s university graduation season (May–June) is one of our busiest Maryland markets. Reserve early.' },
      { icon: '✨', title: 'Full Setup and Complete Cleanup',          desc: `Your ${city} location is immaculate when the chef leaves. We handle every detail — setup, performance, cleanup — so you stay with your guests.` },
    ],
  ...
  // Theme 4 — Capital & Southern Maryland
  {
    ...
    experiencePoints:      (city) => [
      { icon: '⚓', title: `Chef at Your ${city} Waterfront Property`, desc: `Your certified teppanyaki chef sets up on your dock-side deck, terrace, or waterfront patio — performing exclusively for your group against the backdrop of the Chesapeake Bay.` },
      { icon: '🦞', title: 'Premium Proteins for Waterfront Occasions', desc: 'Lobster tail, filet mignon, Chilean sea bass, and wagyu — the standard upgrade for Chesapeake Bay waterfront events. Mix and match per guest at booking.' },
      { icon: '🎖️', title: 'USNA Graduation and Military Occasions',   desc: 'Naval Academy graduation weekend, military homecomings, and deployment farewell dinners — the most emotionally significant occasions in the Annapolis community.' },
      { icon: '✨', title: 'Full Setup and Complete Cleanup',           desc: `Your ${city} waterfront property is immaculate when we leave. No grease, no residue, no trace — your rental or estate is exactly as it was.` },
    ],
  ...
  // Theme 5 — Chesapeake Bay & Eastern Shore
  {
    ...
    experiencePoints:      (city) => [
      { icon: '🏖️', title: `Chef Travels to Your ${city} Rental`,     desc: `Your certified teppanyaki chef travels to your ${city} beach house or vacation rental — sets up on the deck, performs for the whole group, leaves the property immaculate.` },
      { icon: '🥂', title: 'Bachelorette Weekends and Reunions',      desc: 'Ocean City bachelorette groups, multi-family beach house reunions, and summer vacation rental group dinners — the format that keeps everyone together at the rental.' },
      { icon: '🌊', title: 'The Full Eastern Shore Corridor',         desc: 'Ocean City, St. Michaels, Kent Island, Easton, Tilghman Island, and the full Eastern Shore vacation community — all within our service area.' },
      { icon: '✨', title: 'Complete Cleanup — Rental Safe',          desc: `Your ${city} vacation rental is spotless when the chef leaves. No grease, no residue, no cleanup for your group. The security deposit is safe.` },
    ],
    experienceImage:       '/pics/hibachi-event.jpg',
...
const MD_BLOG_POSTS = [
  // Theme 0 — DC Corridor Luxury
  [
    { slug: 'hibachi-at-home-maryland-guide',        title: 'Private Hibachi Chef in Maryland: The Complete Guide to All Six Markets',   excerpt: 'From Bethesda estate dinners to Ocean City beach house events — how private hibachi works across Maryland\'s six distinct entertaining markets.', date: '2026-07-14' },
  ...
  // Theme 4 — Capital & Southern Maryland
  [
    { slug: 'private-hibachi-chesapeake-bay-annapolis', title: 'Private Hibachi Chef in Annapolis and the Chesapeake Bay: The Waterfront Dinner Guide', excerpt: 'USNA graduation weekend, Severn River estate dinners, and Chesapeake Bay waterfront entertaining — how to book a private hibachi chef for any Annapolis or Anne Arundel County event.', date: '2026-07-14' },
  ...
  [
    { slug: 'private-hibachi-maryland-shore-ocean-city', title: 'Private Hibachi Chef at Your Maryland Shore Vacation Rental: The Ocean City and St. Michaels Guide', excerpt: 'How to book a private hibachi chef for your Ocean City beach house, St. Michaels cottage, or Chesapeake Bay Eastern Shore vacation rental — and why it\'s the best dinner of the trip.', date: '2026-07-14' },
