...
const FLORIDA_MAJOR_CITIES = {
  ...
  // ── Panhandle ─────────────────────────────────────────────────────────────
  'pensacola':          { v: 0, intro: 21, nearby: ['Pensacola Beach', 'Gulf Breeze', 'Navarre', 'Milton', 'Pace', 'Ferry Pass', 'Cantonment', 'Warrington', 'Perdido Key', 'Molino'] },
  ...
  // ── Others ────────────────────────────────────────────────────────────────
  'gainesville':        { v: 2, intro: 21, nearby: ['Newberry', 'Alachua', 'High Springs', 'Micanopy', 'Waldo', 'Jonesville', 'Archer', 'Hawthorne', 'Ocala', 'Lake City'] },
  'tallahassee':        { v: 4, intro: 20, nearby: ['Midway', 'Havana', 'Quincy', 'Crawfordville', 'Wakulla Springs', 'Monticello', 'Thomasville (GA)', 'Valdosta (GA)', 'Woodville', 'Apalachicola'] },
