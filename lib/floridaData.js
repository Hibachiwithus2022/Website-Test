...
const FLORIDA_MAJOR_CITIES = {
  ...
  'jacksonville':       { v: 4, profileIdx: 3, nearby: ['Gainesville', 'Ponte Vedra Beach', 'Atlantic Beach', 'Neptune Beach', 'Mandarin', 'Fleming Island', 'Orange Park', 'St. Augustine', 'Palm Coast', 'Amelia Island'] },
  ...
  'west-palm-beach':    { v: 1, profileIdx: 7, nearby: ['Port St. Lucie', 'Palm Beach', 'Jupiter', 'Boca Raton', 'Delray Beach', 'Lake Worth', 'Wellington', 'Boynton Beach', 'Greenacres', 'Royal Palm Beach'] },
  ...
  // ── Growth markets ────────────────────────────────────────────────────────
  // intro: which Florida intro variant to use (18=vacation rental, 19=luxury waterfront, 20=family vacation, 21=bachelorette/social, 22=snowbird/residential)
  'key-west':           { v: 0, intro: 21, nearby: ['Stock Island', 'Big Pine Key', 'Marathon', 'Islamorada', 'Key Largo', 'Sugarloaf Key', 'Cudjoe Key', 'Ramrod Key', 'Summerland Key', 'No Name Key'] },
  'cape-coral':         { v: 4, intro: 19, nearby: ['Fort Myers', 'Bonita Springs', 'Estero', 'Naples', 'Lehigh Acres', 'Sanibel', 'Pine Island', 'North Fort Myers', 'Gateway', 'Iona'] },
  'boca-raton':         { v: 1, intro: 22, nearby: ['Delray Beach', 'Deerfield Beach', 'Pompano Beach', 'Boynton Beach', 'West Palm Beach', 'Lake Worth', 'Coral Springs', 'Coconut Creek', 'Highland Beach', 'Parkland'] },
  'panama-city-beach':  { v: 0, intro: 18, nearby: ['Panama City', 'Lynn Haven', 'Callaway', 'Springfield', 'Destin', 'Fort Walton Beach', 'Santa Rosa Beach', '30A', 'Pier Park area', 'Rosemary Beach'] },
  '30a':                { v: 1, intro: 19, nearby: ['Seaside', 'Rosemary Beach', 'Alys Beach', 'WaterColor', 'Grayton Beach', 'Blue Mountain Beach', 'Inlet Beach', 'Santa Rosa Beach', 'Destin', 'Fort Walton Beach'] },

  // ── Panhandle ─────────────────────────────────────────────────────────────
  'pensacola':          { v: 0, intro: 21, nearby: ['Tallahassee', 'Pensacola Beach', 'Gulf Breeze', 'Navarre', 'Milton', 'Pace', 'Ferry Pass', 'Cantonment', 'Warrington', 'Perdido Key'] },
  'fort-walton-beach':  { v: 0, intro: 22, nearby: ['Destin', 'Okaloosa Island', 'Niceville', 'Valparaiso', 'Navarre', 'Crestview', 'Mary Esther', 'Shalimar', 'Eglin AFB area', 'Hurlburt Field area'] },
  'miramar-beach':      { v: 0, intro: 18, nearby: ['Destin', 'Sandestin', 'Santa Rosa Beach', '30A', 'Fort Walton Beach', 'Niceville', 'DeFuniak Springs', 'Panama City Beach', 'Freeport', 'Navarre'] },

  // ── Northeast FL ──────────────────────────────────────────────────────────
  'st-augustine':       { v: 0, intro: 20, nearby: ['Ponte Vedra Beach', 'Palm Coast', 'Vilano Beach', 'Anastasia Island', 'St. Augustine Beach', 'Flagler Beach', 'Crescent Beach', 'Elkton', 'Hastings', 'Switzerland'] },
  'ponte-vedra-beach':  { v: 1, intro: 22, nearby: ['Jacksonville Beach', 'Neptune Beach', 'Atlantic Beach', 'St. Augustine', 'Palm Valley', 'Nocatee', 'Sawgrass', 'Palm Coast', 'Mandarin', 'Julington Creek'] },
  'palm-coast':         { v: 0, intro: 18, nearby: ['Flagler Beach', 'Bunnell', 'Ormond Beach', 'Daytona Beach', 'St. Augustine', 'Ponte Vedra Beach', 'Marineland', 'Beverly Beach', 'Hammock Beach', 'Matanzas'] },
  'daytona-beach':      { v: 0, intro: 21, nearby: ['Ormond Beach', 'Port Orange', 'South Daytona', 'Holly Hill', 'Daytona Beach Shores', 'New Smyrna Beach', 'Edgewater', 'Palm Coast', 'DeLand', 'Deltona'] },
  'amelia-island':      { v: 0, intro: 18, nearby: ['Fernandina Beach', 'Yulee', 'Callahan', 'Jacksonville', 'Atlantic Beach', 'St. Marys (GA)', 'Kingsland (GA)', 'Hilliard', 'Bryceville', 'Macclenny'] },

  // ── Central FL ────────────────────────────────────────────────────────────
  'kissimmee':          { v: 2, intro: 20, nearby: ['Celebration', 'Lake Buena Vista', 'Davenport', 'Champions Gate', 'Poinciana', 'St. Cloud', 'Reunion', 'Solterra', 'Windermere', 'Winter Garden'] },
  'davenport':          { v: 2, intro: 18, nearby: ['Champions Gate', 'Clermont', 'Kissimmee', 'Poinciana', 'Haines City', 'Winter Haven', 'Lake Wales', 'Four Corners', 'Solterra', 'Reunion'] },
  'clermont':           { v: 2, intro: 22, nearby: ['Winter Garden', 'Minneola', 'Groveland', 'Mascotte', 'Montverde', 'Windermere', 'Oakland', 'Leesburg', 'Tavares', 'Kissimmee'] },
  'winter-garden':      { v: 4, intro: 19, nearby: ['Clermont', 'Windermere', 'Ocoee', 'Oakland', 'Minneola', 'Gotha', 'Montverde', 'Apopka', 'Longwood', 'Altamonte Springs'] },
  'lake-buena-vista':   { v: 2, intro: 21, nearby: ['Kissimmee', 'Celebration', 'Windermere', 'Champions Gate', 'Davenport', 'Winter Garden', 'Doctor Phillips', 'Bay Hill', 'Orlando', 'Buena Ventura Lakes'] },

  // ── Tampa Bay ─────────────────────────────────────────────────────────────
  'clearwater':         { v: 3, intro: 21, nearby: ['Dunedin', 'Safety Harbor', 'Tarpon Springs', 'Largo', 'Palm Harbor', 'St. Petersburg', 'Seminole', 'Belleair', 'Indian Rocks Beach', 'Treasure Island'] },
  'wesley-chapel':      { v: 4, intro: 22, nearby: ["Land O'Lakes", 'Zephyrhills', 'New Tampa', 'Lutz', 'Pasco', 'Dade City', 'San Antonio', 'Odessa', 'Carrollwood', 'Tampa'] },
  'riverview':          { v: 4, intro: 22, nearby: ['Brandon', 'Valrico', 'Apollo Beach', 'Gibsonton', 'Sun City Center', 'Wimauma', 'Ruskin', 'Lithia', 'Boyette', 'Tampa'] },
  'bradenton':          { v: 4, intro: 19, nearby: ['Sarasota', 'Anna Maria Island', 'Palmetto', 'Lakewood Ranch', 'Ellenton', 'Parrish', 'Oneco', 'Cortez', 'Longboat Key', 'Venice'] },

  // ── Southwest FL ──────────────────────────────────────────────────────────
  'fort-myers':         { v: 4, intro: 22, nearby: ['Cape Coral', 'Bonita Springs', 'Estero', 'Naples', 'Lehigh Acres', 'Sanibel', 'Pine Island', 'Gateway', 'Daniels Corridor', 'McGregor'] },
  'bonita-springs':     { v: 1, intro: 18, nearby: ['Naples', 'Estero', 'Fort Myers', 'Cape Coral', 'Marco Island', 'Pelican Landing', 'Barefoot Beach', 'Lely', 'Ave Maria', 'Miromar Lakes'] },
  'marco-island':       { v: 1, intro: 19, nearby: ['Naples', 'Goodland', 'Isles of Capri', 'Bonita Springs', 'Estero', 'Fort Myers', 'Everglades City', 'Chokoloskee', 'Olde Naples', 'Pelican Bay'] },
  'venice':             { v: 4, intro: 22, nearby: ['Sarasota', 'Nokomis', 'Osprey', 'Englewood', 'North Port', 'Port Charlotte', 'Laurel', 'Manasota Key', 'South Venice', 'Wellen Park'] },

  // ── South FL ──────────────────────────────────────────────────────────────
  'coral-gables':       { v: 1, intro: 19, nearby: ['Coconut Grove', 'South Miami', 'Kendall', 'Pinecrest', 'Miami Beach', 'Brickell', 'Doral', 'Westchester', 'Sweetwater', 'Hialeah'] },
  'hollywood':          { v: 3, intro: 21, nearby: ['Hallandale Beach', 'Pembroke Pines', 'Fort Lauderdale', 'Dania Beach', 'Miramar', 'Cooper City', 'Davie', 'Aventura', 'Weston', 'Plantation'] },
  'aventura':           { v: 1, intro: 19, nearby: ['Hallandale Beach', 'Sunny Isles Beach', 'North Miami Beach', 'Golden Beach', 'Hollywood', 'Bal Harbour', 'Surfside', 'Fort Lauderdale', 'Dania Beach', 'Miami Beach'] },
  'delray-beach':       { v: 3, intro: 21, nearby: ['Boca Raton', 'Boynton Beach', 'Lake Worth', 'Lantana', 'Highland Beach', 'Deerfield Beach', 'Pompano Beach', 'West Palm Beach', 'Greenacres', 'Palm Springs'] },
  'pompano-beach':      { v: 0, intro: 18, nearby: ['Fort Lauderdale', 'Deerfield Beach', 'Coconut Creek', 'Margate', 'Coral Springs', 'Lighthouse Point', 'Boca Raton', 'Lauderdale-by-the-Sea', 'Oakland Park', 'Lauderhill'] },
  'deerfield-beach':    { v: 0, intro: 18, nearby: ['Boca Raton', 'Pompano Beach', 'Coconut Creek', 'Margate', 'Hillsboro Beach', 'Lighthouse Point', 'Fort Lauderdale', 'Coral Springs', 'Parkland', 'Hillsboro Pines'] },
  'jupiter':            { v: 1, intro: 19, nearby: ['Palm Beach Gardens', 'Tequesta', 'Juno Beach', 'North Palm Beach', 'West Palm Beach', 'Hobe Sound', 'Stuart', 'Palm City', 'Abacoa', 'Loxahatchee'] },
  'lake-worth':         { v: 0, intro: 22, nearby: ['West Palm Beach', 'Boynton Beach', 'Lantana', 'Greenacres', 'Lake Worth Beach', 'Wellington', 'Delray Beach', 'Royal Palm Beach', 'Palm Springs', 'Haverhill'] },

  // ── Others ────────────────────────────────────────────────────────────────
  'gainesville':        { v: 2, intro: 21, nearby: ['Tallahassee', 'Newberry', 'Alachua', 'High Springs', 'Micanopy', 'Waldo', 'Jonesville', 'Archer', 'Hawthorne', 'Ocala'] },
  'tallahassee':        { v: 4, intro: 20, nearby: ['Gainesville', 'Pensacola', 'Midway', 'Havana', 'Quincy', 'Crawfordville', 'Wakulla Springs', 'Monticello', 'Woodville', 'Apalachicola'] },
  'kendall':            { v: 3, intro: 20, nearby: ['Pinecrest', 'South Miami', 'Doral', 'Westchester', 'Sweetwater', 'Coral Gables', 'Hialeah', 'Homestead', 'Fontainebleau', 'Miami'] },
  'port-st-lucie':      { v: 0, intro: 22, nearby: ['Stuart', 'Palm City', 'Tradition', 'Torino', 'Lakewood Park', 'Jensen Beach', 'Vero Beach', 'Fort Pierce', 'Hobe Sound', 'White City'] },
}

// Correct display names that slugToCity() cannot reconstruct from the slug alone
const FLORIDA_CITY_DISPLAY_NAMES = {
  '30a':           '30A',
...
export function getFloridaCityData(citySlug, cityName) {
  ...
  const displayName = FLORIDA_CITY_DISPLAY_NAMES[citySlug] ?? cityName
  ...
  return {
    ...
    heroSubtitle: override?.heroSubtitle ?? profile?.heroSubtitle ?? FLORIDA_HERO_SUBTITLES[v](displayName),
    nearbyCities:      major?.nearby ?? [],
    nearbyMajorCities: ['Miami', 'Orlando', 'Tampa', 'Jacksonville', 'Fort Lauderdale'],
    localHighlights:   override?.localHighlights ?? FLORIDA_LOCAL_HIGHLIGHTS[v](displayName),
    featuredOccasions: FLORIDA_OCCASIONS[v],
    faqSet:            override?.faqSet ?? FLORIDA_FAQ_SETS[v](displayName),
    testimonials:      override?.testimonials ?? FLORIDA_TESTIMONIALS[v],
    // Top-10 major cities (profileIdx defined) get city-specific intros 23–32; others use per-city intro or fallback 18–22
    uniqueIntroVariant:   (major?.profileIdx != null) ? 23 + major.profileIdx : (major?.intro ?? 18 + v),
...
const FLORIDA_SUPPORT_IMAGES = {
  miami: {
    testimonial: {
      ...
      intro:   (city) => `Trusted by ${city} hosts, executives, and event planners across South Florida, from intimate Brickell apartment dinners to 60-person Coral Gables estate parties. Our certified chefs travel to your ${city} waterfront terrace, rooftop deck, or backyard with the full teppanyaki setup and handle every detail — fresh ingredients, live performance, and complete cleanup. Here's what ${city} hosts are saying:`,
    },
    cta: {
  ...
  orlando: {
    testimonial: {
      ...
      intro:   (city) => `${city} vacation rental groups — from Disney-area family reunions to Champions Gate bachelorette weekends — have made private hibachi the must-do evening event of every Florida trip. Our certified chefs travel to your VRBO or Airbnb with the full teppanyaki setup; no restaurant logistics, no driving, just a live chef performing on your pool deck. Here's what ${city} groups are saying:`,
    },
    cta: {
  ...
  tampa: {
    testimonial: {
      ...
      intro:   (city) => `${city} Bay bachelorette groups, Ybor City weekend visitors, and waterfront homeowners choose private hibachi for the evenings they want to remember most. Our certified chefs arrive at your ${city} pool deck or backyard with the full teppanyaki setup, cook fresh on-site, and handle complete cleanup afterward. See what ${city} hosts are saying:`,
    },
    cta: {
  ...
  jacksonville: {
    testimonial: {
      ...
      intro:   (city) => `Military families from Naval Air Station Jacksonville, Beaches area vacation renters, and Northeast Florida celebration hosts all choose private hibachi for backyard gatherings that feel genuinely special. Our certified chefs travel throughout the ${city} metro — from Ponte Vedra to Orange Park — with full teppanyaki setup and complete cleanup. Read what ${city} hosts are saying:`,
    },
    cta: {
  ...
  'fort-lauderdale': {
    testimonial: {
      ...
      intro:   (city) => `${city}'s boating community, Las Olas entertainment crowd, and bachelorette groups booking beach house weekends have all discovered that private hibachi turns any canal-front patio into the best table in town. Our certified chefs travel to your ${city} waterfront property with the full teppanyaki setup and handle complete cleanup when the evening is done. Here's what ${city} hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-dallas-tyler.jpg',
  ...
  sarasota: {
    testimonial: {
      ...
      intro:   (city) => `${city}'s arts community, affluent seasonal residents, and Gulf Coast waterfront homeowners choose private hibachi for the dinner experience that matches the sophistication of this city. From Siesta Key beach house gatherings to downtown ${city} penthouse events, our certified chefs arrive with full teppanyaki setup and leave with everything cleaned up. See what ${city} hosts are saying:`,
    },
    cta: {
  ...
  naples: {
    testimonial: {
      ...
      trustBadge: "Florida's Favorite Hibachi Experience",
      intro:   (city) => `${city} hosts — from Pelican Bay estates to Port Royal waterfront properties — expect every element of an event to meet the city's elevated standard, and our private hibachi chefs deliver exactly that. We travel to your ${city} estate with the full teppanyaki setup, source premium proteins, and manage complete cleanup so you can focus entirely on your guests. Here's what ${city} hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-shot-2.jpg',
  ...
  destin: {
    testimonial: {
      ...
      intro:   (city) => `${city} beach house vacations are built around the best experiences the Emerald Coast has to offer — and private hibachi has become the standout evening for bachelorette groups, family reunions, and summer rental gatherings every year. Our certified chefs travel to your ${city} pool deck or covered patio with the full teppanyaki setup; no restaurant hassle, just a live performance right at your rental. Read what ${city} groups are saying:`,
    },
    cta: {
  ...
  'st-petersburg': {
    testimonial: {
      ...
      trustBadge: 'Trusted by Local Families',
      intro:   (city) => `${city}'s vibrant arts scene and thriving young professional community have made private hibachi one of the most popular backyard event formats in the area. From Old Northeast patio dinners to St. Pete Beach vacation rental gatherings, our certified chefs bring the full teppanyaki experience to your outdoor space and handle all setup and cleanup. Here's what ${city} hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-catering.jpg',
  ...
  'west-palm-beach': {
    testimonial: {
      ...
      trustBadge: 'Hundreds of Private Events',
      intro:   (city) => `${city} and the surrounding Palm Beach County communities host an active social calendar year-round — corporate entertaining, snowbird season dinners, and milestone celebrations that call for something more elevated than a restaurant reservation. Our certified chefs travel to your ${city} property with full teppanyaki setup and complete cleanup so the night is effortless on your end. See what ${city} hosts are saying:`,
    },
    cta: {
  ...
  'key-west': {
    testimonial: {
      ...
      trustBadge: 'Thousands of Happy Guests',
      intro:   (city) => `From Duval Street Airbnbs to secluded canal-front bungalows, ${city} vacation groups consistently choose private hibachi as the standout evening of their Florida Keys trip. Our certified chefs travel to your ${city} rental with the full teppanyaki setup — live performance, fresh proteins, and complete cleanup — so your group can experience the Keys at their best. Here's what ${city} guests are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-shot-2.jpg',
  ...
  'boca-raton': {
    testimonial: {
      ...
      trustBadge: 'Highly Rated by Local Hosts',
      intro:   (city) => `From Mizner Park gatherings to Broken Sound Club area estate dinners, ${city} hosts choose private hibachi for milestone events, corporate entertainment, and celebrations that need to exceed expectations. Our certified chefs arrive at your ${city} estate with the full teppanyaki setup and stay until everything is cleaned up — the only effort required from you is enjoying the evening. Read what ${city} hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-catering.jpg',
...
const FLORIDA_SUPPORT_FALLBACKS = [
  {
    testimonial: { src: '/pics/backyard-hibachi.jpg',      alt: (city) => `Pool deck hibachi at a vacation rental near ${city}, Florida`,    caption: null, trustBadge: 'Five-Star Entertainment & Dining',              intro: (city) => `${city} vacation rental groups, local families, and celebration hosts choose private hibachi for the evenings that need to be genuinely memorable. Our certified chefs travel to your ${city} pool deck or outdoor space with full teppanyaki setup and handle everything from cooking to cleanup. Here's what ${city} guests are saying:` },
    cta:         { src: '/pics/hibachi-to-you.jpg',        alt: (city) => `Private hibachi chef arriving for a ${city}, Florida event`,      caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-shot-1.jpg',        alt: (city) => `Luxury private hibachi event near ${city}, Florida`,             caption: null, trustBadge: 'Trusted by Local Families',                       intro: (city) => `Private hibachi has become the go-to group dinner experience across ${city} and the surrounding Florida communities — for beach house weekends, milestone birthdays, and family reunions that want something beyond the standard restaurant night out. Our certified chefs arrive with full teppanyaki setup and handle complete cleanup when the evening wraps. Read what ${city} hosts are saying:` },
    cta:         { src: '/pics/hibachi-chef-at-home.jpg',  alt: (city) => `Hibachi chef at home event in ${city}, Florida`,                 caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-shot-1.jpg',        alt: (city) => `Happy guests at a family vacation hibachi near ${city}, Florida`, caption: null, trustBadge: 'Hundreds of Private Events',                     intro: (city) => `From vacation rental pool decks to backyard patios, ${city} groups are discovering that private hibachi is the dinner format that makes every occasion feel like an event. Our certified chefs bring the full teppanyaki setup to your ${city} location, cook fresh on-site, and take care of every bit of cleanup. See what ${city} guests are saying:` },
    cta:         { src: '/pics/hibachi-catering-2.jpg',    alt: (city) => `Hibachi catering for a vacation group in ${city}, Florida`,       caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-catering-austin.jpg', alt: (city) => `Bachelorette group hibachi event near ${city}, Florida`,        caption: null, trustBadge: "Florida's Favorite Hibachi Experience",           intro: (city) => `Bachelorette groups, family vacationers, and local celebration hosts across ${city} choose private hibachi for the same reason — it turns any outdoor space into the most memorable evening of the trip. Our chefs travel to your ${city} rental or home with full setup and complete cleanup included. Here's what ${city} groups are saying:` },
    cta:         { src: '/pics/backyard-hibachi-2.jpg',    alt: (city) => `Pool deck hibachi party near ${city}, Florida`,                   caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-home-austin.jpg',   alt: (city) => `Residential private hibachi dinner in ${city}, Florida`,          caption: null, trustBadge: 'Thousands of Happy Guests',                      intro: (city) => `Whether it's a milestone birthday, a Florida vacation gathering, or a backyard celebration, ${city} hosts trust our private hibachi chefs to deliver an experience that impresses every guest at the table. We arrive with the full teppanyaki setup, perform live, and leave with everything cleaned up. Read what ${city} hosts are saying:` },
