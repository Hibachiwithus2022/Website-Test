...
const AZ_BLOG_POSTS = [
  ...
  [
    { slug: 'hibachi-bachelorette-party',         title: 'Private Hibachi for Bachelorette Parties: The Ultimate Guide',     excerpt: 'Why Scottsdale and Old Town vacation rental hibachi has become Arizona\'s most requested bachelorette dinner format — and how to plan it.', category: 'Guide', readTime: '6 min read' },
    { slug: 'hibachi-birthday-party-ideas',       title: '10 Hibachi Birthday Party Ideas Your Guests Will Never Forget',    excerpt: 'From Paradise Valley estate milestone dinners to Peoria backyard birthday parties — how to host a private hibachi event in Arizona.', category: 'Guide', readTime: '6 min read' },
    { slug: 'how-much-does-private-hibachi-cost', title: 'How Much Does a Private Hibachi Chef Cost?',                       excerpt: 'A full pricing breakdown for Arizona hibachi events — what\'s included, what to expect at every guest count, and how West Valley pricing works.', category: 'Guide', readTime: '4 min read' },
  ],
  // Slot 1 — T1 Phoenix Core + T4 Northern AZ Mountain (v%3=1: Phoenix, Fountain Hills, Sedona, Flagstaff, Prescott)
  [
    { slug: 'hibachi-catering-corporate-events',    title: 'Why Hibachi Catering Is the Best Choice for Corporate Events',       excerpt: 'Team dinners, client entertainment, and Phoenix professional events — why private hibachi beats every other corporate format in the Valley.', category: 'Guide', readTime: '5 min read' },
    { slug: 'private-hibachi-beach-house-guide',   title: 'Private Hibachi at a Vacation Rental: The Complete Guide',          excerpt: 'Sedona red rock rentals, Flagstaff mountain cabins, and Prescott ponderosa properties — how private hibachi works at any Arizona destination rental.', category: 'Guide', readTime: '7 min read' },
    { slug: 'how-much-does-private-hibachi-cost',  title: 'How Much Does a Private Hibachi Chef Cost?',                        excerpt: 'A full pricing breakdown for Phoenix and Northern Arizona hibachi events — what\'s included at every guest count and occasion type.', category: 'Guide', readTime: '4 min read' },
  ],
  // Slot 2 — T2 East Valley + T5 Southern AZ (v%3=2: Tempe, Chandler, Gilbert, Mesa, Queen Creek, Tucson, Oro Valley)
  [
    { slug: 'hibachi-birthday-party-ideas',       title: '10 Hibachi Birthday Party Ideas Your Guests Will Never Forget',    excerpt: 'East Valley graduation parties, Chandler backyard birthdays, and Tucson milestone dinners — how to host a private hibachi event in Arizona.', category: 'Guide', readTime: '6 min read' },
    { slug: 'what-to-expect-hibachi-chef-home',   title: 'What to Expect When You Book a Private Hibachi Chef at Home',     excerpt: 'From East Valley graduation Saturdays to Catalina Foothills estate dinners — what happens from booking to cleanup at an Arizona private hibachi event.', category: 'Guide', readTime: '5 min read' },
