...
const VA_LOCAL_HIGHLIGHTS = [
  ...
  (city) => [
    ...
    `Perfect for ${city} backyard gatherings, campus events, and mountain retreats`,
...
const VA_CITY_IMAGE_MAP = {
  // Batch 1 — NoVA
  'mclean':         { src: '/pics/hibachi-catering-3.jpg',    alt: (city) => `Private hibachi chef at a McLean VA estate event` },
  'fairfax':        { src: '/pics/hibachi-catering-3.jpg',   alt: (city) => `Private hibachi chef at a Fairfax VA event` },
  'arlington':      { src: '/pics/hibachi-pic-4.jpg',     alt: (city) => `Private hibachi chef at an Arlington VA event` },
  ...
  'richmond':         { src: '/pics/hibachi-catering.jpg',    alt: (city) => `Private hibachi chef at a Richmond VA backyard event` },
  ...
  'virginia-beach':   { src: '/pics/backyard-hibachi.jpg',alt: (city) => `Private hibachi chef at a Virginia Beach VA event` },
  ...
  // Batch 4 — Mix
  'charlottesville':  { src: '/pics/hibachi-catering-3.jpg', alt: (city) => `Private hibachi chef at a Charlottesville VA estate` },
  ...
  'roanoke':          { src: '/pics/hibachi-catering.jpg',      alt: (city) => `Private hibachi chef at a Roanoke VA outdoor event` },
  'blacksburg':       { src: '/pics/backyard-hibachi-3.jpg',    alt: (city) => `Private hibachi chef at a Blacksburg VA event` },
  'herndon':          { src: '/pics/hibachi-catering-3.jpg',      alt: (city) => `Private hibachi chef at a Herndon VA event` },
  'leesburg':         { src: '/pics/hibachi-catering.jpg',     alt: (city) => `Private hibachi chef at a Leesburg VA estate event` },
...
// ── City-specific closings (VA city-specific 224–248) ─────────────────────────
...
// ── City-specific intros (VA city-specific 224–248) ────────────────────────────
...
const VA_NEARBY_MAJOR = [
  ['McLean', 'Arlington', 'Alexandria', 'Reston', 'Fairfax'],                         // v=0 NoVA Luxury
  ['McLean', 'Arlington', 'Alexandria', 'Reston', 'Herndon'],                         // v=1 NoVA Urban/Corporate
  ['Richmond', 'Short Pump', 'Midlothian', 'Henrico', 'Fredericksburg'],              // v=2 Richmond Metro
  ['Virginia Beach', 'Chesapeake', 'Norfolk', 'Newport News', 'Hampton'],             // v=3 Hampton Roads
  ['Charlottesville', 'Williamsburg', 'Winchester', 'Richmond', 'Fredericksburg'],    // v=4 Wine Country & Historic
  ['Roanoke', 'Blacksburg', 'Charlottesville', 'Richmond', 'Williamsburg'],           // v=5 Blue Ridge & Western
]
...
export function getVirginiaCityData(citySlug, cityName) {
  ...
  return {
    ...
    nearbyMajorCities: VA_NEARBY_MAJOR[v],
    ...
    // INTRO_VARIANTS: 218–223 = VA generic, 224–248 = VA city-specific
    uniqueIntroVariant:  (major?.profileIdx != null) ? 224 + major.profileIdx : 218 + v,
    uniqueWhyUsVariant:  v % 5,
    // CLOSING_VARIANTS: 218–223 = VA generic, 224–248 = VA city-specific
