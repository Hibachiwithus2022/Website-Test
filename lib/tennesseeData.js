...
const TN_NEARBY_MAJOR = [
  ['Nashville', 'Brentwood', 'Franklin', 'Nolensville', 'Spring Hill'], // v=0 Nashville Core
  ['Franklin', 'Nolensville', 'Nashville', 'Brentwood', 'Spring Hill'], // v=1 Nashville South
  ['Nashville', 'Brentwood', 'Franklin', 'Nolensville', 'Spring Hill'], // v=2 placeholder — update Batch 2
  ['Nashville', 'Brentwood', 'Franklin', 'Nolensville', 'Spring Hill'], // v=3 placeholder — update Batch 3
  ['Nashville', 'Brentwood', 'Franklin', 'Nolensville', 'Spring Hill'], // v=4 placeholder — update Batch 3
  ['Nashville', 'Brentwood', 'Franklin', 'Nolensville', 'Spring Hill'], // v=5 placeholder — update Batch 4
]
