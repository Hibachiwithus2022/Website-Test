...
const TN_TESTIMONIALS = [
  // Theme 0 — Nashville Core
  [
    { text: `"Bachelorette weekend in Nashville — 18 of us in a rental house in East Nashville. The hibachi chef arrived Friday night and completely changed the whole trip. Fire tricks, flying shrimp, the full performance on the deck. We've done Nashville bachelorette weekends before. Nothing has ever been the highlight of the trip the way that dinner was."`, name: `Megan R.`, city: `Nashville, TN`, event: `Bachelorette Weekend`, initials: `MR` },
    { text: `"Anniversary dinner at our Brentwood estate. Twenty-two guests on the back patio. Chef arrived on time, set up completely independently, and exceeded every expectation. The filet mignon and lobster combination was exceptional. Three of our guests requested the contact before the chef finished cleanup."`, name: `David & Lisa M.`, city: `Brentwood, TN`, event: `Anniversary Dinner`, initials: `DM` },
    { text: `"Client entertainment event for our healthcare group at our Franklin property — 28 guests, chef was genuinely professional from arrival through cleanup. Every client commented on it afterward. This is now our standard format for quarterly client dinners."`, name: `James T.`, city: `Franklin, TN`, event: `Corporate Client Event`, initials: `JT` },
  ],
  // Theme 1 — Nashville South
  [
    { text: `"Graduation party for our son in Nolensville — 48 guests in our backyard. Chef had everyone gathered from the first flame. His entire friend group plus our extended family from Memphis all cheering at the same grill. We're already planning our daughter's event for next May."`, name: `Mark & Jennifer H.`, city: `Nolensville, TN`, event: `Graduation Party`, initials: `MH` },
    { text: `"Birthday dinner in our Spring Hill backyard — 34 guests on a June evening. The chef was engaging, professional, and turned what would have been a regular dinner party into a full performance. My guests have not stopped asking me for the contact."`, name: `Sandra W.`, city: `Spring Hill, TN`, event: `Birthday Dinner`, initials: `SW` },
    { text: `"Neighborhood Fourth of July in our Westhaven community — 42 guests, dual stations, chef ran the whole crowd for almost two hours. Best neighborhood gathering we've ever hosted. We're already organizing next summer."`, name: `The Bradford Family`, city: `Franklin, TN`, event: `Neighborhood Gathering`, initials: `BF` },
  ],
  // Theme 2 — Nashville East & North
  [
    { text: `"MTSU graduation party — 55 guests at our Murfreesboro home. Dual chef stations had everyone eating at the same time, grandparents from both coasts, his whole friend group from the program. The whole evening was exactly what we wanted a graduation party to feel like."`, name: `The Wallace Family`, city: `Murfreesboro, TN`, event: `MTSU Graduation Party`, initials: `WF` },
    { text: `"Birthday dinner at our Old Hickory Lake home in Hendersonville — 24 guests on the dock-side deck. Perfect summer evening, chef set up on the deck without any input from us, and the performance ran the whole time we were out there. Everyone is still talking about it."`, name: `Robert & Carol T.`, city: `Hendersonville, TN`, event: `Birthday on the Lake`, initials: `RT` },
    { text: `"Anniversary dinner with family at our Mt. Juliet home — 20 guests, chef exceeded every expectation. Our parents had never seen live hibachi cooking before and were completely captivated. The whole evening was worth every penny."`, name: `Michael & Sarah K.`, city: `Mt. Juliet, TN`, event: `Anniversary Celebration`, initials: `MK` },
  ],
  // Theme 3 — Smoky Mountains
  [
    { text: `"Bachelorette weekend in Gatlinburg — 14 of us in a cabin in Chalet Village. Chef came Saturday night, set up on the deck, and performed for all of us. The mountains in the background, the fire, the whole group at the grill together. I've been to dozens of bachelorette weekends. Nobody has ever done anything like this."`, name: `Ashley M.`, city: `Gatlinburg, TN`, event: `Bachelorette Weekend`, initials: `AM` },
    { text: `"Family reunion at a Pigeon Forge cabin — 38 people, dual stations, every generation from the grandparents down to the grandkids all gathered around the same grill. The chef was patient, funny, and made the whole night. We've already made this our annual tradition."`, name: `The Henderson Family`, city: `Pigeon Forge, TN`, event: `Family Reunion`, initials: `HF` },
    { text: `"Birthday weekend in Sevierville for my husband — 22 guests at a vacation rental near the Parkway. Chef arrived exactly on time, set up on the deck, and the whole group was completely engaged from the first minute to the last. We couldn't have planned a better evening."`, name: `Rachel L.`, city: `Sevierville, TN`, event: `Birthday Weekend`, initials: `RL` },
  ],
  // Theme 4 — East Tennessee
  [
    { text: `"UT graduation party for our daughter — 44 guests at our Sequoyah Hills home. Extended family flew in from four states. Chef set up on the back patio, ran dual stations for the whole group, and had everyone engaged for two hours. Our family has done every kind of graduation celebration. This was the best."`, name: `The Morrison Family`, city: `Knoxville, TN`, event: `UT Graduation Party`, initials: `MF` },
    { text: `"Retirement dinner at our Farragut home — 30 guests on the back patio. Chef arrived perfectly on time, performed exclusively for our group, and left the property immaculate. Filet mignon and lobster tail were exceptional. Several guests asked for the contact before the chef finished."`, name: `Robert & Patricia C.`, city: `Farragut, TN`, event: `Retirement Celebration`, initials: `RC` },
    { text: `"Birthday dinner in Maryville — 26 guests, backyard setup, chef was completely professional and had the whole group captivated. My husband kept saying he'd never had a birthday dinner that became an actual event before. The whole experience was unforgettable."`, name: `Jennifer H.`, city: `Maryville, TN`, event: `Birthday Dinner`, initials: `JH` },
  ],
  // Theme 5 — West & South Tennessee
  [
    { text: `"Team dinner for our Memphis distribution group — 32 guests at our company property in East Memphis. Chef handled everything, set up independently, and performed for the whole team. Our people have been talking about it for three weeks. We're booking again for Q4."`, name: `Marcus T.`, city: `Memphis, TN`, event: `Corporate Team Dinner`, initials: `MT` },
    { text: `"Graduation party for our son in Germantown — 46 guests in our backyard. Dual stations had the whole family eating together. The grandparents who flew in from Atlanta, his college friends, our neighbors — all gathered around the same grill at the same time. Already planning his sister's event."`, name: `The Davis Family`, city: `Germantown, TN`, event: `Graduation Party`, initials: `DF` },
    { text: `"Dinner party at our Lookout Mountain home — 22 guests on the terrace. Chef set up completely independently and performed for two hours. The views, the fire, the whole evening was exactly what we hoped it would be. Our guests were still mentioning it weeks later."`, name: `William & Margaret S.`, city: `Chattanooga, TN`, event: `Dinner Party`, initials: `WS` },
  ],
]
