...
//
// INTRO_VARIANTS indices:  63–67 NY generic · 68–89 NY city-specific
// CLOSING_VARIANTS indices: 63–67 NY generic · 68–89 NY city-specific
// =============================================================================
...
const NY_HERO_SUBTITLES = [
  (city) => city === 'New York City'
    ? `Rooftop Entertaining · Corporate Dinners · Private Events · All Five Boroughs`
    : `Rooftop Entertaining · Corporate Dinners · Private Events · Serving ${city} & NYC`,
...
const NY_SECTION_VARIANTS = [
  // Theme 0 — NYC Metro
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏙️', title: 'Your Rooftop or Backyard Is the Venue', desc: `No restaurant waitlists in ${city} — your rooftop, backyard, or event space becomes the exclusive dining room for your group.` },
      { icon: '👨‍🍳', title: 'Certified Chef, Your Group Only',      desc: 'Your teppanyaki chef performs exclusively for your party — no shared dining room, no strangers, no restaurant noise.' },
      { icon: '🗽', title: 'All Five Boroughs Served',              desc: `From Manhattan to Staten Island, ${city} and every NYC borough is covered — plus Hoboken, Jersey City, and Westchester.` },
      { icon: '✨', title: 'Full Show, Zero Cleanup',                desc: 'Premium proteins cooked live on the teppan grill, fire tricks for your guests, and complete cleanup when dinner is done.' },
    ],
  ...
  // Theme 1 — Westchester / Long Island Affluent
  {
    ...
    experiencePoints:   (city) => [
      ...
      { icon: '🔥', title: 'One Chef, One Show',                  desc: 'Every guest sits at the same table with the same chef and the same performance — the shared moment is what makes hibachi unforgettable.' },
      { icon: '🎭', title: '90–120 Minutes of Live Teppanyaki',   desc: 'A certified chef performs fire tricks and cooks every course to order right in front of your guests.' },
      { icon: '🧹', title: 'Setup & Cleanup Fully Included',      desc: 'Your chef arrives with everything needed, runs the entire show, and packs out completely — nothing left for you to do.' },
    ],
  ...
  // Theme 2 — Hamptons / East End
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏖️', title: 'Your Rental Is the Venue',            desc: `The chef comes directly to your ${city} rental — no restaurant reservation needed.` },
      { icon: '🍽️', title: 'One Table, One Show',                 desc: 'All guests gather at the same outdoor table for the full live teppanyaki performance.' },
      { icon: '🔥', title: '90–120 Minutes of Fire & Flavor',      desc: 'Fire tricks, live cooking, and a full show for the whole group.' },
      { icon: '🧹', title: 'Spotless Pack-Out',                    desc: 'Full setup and complete pack-out afterward — your rental property stays spotless.' },
    ],
  ...
  // Theme 3 — Hudson Valley / Catskills / Adirondacks
  {
    ...
    experiencePoints:   (city) => [
      { icon: '🏕️', title: 'Chef Comes to Your Rental or Lake House', desc: `Private hibachi delivered directly to your ${city} vacation rental or lake house — no restaurant needed.` },
      { icon: '🥩', title: 'Premium Proteins, Full Service',           desc: 'Live fire performance with premium proteins cooked to order and complete service throughout.' },
      { icon: '👥', title: 'Groups From 8 to 60+',                     desc: 'Intimate gatherings of 8–20 or larger celebrations up to 60 — we scale to your group.' },
      { icon: '🧹', title: 'Flawless Setup & Cleanup',                 desc: 'Nothing left for you to manage — your chef handles it all from start to finish.' },
    ],
  ...
  // Theme 4 — Western NY / Capital Region
  {
    ...
    experiencePoints:   (city) => [
      { icon: '👨‍👩‍👧‍👦', title: 'Dual-Station Capacity',            desc: 'Groups of 25–60+ guests are covered with dual hibachi stations running at once.' },
      { icon: '🔥', title: 'Every Generation at the Grill',       desc: 'Kids, parents, and grandparents all gather around the same grill for the show.' },
      { icon: '🍱', title: 'Fresh Proteins, Full Performance',    desc: 'No restaurant logistics — just fresh proteins and a live show at your event.' },
      { icon: '🧹', title: 'Setup & Cleanup Included',            desc: 'Nothing for the host to do — your chef handles everything.' },
    ],
...
const NY_SUPPORT_IMAGES = {
  'new-york-city': {
    testimonial: { src: '/pics/hibachi-photo-2.jpg',      alt: (city) => `Guests at a New York City rooftop hibachi event`,       caption: 'New York City private hibachi',          trustBadge: "New York's Favorite Hibachi Experience", intro: (city) => `Manhattan and Brooklyn hosts are raising the bar on private entertaining — rooftop dinners, penthouse gatherings, and loft parties that demand something far beyond a restaurant reservation. Our certified chefs travel directly to your NYC space with the full teppanyaki setup and handle every detail, including complete cleanup. Here's what New York City hosts are saying:` },
  ...
  'brooklyn': {
    testimonial: { src: '/pics/hibachi-photo-1.jpg',      alt: (city) => `Bachelorette hibachi event in Williamsburg Brooklyn`,   caption: 'Brooklyn groups come back every year',   trustBadge: 'Five-Star Entertainment & Dining', intro: (city) => `Brooklyn's Park Slope backyards, Williamsburg rooftops, and DUMBO loft spaces have become some of our most-requested private dining venues in New York. Young families and professionals across Brooklyn choose private hibachi for birthdays, bachelorette weekends, and milestone dinners that feel truly original. See what Brooklyn hosts have discovered:` },
  ...
  'scarsdale': {
    testimonial: { src: '/pics/private-hibachi.jpg',      alt: (city) => `Graduation hibachi party in Scarsdale, NY`,             caption: 'Scarsdale graduation season',            trustBadge: 'Trusted by Local Families', intro: (city) => `Scarsdale families planning graduation dinners and milestone celebrations know that Westchester restaurants can't accommodate a crowd the way your own backyard can. Our certified chefs arrive at your Scarsdale estate with a complete teppanyaki station, premium proteins, and full cleanup — so you enjoy the evening alongside your guests. Here's why Scarsdale families book us every season:` },
  ...
  'southampton': {
    testimonial: { src: '/pics/hibachi-pic-3.jpg',        alt: (city) => `Private hibachi on a Southampton summer house patio`,   caption: 'Southampton vacation rental hibachi',    trustBadge: 'Hundreds of Private Events', intro: (city) => `Southampton summer renters and estate hosts demand an experience that matches the caliber of their surroundings — and a private hibachi chef on the back patio delivers exactly that. Our team arrives at your Southampton property fully equipped, performs the full teppanyaki show, and departs with zero trace left behind. Here's what Southampton summer hosts come back for every year:` },
  ...
  'east-hampton': {
    testimonial: { src: '/pics/hibachi-austin-home-2.jpg',alt: (city) => `Private hibachi at an East Hampton NY estate`,          caption: 'East Hampton summer dining',             trustBadge: 'Unforgettable Private Dining Experiences', intro: (city) => `East Hampton estate owners and seasonal renters have made private hibachi a signature summer tradition — an open-air teppanyaki dinner that turns any evening on the property into an event worth talking about. Our certified chefs travel to your East Hampton address with a complete setup and handle every detail from first flame to final cleanup. Here's what East Hampton hosts keep coming back for:` },
  ...
  'lake-george': {
    testimonial: { src: '/pics/hibachi-austin-home-3.jpg',alt: (city) => `Lake house hibachi event at Lake George, NY`,          caption: 'Lake George lake house hibachi',         trustBadge: 'Thousands of Happy Guests', intro: (city) => `Lake George vacation rentals and lake house groups have discovered that a private hibachi chef is the perfect centerpiece for a summer weekend — better than driving into town, and memorable long after the trip ends. We travel to your Lake George property with a full teppanyaki station, fresh proteins, and complete cleanup so every guest can relax. Here's why Lake George groups keep booking us:` },
  ...
  'buffalo': {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',   alt: (city) => `Graduation hibachi party in Buffalo, NY`,              caption: 'Buffalo families celebrate big',         trustBadge: 'Highly Rated by Local Hosts', intro: (city) => `Buffalo and Niagara frontier families celebrate big — graduation parties, milestone birthdays, and community gatherings that call for something more than a restaurant table. Our certified hibachi chefs travel to your Buffalo home or backyard with a full teppanyaki station, premium proteins, and handle all cleanup once the show is done. Here's what Western New York hosts are saying:` },
  ...
  'rhinebeck': {
    testimonial: { src: '/pics/traveling-hibachi.jpg',    alt: (city) => `Weekend rental hibachi dinner in Rhinebeck, NY`,       caption: 'Rhinebeck weekend rental hibachi',       trustBadge: '5.0 Average Rating', intro: (city) => `Rhinebeck weekend renters and Hudson Valley hosts have made private hibachi the highlight of getaway trips — a live teppanyaki dinner on the patio that beats every restaurant reservation in the area. Our chefs travel to your Rhinebeck property fully equipped and leave nothing behind except the memories. Here's why Hudson Valley hosts keep choosing us:` },
    cta:         { src: '/pics/hibachi-raleigh.jpg',      alt: (city) => `Private hibachi chef in Rhinebeck, NY`,                caption: 'The Rhinebeck weekend dinner' },
  },
  'woodstock': {
    testimonial: { src: '/pics/hibachi-austin-3.jpg',     alt: (city) => `Bachelorette hibachi weekend in Woodstock, NY`,        caption: 'Woodstock bachelorette weekends',        trustBadge: 'Trusted by Local Families', intro: (city) => `Woodstock bachelorette weekends, Catskill getaways, and Hudson Valley reunion groups have discovered that a private hibachi chef turns an ordinary rental evening into a full celebration. We travel to your Woodstock cottage or property with everything needed for the teppanyaki experience, and we handle all cleanup so your group never misses a moment. Here's what Woodstock weekend groups are saying:` },
    cta:         { src: '/pics/mobile-hibachi.jpg',        alt: (city) => `Private hibachi chef in Woodstock, NY`,                caption: 'The Woodstock weekend night' },
  },
  'montauk': {
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg',alt: (city) => `Girls trip hibachi at a Montauk house`,               caption: 'Montauk groups always come back',        trustBadge: 'Hundreds of Private Events', intro: (city) => `Montauk girls trips, summer house groups, and East End renters have turned private hibachi into the signature dinner of their season — a full teppanyaki performance on the deck that no restaurant in the area can match. Our certified chefs travel to your Montauk rental with premium proteins, a complete setup, and full cleanup included. See what Montauk groups keep coming back for:` },
    cta:         { src: '/pics/hibachi-miami.jpg',         alt: (city) => `Private hibachi chef in Montauk, NY`,                  caption: 'The Montauk dinner of the summer' },
  },
  'white-plains': {
    testimonial: { src: '/pics/hibachi-catering.jpg',     alt: (city) => `Corporate hibachi event in White Plains, NY`,          caption: 'White Plains corporate events',          trustBadge: 'Five-Star Entertainment & Dining', intro: (city) => `White Plains and greater Westchester hosts — from corporate teams in Tarrytown to suburban families near Yonkers — choose private hibachi when they want an event that runs flawlessly and impresses every guest at the table. Our certified chefs bring the full teppanyaki experience to your space, manage every detail, and leave the property spotless. Here's what Westchester hosts are saying:` },
  ...
  'albany': {
    testimonial: { src: '/pics/hibachi-austin-home.jpg',  alt: (city) => `Corporate hibachi event in Albany, NY`,                caption: 'Albany corporate and family events',     trustBadge: 'Thousands of Happy Guests', intro: (city) => `Albany's capital region community — UAlbany families, government professionals, and longtime residents — expects private events to run with precision and leave a lasting impression on every guest. Our certified hibachi chefs travel to your Albany home or venue with a complete teppanyaki station and handle everything from setup to final cleanup. Here's what Albany hosts have found:` },
    cta:         { src: '/pics/hibachi-shot-2.jpg',        alt: (city) => `Private hibachi chef in Albany, NY`,                   caption: 'The Albany event everyone talks about' },
  },
  'smithtown': {
    testimonial: { src: '/pics/hibachi-shot-1.jpg',       alt: (city) => `Backyard hibachi party in Smithtown, NY`,              caption: 'Smithtown backyard hibachi',             trustBadge: 'Highly Rated by Local Hosts', intro: (city) => `Smithtown and Suffolk County families hosting graduation parties, milestone birthdays, and summer backyard events have found that a private hibachi chef delivers the kind of experience no restaurant on Long Island can replicate. Our team arrives fully equipped, performs the complete teppanyaki show, and handles all cleanup so you can stay present with your guests from start to finish. Here's what Smithtown families are saying:` },
  ...
  'bronxville': {
    testimonial: { src: '/pics/hibachi-pic-4.jpg',        alt: (city) => `Private hibachi dinner party in Bronxville, NY`,       caption: 'Bronxville dinner parties done right',   trustBadge: 'Unforgettable Private Dining Experiences', intro: (city) => `Bronxville's intimate village setting and discerning hosts call for private entertaining that feels curated and effortless — and a teppanyaki chef at your home delivers exactly that standard. Our certified chefs travel to your Bronxville property with the full setup, premium ingredients, and complete cleanup included in every booking. Here's what Bronxville hosts have found when they stop settling for restaurants:` },
  ...
  'lake-placid': {
    testimonial: { src: '/pics/hibachi-home-austin.jpg',  alt: (city) => `Lake Placid vacation rental hibachi event`,            caption: 'Lake Placid vacation rental hibachi',    trustBadge: '5.0 Average Rating', intro: (city) => `Lake Placid vacation groups and Adirondack retreat guests have discovered that a private hibachi chef transforms a mountain getaway into a truly unforgettable experience — no driving into town, no waiting for a table, just a live teppanyaki performance under open sky. Our certified chefs travel to your Lake Placid rental fully equipped and leave with complete cleanup handled. See what Lake Placid hosts keep coming back for:` },
...
const NY_SUPPORT_FALLBACKS = [
  // Theme 0 — NYC Metro
  {
    testimonial: { src: '/pics/hibachi-pic-2.jpg',        alt: (city) => `Private hibachi event in ${city}, NY`,    caption: 'New York City hosts agree',       trustBadge: "New York's Favorite Hibachi Experience", intro: (city) => `${city} hosts entertaining at rooftops, lofts, and outdoor spaces across the five boroughs have raised the bar on private dining — choosing a certified hibachi chef over crowded Manhattan restaurants every time. Our team travels directly to your ${city} location with the full teppanyaki setup, premium proteins, and complete cleanup so every guest gets the star treatment. Here's what ${city} hosts are saying:` },
    cta:         { src: '/pics/hibachi-catering-3.jpg',   alt: (city) => `Private hibachi chef in ${city}, NY`,     caption: 'Your ${city} evening starts here' },
  },
  // Theme 1 — Westchester / Long Island
  {
    testimonial: { src: '/pics/hibachi-dallas-home.jpg',  alt: (city) => `Backyard hibachi event in ${city}, NY`,  caption: 'Westchester & LI hosts agree',    trustBadge: 'Trusted by Local Families', intro: (city) => `${city} families and celebration hosts across Westchester and Long Island choose private hibachi for graduation dinners, milestone birthdays, and backyard events that go far beyond anything a local restaurant can offer. Our certified chefs travel to your ${city} home with the full teppanyaki setup and complete cleanup — no logistics required on your end. Here's what ${city} hosts are saying:` },
    cta:         { src: '/pics/backyard-hibachi-2.jpg',   alt: (city) => `Private hibachi chef in ${city}, NY`,     caption: 'Your ${city} backyard, upgraded' },
  },
  // Theme 2 — Hamptons / East End
  {
    testimonial: { src: '/pics/hibachi-virginia-beach.jpg',alt: (city) => `Hamptons hibachi at ${city}, NY`,        caption: 'Hamptons hosts agree',            trustBadge: 'Unforgettable Private Dining Experiences', intro: (city) => `${city} summer renters and estate owners across the East End have made private hibachi the dining highlight of their season — a live teppanyaki performance on the patio that outshines every Hamptons restaurant experience. Our certified chefs arrive at your ${city} property fully equipped and leave without a trace. Here's why ${city} summer hosts keep coming back:` },
  ...
  {
    testimonial: { src: '/pics/hibachi-colorado.jpg',     alt: (city) => `Vacation rental hibachi in ${city}, NY`, caption: 'Hudson Valley hosts agree',       trustBadge: '5.0 Average Rating', intro: (city) => `${city} weekend rental groups and Hudson Valley getaway hosts have found that a private hibachi chef is the single best upgrade to any Catskill or Adirondack trip — a full live-fire teppanyaki experience right at your rental that no local restaurant can match. We travel to your ${city} property fully equipped and depart with complete cleanup done. See what ${city} weekend hosts have discovered:` },
    cta:         { src: '/pics/traveling-hibachi.jpg',    alt: (city) => `Private hibachi chef in ${city}, NY`,     caption: 'The ${city} weekend dinner' },
  },
  // Theme 4 — Western NY / Capital Region
  {
    testimonial: { src: '/pics/hibachi-catering-2.jpg',   alt: (city) => `Family hibachi gathering in ${city}, NY`, caption: 'Western NY families celebrate',   trustBadge: 'Thousands of Happy Guests', intro: (city) => `${city} families across Western New York and the Capital Region celebrate milestones in a big way — graduation parties, reunion dinners, and community gatherings that deserve more than a restaurant table for a crowd. Our certified hibachi chefs travel to your ${city} backyard or home with a complete teppanyaki station, fresh proteins, and full cleanup included. Here's what ${city} families are saying:` },
...
export const NY_CITY_CLOSINGS = [
  ...
  // 83 — Great Neck (profileIdx 15)
  {
    headline: (city) => `Great Neck's Best Backyard Dinner — Book It`,
    sub:      (city) => `A certified hibachi chef at your Great Neck property. Full setup, premium proteins, complete cleanup. From $60/adult.`,
    urgency:  `Long Island weekends book 2–4 weeks ahead. Secure your Great Neck date now.`,
  },
  // 84 — Garden City (profileIdx 16)
  {
    headline: (city) => `Garden City Corporate & Private Hibachi — Book It`,
    sub:      (city) => `A certified teppanyaki chef for your Garden City event or gathering. Full setup, all fresh ingredients, complete cleanup. From $60/adult.`,
    urgency:  `Garden City and Nassau County dates fill 2–3 weeks out. Reserve yours now.`,
  },
  // 85 — New Paltz (profileIdx 17)
  {
    headline: (city) => `Your New Paltz Weekend Just Got Its Best Night`,
    sub:      (city) => `A certified hibachi chef travels to your New Paltz rental. Full setup, live performance, complete cleanup. From $60/adult.`,
    urgency:  `Hudson Valley peak season books fast. Confirm your New Paltz date now.`,
  },
  // 86 — Kingston (profileIdx 18)
  {
    headline: (city) => `Kingston Hibachi Catering — Reserve Your Date`,
    sub:      (city) => `A certified teppanyaki chef at your Kingston property or event. Full setup, fresh proteins, complete cleanup. From $60/adult.`,
    urgency:  `Kingston and Hudson Valley weekends book 2–4 weeks ahead. Secure your date now.`,
  },
  // 87 — Saratoga Springs (profileIdx 19)
  {
    headline: (city) => `The Saratoga Springs Dinner Your Group Deserves`,
    sub:      (city) => `A certified hibachi chef comes to your Saratoga Springs property. Full setup, live performance, complete cleanup. From $60/adult.`,
    urgency:  `Saratoga racing season and summer weekends fill fast. Reserve your date now.`,
  },
  // 88 — Huntington (profileIdx 20)
  {
    headline: (city) => `Huntington's Best Backyard Hibachi — Book Yours`,
    sub:      (city) => `A certified hibachi chef at your Huntington home or outdoor space. All proteins, full performance, complete cleanup. From $60/adult.`,
    urgency:  `Huntington and Suffolk County weekends book 2–3 weeks ahead. Confirm your date now.`,
  },
  // 89 — Poughkeepsie (profileIdx 21)
  {
    headline: (city) => `Private Hibachi Chef in Poughkeepsie — Book It`,
    sub:      (city) => `A certified teppanyaki chef at your Poughkeepsie property. Full setup, premium proteins, complete cleanup. From $60/adult.`,
    urgency:  `Hudson Valley events book 2–4 weeks out. Reserve your Poughkeepsie date now.`,
  },
]
...
export const NY_CITY_INTROS = [
  ...
  // 83 — Great Neck (profileIdx 15)
  {
    headline: () => `Backyard Hibachi in Great Neck`,
    opening:  () =>
      `Great Neck is where Long Island's most discerning hosts entertain — and a private backyard hibachi brings exactly the kind of evening the neighborhood expects. Whether it's a graduation party for the extended family, a milestone birthday dinner, or an anniversary celebration on the back patio, a certified teppanyaki chef comes to your Great Neck property with the full setup and a live-fire performance that makes the occasion.`,
    middle:   () =>
      `Your chef arrives with everything: teppan grill, propane, all fresh proteins, fried rice, vegetables, sauces, plates, and chopsticks. The performance runs 90–120 minutes from first flame to final plate — fire tricks, flying shrimp, and every dish cooked to order at the grill in front of your guests. Full cleanup when dinner is done. Your Great Neck property is spotless when the chef leaves.`,
    closing:  () =>
      `Great Neck weekend evenings book 2–4 weeks ahead. Graduation season (May–June) is our fastest-filling window. Serving Great Neck and all of Nassau County including Manhasset, Port Washington, Roslyn, and surrounding communities. Starting at $60/adult, $30/child, $600 event minimum.`,
  },
  // 84 — Garden City (profileIdx 16)
  {
    headline: () => `Hibachi Catering in Garden City`,
    opening:  () =>
      `Garden City sets the tone for Long Island private entertaining — the graduation parties here are legendary, the corporate events draw the Nassau County business community, and the standard for any catered gathering runs high. Private hibachi catering in Garden City brings a certified teppanyaki chef to your property or outdoor event space with the full setup, all proteins, and a live cooking performance that turns any gathering into the kind of evening people request at the next one.`,
    middle:   () =>
      `Your chef arrives with everything: teppan grill, propane, all fresh proteins, fried rice, vegetables, house-made sauces, plates, and chopsticks. The performance runs 90–120 minutes from first flame to final plate — fire tricks, flying shrimp, and every plate cooked to order in front of your guests. For Garden City events over 25 guests, we deploy two chef stations. Full cleanup when dinner is done.`,
    closing:  () =>
      `Garden City events and graduation season bookings fill 2–4 weeks ahead. Serving Garden City and all of Nassau County — Hempstead, Mineola, Uniondale, Rockville Centre, and surrounding communities. Starting at $60/adult, $30/child, $600 event minimum. Most quotes returned same day.`,
  },
  // 85 — New Paltz (profileIdx 17)
  {
    headline: () => `Mobile Hibachi in New Paltz`,
    opening:  () =>
      `New Paltz brings the most intentional weekend travelers in the Hudson Valley — rock climbers and Catskill hikers, bachelorette groups and birthday weekends, the friend crews who rented the farmhouse for a long weekend and want the best dinner of the trip to happen at the house. Mobile hibachi in New Paltz brings a certified teppanyaki chef to your rental property, your backyard, or your outdoor space — the full setup, the live performance, and complete cleanup before the chef drives home.`,
    middle:   () =>
      `Your chef arrives with everything: teppan grill, propane, all fresh proteins, rice, vegetables, sauces, plates, and chopsticks. Setup takes 20 minutes on your deck, patio, or yard area. The performance runs 90–120 minutes from first flame to final plate — fire tricks, flying shrimp, and every dish cooked to order at the teppan in front of your group. Full cleanup when dinner is done.`,
    closing:  () =>
      `New Paltz weekend events book 3–4 weeks ahead in peak season. Bachelorette weekends, birthday dinners, and vacation rental group events are our most common New Paltz bookings. Serving New Paltz and all of Ulster County — Woodstock, Kingston, Rhinebeck, Saugerties, and surrounding communities. Starting at $60/adult, $30/child, $600 event minimum.`,
  },
  // 86 — Kingston (profileIdx 18)
  {
    headline: () => `Hibachi Catering in Kingston`,
    opening:  () =>
      `Kingston is the Hudson Valley's original city — and the events that happen here carry that energy. Corporate team dinners for the region's growing creative and professional community, private gatherings at historic properties, milestone celebrations for families who have called Kingston home for generations. Private hibachi catering in Kingston brings a certified teppanyaki chef to your property or outdoor venue with the full setup and a live cooking performance that elevates any occasion.`,
    middle:   () =>
      `Your chef arrives with everything: teppan grill, propane, all fresh proteins, fried rice, vegetables, house-made sauces, plates, and chopsticks. The show runs 90–120 minutes from first flame to final plate — fire tricks, flying shrimp, and every plate cooked to order in front of your guests. For Kingston events over 25 guests, we deploy dual chef stations. Full cleanup when dinner is done.`,
    closing:  () =>
      `Kingston weekend events and catering bookings fill 2–3 weeks out. Serving Kingston and all of Ulster County — Woodstock, New Paltz, Rhinebeck, Saugerties, Catskill, and surrounding communities. Starting at $60/adult, $30/child, $600 event minimum. Most quotes confirmed same day.`,
  },
  // 87 — Saratoga Springs (profileIdx 19)
  {
    headline: () => `Mobile Hibachi in Saratoga Springs`,
    opening:  () =>
      `Saratoga Springs is where New York State comes to celebrate — the racing season draws the most enthusiastic crowds in the region, and the rest of the calendar fills with milestone birthdays, bachelorette weekends, and destination events that bring people in from across the state. Mobile hibachi in Saratoga Springs brings a certified teppanyaki chef to your property, rental home, or outdoor venue with the full setup and a live-fire performance that matches the energy of a Saratoga weekend.`,
    middle:   () =>
      `Your chef arrives with everything: teppan grill, propane, all fresh proteins, rice, vegetables, sauces, plates, and chopsticks. Setup takes 20 minutes on your deck, patio, or yard. The show runs 90–120 minutes from first flame to final plate — fire tricks, flying shrimp, and every dish cooked to order at the grill in front of your group. Full cleanup when dinner is done.`,
    closing:  () =>
      `Saratoga Springs racing season and peak summer weekends fill 4–6 weeks ahead. Bachelorette weekends, birthday dinners, and group vacation events are our most common Saratoga bookings. Serving Saratoga Springs and surrounding areas — Clifton Park, Ballston Spa, Glens Falls, Lake George, and Albany. Starting at $60/adult, $30/child, $600 event minimum.`,
  },
  // 88 — Huntington (profileIdx 20)
  {
    headline: () => `Backyard Hibachi in Huntington`,
    opening:  () =>
      `Huntington is where Long Island's North Shore community does its best entertaining — graduation parties that fill the back patio, milestone anniversary dinners, summer neighborhood gatherings where the whole block shows up. Backyard hibachi in Huntington brings a certified teppanyaki chef to your property with the full setup and a live-fire cooking performance that upgrades any occasion from a dinner party to the event everyone talks about going into the following season.`,
    middle:   () =>
      `Your chef arrives with everything: teppan grill, propane, all fresh proteins, fried rice, vegetables, house-made sauces, plates, and chopsticks. The performance runs 90–120 minutes from first flame to final plate — fire tricks, flying shrimp, and every dish cooked to order at the teppan in front of your guests. For large Huntington gatherings, dual-station capacity handles groups of 25–60+. Full cleanup when dinner is done.`,
    closing:  () =>
      `Huntington weekend evenings book 2–3 weeks ahead. Graduation season (May–June) fills fastest — book 4–5 weeks out for Saturday events. Serving Huntington and all of Suffolk County's North Shore — Northport, Cold Spring Harbor, Oyster Bay, Smithtown, and surrounding communities. Starting at $60/adult, $30/child, $600 event minimum.`,
  },
  // 89 — Poughkeepsie (profileIdx 21)
  {
    headline: () => `Private Hibachi Chef in Poughkeepsie`,
    opening:  () =>
      `Poughkeepsie anchors the mid-Hudson Valley — and the gatherings that happen here reflect the energy of a city that brings together Marist and Vassar communities, Hudson Valley professionals, and families who have been celebrating here for generations. Private hibachi at home in Poughkeepsie brings a certified teppanyaki chef to your property with the full setup and a live cooking performance that turns any occasion into the kind of evening your guests request at the next event.`,
    middle:   () =>
      `Your chef arrives with everything: teppan grill, propane, all fresh proteins, fried rice, vegetables, house-made sauces, plates, and chopsticks. The performance runs 90–120 minutes from first flame to final plate — fire tricks, flying shrimp, and every plate cooked to order at the grill in front of your guests. For larger Poughkeepsie gatherings, dual-station capacity is available for groups of 25–60+. Full cleanup when dinner is done.`,
    closing:  () =>
      `Poughkeepsie weekend events book 2–3 weeks out. Graduation season and Hudson Valley foliage weekends fill fastest. Serving Poughkeepsie and all of Dutchess County — Beacon, Hyde Park, Rhinebeck, Wappingers Falls, and surrounding communities. Starting at $60/adult, $30/child, $600 event minimum. Most quotes confirmed same day.`,
  },
]
...
const NY_MAJOR_CITIES = {
  ...
  'great-neck':       { v: 1, profileIdx: 15, nearby: ['Manhasset','Port Washington','Flushing','Garden City','Oyster Bay','Roslyn','Queens'] },
  'manhasset':        { v: 1,                 nearby: ['Great Neck','Port Washington','Garden City','Oyster Bay','Flushing','Roslyn Heights','New Hyde Park'] },
  'garden-city':      { v: 1, profileIdx: 16, nearby: ['Hempstead','Rockville Centre','Manhasset','Great Neck','Flushing','Mineola','Uniondale'] },
  'huntington':       { v: 1, profileIdx: 20, nearby: ['Smithtown','Commack','Bay Shore','Northport','Cold Spring Harbor','Oyster Bay','Babylon'] },
  ...
  'new-paltz':        { v: 3, profileIdx: 17, nearby: ['Woodstock','Kingston','Poughkeepsie','Beacon','Newburgh','Highland','Rosendale','Ellenville'] },
  'kingston':         { v: 3, profileIdx: 18, nearby: ['Woodstock','New Paltz','Rhinebeck','Poughkeepsie','Catskill','Saugerties','Red Hook'] },
  'woodstock':        { v: 3, profileIdx: 8,  nearby: ['Kingston','New Paltz','Rhinebeck','Catskill','Phoenicia','Saugerties','Hunter','Windham'] },
  'poughkeepsie':     { v: 3, profileIdx: 21, nearby: ['Rhinebeck','Kingston','Newburgh','New Paltz','Beacon','Hyde Park','Highland'] },
  ...
  'saratoga-springs': { v: 3, profileIdx: 19, nearby: ['Albany','Lake George','Troy','Clifton Park','Glens Falls','Ballston Spa'] },
...
// Maps profileIdx → the prefix text displayed on line 1 of the hero H1
const NY_PROFILE_H1_PREFIXES = [
  'Private Hibachi Chef in', // 0  — New York City
  'Hibachi Catering in',     // 1  — Brooklyn
  'Private Hibachi Chef in', // 2  — Scarsdale
  'Private Hibachi Chef in', // 3  — Southampton
  'Private Hibachi Chef in', // 4  — East Hampton
  'Mobile Hibachi in',       // 5  — Lake George
  'Hibachi at Home in',      // 6  — Buffalo
  'Hibachi at Home in',      // 7  — Rhinebeck
  'Mobile Hibachi in',       // 8  — Woodstock
  'Mobile Hibachi in',       // 9  — Montauk
  'Hibachi Catering in',     // 10 — White Plains
  'Hibachi Catering in',     // 11 — Albany
  'Backyard Hibachi in',     // 12 — Smithtown
  'Private Hibachi Chef in', // 13 — Bronxville
  'Mobile Hibachi in',       // 14 — Lake Placid
  'Backyard Hibachi in',     // 15 — Great Neck
  'Hibachi Catering in',     // 16 — Garden City
  'Mobile Hibachi in',       // 17 — New Paltz
  'Hibachi Catering in',     // 18 — Kingston
  'Mobile Hibachi in',       // 19 — Saratoga Springs
  'Backyard Hibachi in',     // 20 — Huntington
  'Private Hibachi Chef in', // 21 — Poughkeepsie
]
// Generic theme H1 prefixes (for cities without a profileIdx)
const NY_THEME_H1_PREFIXES = [
  'Hibachi at Home in',      // v=0 NYC Metro generic
  'Hibachi at Home in',      // v=1 Westchester/LI generic
  'Private Hibachi Chef in', // v=2 Hamptons generic
  'Hibachi at Home in',      // v=3 Hudson Valley generic
  'Hibachi at Home in',      // v=4 Western NY generic
]
...
export function getNyCityData(citySlug, cityName) {
  ...
  return {
    ...
    // INTRO_VARIANTS: 63–67 = NY generic, 68–89 = NY city-specific
    uniqueIntroVariant:  (major?.profileIdx != null) ? 68 + major.profileIdx : 63 + v,
    uniqueWhyUsVariant:  v,
    // CLOSING_VARIANTS: 63–67 = NY generic, 68–89 = NY city-specific
    ...
    heroH1Prefix: major?.profileIdx != null
      ? NY_PROFILE_H1_PREFIXES[major.profileIdx]
      : NY_THEME_H1_PREFIXES[v],
  }
}
