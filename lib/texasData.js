...
const TEXAS_CITY_IMAGE_MAP = {
  ...
  dallas:           { src: '/pics/hibachi-dallas.jpg',        alt: (city) => `Private hibachi chef experience in ${city}, Texas` },
...
const TEXAS_SUPPORT_IMAGES = {
  dallas: {
    testimonial: {
      ...
      alt:     (city) => `Corporate hibachi dinner at an upscale ${city} event with live chef entertainment`,
      caption: null,
