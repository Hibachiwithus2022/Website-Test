...
const TEXAS_SUPPORT_IMAGES = {
  dallas: {
    testimonial: {
      ...
      caption: null,
      intro:   (city) => `Trusted by executives, hosts, event planners, birthday hosts, corporate teams, and families across ${city}–Fort Worth. From intimate backyard dinners to large celebrations, our guests consistently praise the food, entertainment, and professionalism of our chefs.`,
    },
    cta: {
...
const TEXAS_SUPPORT_FALLBACKS = [
  {
    testimonial: { src: '/pics/hibachi-pic-3.jpg',       alt: (city) => `Live hibachi chef entertaining guests at a private ${city} event`,   caption: null },
    cta:         { src: '/pics/traveling-hibachi.jpg',    alt: (city) => `Traveling hibachi chef arriving for a ${city} backyard party`,        caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-pic-4.jpg',       alt: (city) => `Hibachi chef cooking teppanyaki at a ${city} home gathering`,         caption: null },
    cta:         { src: '/pics/hibachi-to-you.jpg',      alt: (city) => `Hibachi to your door — private chef event in ${city}, Texas`,         caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-pic-32.jpg',      alt: (city) => `Private teppanyaki event at a ${city} residence`,                     caption: null },
    cta:         { src: '/pics/backyard-hibachi-2.jpg',  alt: (city) => `Backyard hibachi setup with full grill in ${city}`,                   caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-pic-2.jpg',       alt: (city) => `Hibachi chef at a backyard party in ${city}, Texas`,                  caption: null },
    cta:         { src: '/pics/hibachi-austin-3.jpg',    alt: (city) => `Private chef hibachi experience in ${city}`,                          caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-home-austin.jpg', alt: (city) => `Private hibachi chef at a ${city} home event`,                        caption: null },
