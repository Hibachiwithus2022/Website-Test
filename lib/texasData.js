...
export const TEXAS_FAQ_SETS = [
  ...
  (city) => [
    ...
    },
    {
      ...
      a: `Tables and chairs for your guests — that's it. We arrive 5–10 minutes before your scheduled event start time. The grill is set, the station is arranged, and we run a quick safety check before the show begins. We bring all ingredients, sauces, plates, chopsticks, and serving utensils, plus full cleanup when the last course is done.`,
    },
    {
...
// ── How It Works — 5 Texas-specific rotating variants ────────────────────────
// Each variant rewrites the 4-step section headline, step titles/descs, and
// footer note with a distinct tone keyed to the city's event focus.
// Selected by getTexasVariantIndex(citySlug) — same deterministic hash.
export const TEXAS_HOW_IT_WORKS = [

  // ── 0: Family celebration tone (Houston, Katy) ──────────────────────────────
  {
    headline:   (city) => `Your ${city} Hibachi Event — Four Steps to the Night Everyone Remembers`,
    footerNote: (city) => `Whether it's a ${city} quinceañera for 50 or a graduation dinner for 20, the process is the same: simple on your end, spectacular for your guests.`,
    steps: [
      {
        num:   '01',
        title: 'Request Your Date',
        desc:  'Tell us your city, event type, guest count, and preferred date. Whether it\'s a graduation party, a quinceañera, or a birthday celebration, we confirm availability and send pricing within hours.',
      },
      {
        num:   '02',
        title: 'Your Chef Gets Assigned',
        desc:  'We pair you with a certified teppanyaki chef serving your area. You\'ll receive their details plus a quick prep guide so your backyard or venue is ready when they arrive.',
      },
      {
        num:   '03',
        title: 'The Chef Arrives Fully Loaded',
        desc:  'Right on schedule, your chef shows up with a full propane grill, fresh proteins, rice, vegetables, all sauces, plates, and chopsticks. You provide the seating — we bring everything else.',
      },
      {
        num:   '04',
        title: 'Your Crowd Gets the Show',
        desc:  'Fire tricks, flying shrimp, the onion volcano — your chef performs and cooks every plate to order while the whole family watches. Full cleanup when the last course is done.',
      },
    ],
  },

  // ── 1: Corporate / efficiency tone (Dallas, Sugar Land) ────────────────────
  {
    headline:   (city) => `Book a ${city} Hibachi Chef — Confirmed Same Day`,
    footerNote: (city) => `From a ${city} corporate cookout for 80 to an intimate team dinner for 12 — the same process runs every event. Confirmed same day, executed flawlessly.`,
    steps: [
      {
        num:   '01',
        title: 'Get a Quote',
        desc:  'Submit your event date, guest count, and location. We price it out and confirm availability fast — most quotes come back the same day. No back-and-forth. No surprise fees.',
      },
      {
        num:   '02',
        title: 'Chef Confirmed',
        desc:  'A certified hibachi chef in the area gets assigned and confirmed to your event. You\'ll receive all logistics upfront plus a quick-prep checklist for your space.',
      },
      {
        num:   '03',
        title: 'Setup Is Fully Ours',
        desc:  'Your chef arrives 5–10 minutes before your scheduled start time with the complete teppanyaki setup: propane grill, proteins, vegetables, rice, sauces, and all serving ware. You supply the seating.',
      },
      {
        num:   '04',
        title: 'The Full Performance',
        desc:  'From first flame to last plate, your chef cooks to order and entertains the entire crowd. Fire tricks included. Complete cleanup the moment dinner is done — your space stays exactly as you left it.',
      },
    ],
  },

  // ── 2: Outdoor / casual tone (Austin, The Woodlands) ───────────────────────
  {
    headline:   (city) => `From Quote to Your ${city} Backyard — Here's How It Works`,
    footerNote: (city) => `Planning a pool-deck party in ${city} or a covered-patio dinner in the suburbs? Same process, same standard — just tell us your date and we handle everything from there.`,
    steps: [
      {
        num:   '01',
        title: 'Pick a Date and Send It Over',
        desc:  'Drop us your preferred date, your zip code, and how many guests you\'re feeding. We get back to you fast — usually within a few hours — with availability and a full quote.',
      },
      {
        num:   '02',
        title: 'We Lock In Your Chef',
        desc:  'A certified teppanyaki chef in your area gets assigned to the event. You\'ll get their info and a pre-event note outlining exactly what to have ready when they show up.',
      },
      {
        num:   '03',
        title: 'The Grill Comes to You',
        desc:  'Your chef shows up 5–10 minutes before your scheduled start time with a full propane grill, all proteins, sauces, rice, vegetables, plates, and utensils. You set up chairs — we handle everything at the cooking station.',
      },
      {
        num:   '04',
        title: 'Dinner Is the Experience',
        desc:  'Fire tricks, knife work, flying shrimp — your chef performs the whole evening while every plate gets cooked fresh at the grill. Spotless cleanup when the last guest is served.',
      },
    ],
  },

  // ── 3: Multi-generational / family tone (San Antonio) ──────────────────────
  {
    headline:   (city) => `Your ${city} Family Event — Four Simple Steps`,
    footerNote: (city) => `Whether you\'re feeding 15 or 60 at your ${city} family event — one station, two, or more — the process is the same. Easy on you. Unforgettable for everyone at the table.`,
    steps: [
      {
        num:   '01',
        title: 'Tell Us About Your Event',
        desc:  'Share your event date, location, and guest count. Big family gatherings, multi-generational reunions, milestone birthdays — we size the chef setup correctly from your very first message.',
      },
      {
        num:   '02',
        title: 'Meet Your Hibachi Chef',
        desc:  'We match you with a certified chef who knows your area. You\'ll get a confirmation with their details and everything you need to prep your backyard or indoor space for the event.',
      },
      {
        num:   '03',
        title: 'Everything Arrives Ready',
        desc:  'Thirty minutes before your event start, your chef arrives with a full teppan grill, fresh proteins, rice, vegetables, all sauces, plates, and chopsticks. You provide chairs and the space — that\'s it.',
      },
      {
        num:   '04',
        title: 'Three Generations, One Grill',
        desc:  'Kids get the fire tricks and flying shrimp. Adults get perfectly cooked proteins. Grandparents get front-row seats. Every plate is cooked fresh to order. Chef cleans up when the last round is served.',
      },
    ],
  },

  // ── 4: Value / BBQ-alternative tone (Fort Worth) ───────────────────────────
  {
    headline:   (city) => `Skip the Catering Truck — Here's How Hibachi Works in ${city}`,
    footerNote: (city) => `Same backyard. Same crowd. Completely different night. Private hibachi in ${city} starts at $60/adult with a $600 event minimum. No hidden fees, no chafing dishes, no cold food.`,
    steps: [
      {
        num:   '01',
        title: 'Request Your Quote',
        desc:  'Tell us your address, event date, and headcount. We confirm pricing and availability fast — no back-and-forth, no surprise fees. What you\'re quoted is exactly what you pay.',
      },
      {
        num:   '02',
        title: 'Chef Assigned, Event Confirmed',
        desc:  'A certified hibachi chef in your area gets assigned and confirmed. You\'ll receive a prep note so you know exactly what to have ready the day of the event.',
      },
      {
        num:   '03',
        title: 'We Bring Everything — You Just Add Chairs',
        desc:  'Your chef arrives 5–10 minutes before your scheduled start time with the propane grill, proteins, vegetables, fried rice, house-made sauces, plates, and utensils. No catering truck. No chafing dishes. Just a live teppanyaki kitchen in your backyard.',
      },
      {
        num:   '04',
        title: 'The Show and the Meal — All at Once',
        desc:  'Fire tricks, knife work, flying shrimp — dinner and entertainment running simultaneously. Every plate cooked fresh at the grill. Total cleanup when the last course is done. Your yard stays exactly as you left it.',
      },
    ],
  },
]

// Maps each major Texas city to the How It Works variant that fits its tone.
// Falls back to the deterministic hash for any city not listed here.
const TEXAS_HIW_MAP = {
  'houston':       0,  // family-celebration (quinceañeras, graduation parties)
  'dallas':        1,  // corporate/efficiency (upscale, DFW)
  'austin':        2,  // outdoor/casual (Airbnb, trendy social)
  'san-antonio':   3,  // multi-gen family (cultural milestones)
  'fort-worth':    4,  // value/BBQ-alt (authentic Texas backyard)
  'katy':          0,  // family-celebration (graduation, quinceañera)
  'sugar-land':    3,  // multi-gen family (diverse, multi-cultural)
  'the-woodlands': 1,  // corporate/efficiency (premium, polished)
}

export function getTexasHowItWorks(citySlug) {
  const v = TEXAS_HIW_MAP[citySlug] ?? getTexasVariantIndex(citySlug)
  return TEXAS_HOW_IT_WORKS[v]
}
...
// Variant 0: Family-Celebration (Houston, Katy)
// Variant 1: Corporate-Upscale (Dallas, The Woodlands)
// Variant 2: Social-Trendy (Austin)
// Variant 3: Multi-Gen Family (San Antonio, Sugar Land)
// Variant 4: Authentic Texas / BBQ-Alt (Fort Worth)
// ─────────────────────────────────────────────────────────────────────────────

export const TEXAS_SECTION_VARIANTS = [
  // ── [0] Family-Celebration ──────────────────────────────────────────────────
  {
    heroPill: 'Private Hibachi Chef',
    experiencePill: 'The Hibachi Experience',
    experienceImage: '/pics/hibachi-texas.jpg',
    experienceImageAlt: (city) => `Backyard hibachi party in ${city}, Texas`,
    experiencePoints: [
      {
        icon: '🎉',
        title: 'The Show Everyone Talks About',
        desc: 'Fire tricks, flying shrimp, the onion volcano — your chef performs while cooking. Your guests won\'t touch their phones the entire night.',
      },
      {
        icon: '🍽️',
        title: 'Every Plate Made Fresh to Order',
        desc: 'Proteins cooked right on the teppan grill in front of your guests. Chicken, steak, shrimp — each portion made exactly how they like it, no shortcuts.',
      },
      {
        icon: '🏡',
        title: 'Host Without the Stress',
        desc: 'Your chef handles setup, cooking, and full cleanup. You relax and celebrate with your guests. Most hosts say it\'s the easiest party they\'ve ever thrown.',
      },
      {
        icon: '👨‍👩‍👧‍👦',
        title: 'Built for Large Gatherings',
        desc: 'From 10-person birthday dinners to 100-guest quinceañeras — we scale to your group size. Multiple chef stations available for larger events.',
      },
    ],
    areasPill: 'Areas We Serve',
    areasHeadline: (city) => `We Serve ${city} & All Surrounding Communities`,
    areasIntro: [
      (city, stateName) => `Hibachi Connect serves ${city} and the surrounding suburbs across Greater ${stateName}. From backyard cookouts to poolside celebrations, our chefs drive to your neighborhood fully equipped and ready to go.`,
      (city) => `Whether you're in the heart of the city or 25 miles out in the suburbs, we've got chefs in your area. Send us your zip code and we'll confirm coverage — same day in most cases.`,
    ],
    areasButton: 'Check Availability in My Area',
    occasionPill: 'Perfect For Every Celebration',
    occasionHeadline: (city) => `The Celebrations ${city} Families Remember`,
    occasionSubtext: 'From quinceañeras to graduation parties — our chefs bring the full teppanyaki experience to your backyard.',
    faqPill: 'Common Questions',
    faqHeadline: (city, stateAbbr) => `Hibachi Catering in ${city}, ${stateAbbr} — Your Questions Answered`,
    testimonialSubheading: 'Real families. Real celebrations. Real reviews from across the area.',
  },

  // ── [1] Corporate-Upscale ───────────────────────────────────────────────────
  {
    heroPill: 'Private Teppanyaki Chef',
    experiencePill: 'The Full Experience',
    experienceImage: '/pics/hibachi-dallas.jpg',
    experienceImageAlt: (city) => `Private teppanyaki chef experience in ${city}, Texas`,
    experiencePoints: [
      {
        icon: '🔥',
        title: 'Live Teppanyaki Performance',
        desc: 'Your chef commands the event. Precision knife work, controlled fire displays, and seamless plating create an experience no restaurant reservation can replicate.',
      },
      {
        icon: '🥩',
        title: 'Premium Proteins, Sourced Fresh',
        desc: 'Filet mignon, lobster tail, Chilean sea bass — our premium upgrades turn any gathering into a fine-dining experience delivered to your door.',
      },
      {
        icon: '🧹',
        title: 'White-Glove Setup & Cleanup',
        desc: 'We arrive 5–10 minutes before start time, set up the full station, and leave your space cleaner than we found it. Zero coordination required from your team.',
      },
      {
        icon: '💼',
        title: 'Corporate-Ready Execution',
        desc: 'Punctual chefs, professional presentation, and coordinated service timing — ideal for executive dinners, client appreciation events, and team celebrations.',
      },
    ],
    areasPill: 'Our Service Area',
    areasHeadline: (city) => `${city} Metro Coverage — We Come to You`,
    areasIntro: [
      (city, stateName) => `Hibachi Connect operates across ${city} and the broader metro area. From Uptown to the suburbs, our chefs bring a professional teppanyaki setup directly to your home, office, or venue.`,
      (city) => `Service extends throughout the metroplex and surrounding communities. Contact us with your venue address and we'll confirm availability — usually within a few hours. Travel fees may apply beyond 30 miles from ${city}.`,
    ],
    areasButton: 'Confirm My Location',
    occasionPill: 'Curated for Your Occasion',
    occasionHeadline: (city) => `Upscale Private Dining Events in ${city}`,
    occasionSubtext: 'From executive dinners to corporate team events — a private teppanyaki chef delivers an experience your guests won\'t find at any restaurant.',
    faqPill: 'Questions & Answers',
    faqHeadline: (city, stateAbbr) => `Private Teppanyaki in ${city}, ${stateAbbr} — Everything You Need to Know`,
    testimonialSubheading: 'Trusted by executives, hosts, and event planners across the area.',
  },

  // ── [2] Social-Trendy ───────────────────────────────────────────────────────
  {
    heroPill: 'Backyard Hibachi Chef',
    experiencePill: 'What You\'re Getting',
    experienceImage: '/pics/hibachi-austin.jpg',
    experienceImageAlt: (city) => `Hibachi party experience in ${city}, Texas`,
    experiencePoints: [
      {
        icon: '🎭',
        title: 'A Dinner That\'s Also a Show',
        desc: 'Flying shrimp, onion volcanos, fire tricks — your chef entertains while cooking. It\'s content-worthy from the first flame to the last bite. Your guests will document every second.',
      },
      {
        icon: '🌮',
        title: 'Fully Customizable for Your Crew',
        desc: 'Dietary restrictions? No problem. Mix proteins, request modifications, build a spread that works for your whole group. Everyone eats exactly what they want.',
      },
      {
        icon: '🎯',
        title: 'Zero Planning Stress',
        desc: 'We bring the grill, the food, and the full setup. You focus on the vibe. Most Airbnb hosts say hibachi nights are the easiest events they ever coordinate.',
      },
      {
        icon: '📱',
        title: 'Guaranteed Moments Worth Sharing',
        desc: 'The flames, the tricks, the live cooking — there\'s nothing passive about a hibachi dinner party. It\'s an event, not just a meal. Book it and watch the group chat light up.',
      },
    ],
    areasPill: 'Where We Operate',
    areasHeadline: (city) => `${city} & Surrounding Areas — We Come to You`,
    areasIntro: [
      (city, stateName) => `Whether your event is in the heart of ${city} or at an Airbnb 20 miles out, our chefs come to you. We serve the full ${city} metro and surrounding communities, with same-week booking available on most dates.`,
      (city) => `We cover a wide radius around ${city}. Exact coverage depends on chef availability — send us your address and we\'ll confirm fast. We always try to make it work.`,
    ],
    areasButton: 'See If We Cover My Area',
    occasionPill: 'Any Occasion, Any Vibe',
    occasionHeadline: (city) => `Your Next ${city} Party Starts Here`,
    occasionSubtext: 'Airbnb weekends, bachelorette parties, rooftop events — hibachi is the move when you want the night to be genuinely unforgettable.',
    faqPill: 'Quick Answers',
    faqHeadline: (city, stateAbbr) => `Backyard Hibachi in ${city}, ${stateAbbr} — FAQs`,
    testimonialSubheading: 'What hosts across the area are saying about their hibachi nights.',
  },

  // ── [3] Multi-Gen Family ────────────────────────────────────────────────────
  {
    heroPill: 'Mobile Hibachi Chef',
    experiencePill: 'What Makes Us Different',
    experienceImage: '/pics/private-hibachi.jpg',
    experienceImageAlt: (city) => `Family hibachi celebration in ${city}, Texas`,
    experiencePoints: [
      {
        icon: '💃',
        title: 'Celebration-Ready Entertainment',
        desc: 'From quinceañeras to graduation dinners — your chef brings the energy, the food, and the spectacle that makes the night unforgettable for every generation at the table.',
      },
      {
        icon: '🍽️',
        title: 'Something for Everyone',
        desc: 'Chicken, steak, shrimp, vegetables, fried rice — our menus accommodate picky eaters, kids, and everyone in between. No one goes home hungry. No one gets left out.',
      },
      {
        icon: '🏡',
        title: 'Backyard or Venue — We Adapt',
        desc: 'Whether it\'s a family backyard, a rented hall, or a community center, we set up the full hibachi experience at your location. We work around your space.',
      },
      {
        icon: '❤️',
        title: 'Made for Milestone Moments',
        desc: 'Quinceañeras, anniversaries, baby showers, milestone birthdays — we understand the significance of the occasion and show up prepared to match it.',
      },
    ],
    areasPill: 'Coverage Area',
    areasHeadline: (city) => `Serving ${city} & Surrounding Communities`,
    areasIntro: [
      (city, stateName) => `Hibachi Connect travels throughout ${city} and all surrounding communities in ${stateName}. Whether your event is at a family home, a rented venue, or an outdoor space, we come to you fully equipped with everything needed.`,
      (city) => `We serve a broad coverage area around ${city}. If you\'re outside the primary zone, reach out — we always try to accommodate. Travel fees may apply for locations more than 30 miles from the city center.`,
    ],
    areasButton: 'Check My Zip Code',
    occasionPill: 'Built for Every Gathering',
    occasionHeadline: (city) => `Every Family Gathering in ${city} Deserves Hibachi`,
    occasionSubtext: 'Quinceañeras, family reunions, multi-generational celebrations — we bring the full teppanyaki experience to your home, backyard, or venue.',
    faqPill: 'Your Questions, Answered',
    faqHeadline: (city, stateAbbr) => `Mobile Hibachi in ${city}, ${stateAbbr} — What to Expect`,
    testimonialSubheading: 'Families across the area trust us for their most meaningful celebrations.',
  },

  // ── [4] Authentic Texas / BBQ-Alt ──────────────────────────────────────────
  {
    heroPill: 'Teppanyaki Catering',
    experiencePill: 'Why Skip the Restaurant',
    experienceImage: '/pics/backyard-hibachi.jpg',
    experienceImageAlt: (city) => `Mobile hibachi chef at a backyard event in ${city}, Texas`,
    experiencePoints: [
      {
        icon: '🔥',
        title: 'Something Different from the Usual BBQ',
        desc: 'You love Texas BBQ — so do we. But a hibachi chef brings live performance, interactive cooking, and a full menu that goes way beyond what any grill master can pull off at a cookout.',
      },
      {
        icon: '🤠',
        title: 'Built for Texas-Sized Events',
        desc: 'Backyard gatherings, ranch cookouts, neighborhood block parties — our chefs travel wherever the event is. No venue required. Grass, concrete, or patio, we set up and run the show.',
      },
      {
        icon: '💰',
        title: 'Real Value, No Hidden Fees',
        desc: '$60 per adult, $30 per child, all-in. Food, grill, propane, setup, cleanup — everything included. No catering kitchen fees, no venue surcharges, no surprises on the invoice.',
      },
      {
        icon: '🧹',
        title: 'We Leave It Cleaner Than We Found It',
        desc: 'Full teardown after every event. Grill, equipment, packaging — all of it leaves with us. You focus on the guests; we handle everything before and after.',
      },
    ],
    areasPill: 'Where We Travel',
    areasHeadline: (city) => `Our ${city} Service Area — Backyards to Ranches`,
    areasIntro: [
      (city, stateName) => `Our chefs travel across ${city} and the surrounding region — backyards, ranches, parks, and event venues all work. If you have the space and the guests, we\'ll bring the full hibachi setup and run the entire show.`,
      (city) => `Coverage extends well beyond ${city} proper. Most suburban and rural locations within 30 miles are in our standard range at no extra charge. Send us your address and we\'ll confirm quickly — no pressure, no commitment.`,
    ],
    areasButton: 'Get a Coverage Confirmation',
    occasionPill: 'Texas-Sized Events Welcome',
    occasionHeadline: (city) => `${city} Events That Go Beyond the Backyard BBQ`,
    occasionSubtext: 'Ranch cookouts, neighborhood block parties, graduation blowouts — skip the grill and let a hibachi chef handle the entire show.',
    faqPill: 'FAQs',
    faqHeadline: (city, stateAbbr) => `Teppanyaki Catering in ${city}, ${stateAbbr} — Common Questions`,
    testimonialSubheading: 'Texans who traded the backyard grill for a hibachi chef — and never looked back.',
  },
]

const TEXAS_SECTION_MAP = {
  houston:         0,
  dallas:          1,
  austin:          2,
  'san-antonio':   3,
...
export function getTexasSectionVariant(citySlug) {
  const idx = TEXAS_SECTION_MAP[citySlug] ?? getTexasVariantIndex(citySlug)
  return TEXAS_SECTION_VARIANTS[idx % TEXAS_SECTION_VARIANTS.length]
}

// ─────────────────────────────────────────────────────────────────────────────
// PER-CITY IMAGE MAP
// Every Texas city gets its own unique image for the Experience section.
// Falls back to the variant image for any city not listed here.
// ─────────────────────────────────────────────────────────────────────────────

const TEXAS_CITY_IMAGE_MAP = {
  // Major metros — city-specific shots
  houston:          { src: '/pics/hibachi-texas.jpg',         alt: (city) => `Backyard hibachi party in ${city}, Texas` },
  dallas:           { src: '/pics/hibachi-dallas-tyler.jpg',  alt: (city) => `Upscale private hibachi dinner at a covered outdoor venue in ${city}, Texas` },
  austin:           { src: '/pics/hibachi-austin.jpg',        alt: (city) => `Outdoor hibachi party in ${city}, Texas` },
  'san-antonio':    { src: '/pics/private-hibachi.jpg',       alt: (city) => `Family hibachi celebration in ${city}, Texas` },
  'fort-worth':     { src: '/pics/backyard-hibachi.jpg',      alt: (city) => `Backyard hibachi cookout in ${city}, Texas` },
  // Houston suburbs
  'the-woodlands':  { src: '/pics/hibachi-chef-at-home.jpg',  alt: (city) => `Private teppanyaki chef in ${city}, Texas` },
  katy:             { src: '/pics/hibachi-at-home.jpg',       alt: (city) => `Hibachi at home event in ${city}, Texas` },
  'sugar-land':     { src: '/pics/hibachi-catering.jpg',      alt: (city) => `Hibachi catering in ${city}, Texas` },
  pearland:         { src: '/pics/traveling-hibachi.jpg',     alt: (city) => `Mobile hibachi chef in ${city}, Texas` },
  'league-city':    { src: '/pics/hibachi-to-you.jpg',        alt: (city) => `Private hibachi party in ${city}, Texas` },
  cypress:          { src: '/pics/mobile-hibachi.jpg',        alt: (city) => `Mobile hibachi catering in ${city}, Texas` },
  // DFW suburbs
  frisco:           { src: '/pics/hibachi-dallas-tyler.jpg',  alt: (city) => `Hibachi chef experience in ${city}, Texas` },
  // Austin area
  georgetown:       { src: '/pics/hibachi-catering-austin.jpg', alt: (city) => `Hibachi catering in ${city}, Texas` },
  // Other Texas cities
  'new-braunfels':  { src: '/pics/hibachi-colorado.jpg',      alt: (city) => `Outdoor hibachi event in ${city}, Texas` },
  'corpus-christi': { src: '/pics/backyard-hibachi-2.jpg',    alt: (city) => `Backyard hibachi party in ${city}, Texas` },
  galveston:        { src: '/pics/hibachi-catering-2.jpg',    alt: (city) => `Hibachi catering event in ${city}, Texas` },
  waco:             { src: '/pics/hibachi-dallas-2.jpg',      alt: (city) => `Private hibachi chef in ${city}, Texas` },
  temple:           { src: '/pics/hibachi-home-austin.jpg',   alt: (city) => `Hibachi at home in ${city}, Texas` },
  beaumont:         { src: '/pics/hibachi-austin-2.jpg',      alt: (city) => `Backyard hibachi party in ${city}, Texas` },
  victoria:         { src: '/pics/hibachi-event.jpg',         alt: (city) => `Private hibachi experience in ${city}, Texas` },
  // Additional cities — rotating from extra image pool
  'killeen':        { src: '/pics/hibachi-pic-4.jpg',         alt: (city) => `Backyard teppanyaki event in ${city}, Texas` },
  lubbock:          { src: '/pics/hibachi-shot-1.jpg',        alt: (city) => `Private hibachi chef in ${city}, Texas` },
  amarillo:         { src: '/pics/hibachi-shot-2.jpg',        alt: (city) => `Hibachi catering in ${city}, Texas` },
  midland:          { src: '/pics/hibachi-pic-2.jpg',         alt: (city) => `Mobile hibachi party in ${city}, Texas` },
  odessa:           { src: '/pics/hibachi-pic-3.jpg',         alt: (city) => `Backyard hibachi event in ${city}, Texas` },
  abilene:          { src: '/pics/hibachi-pic-32.jpg',        alt: (city) => `Private hibachi chef in ${city}, Texas` },
  'el-paso':        { src: '/pics/hibachi-pic-62.jpg',        alt: (city) => `Hibachi at home in ${city}, Texas` },
  tyler:            { src: '/pics/hibachi-austin-3.jpg',      alt: (city) => `Backyard hibachi party in ${city}, Texas` },
}

export function getTexasCityImage(citySlug) {
  return TEXAS_CITY_IMAGE_MAP[citySlug] ?? null
}

// ── Support images — above Testimonials + above Final CTA ────────────────────
// Each city gets two images different from its experience-section image.
const TEXAS_SUPPORT_IMAGES = {
  dallas: {
    testimonial: {
      src:     '/pics/backyard-hibachi.jpg',
      alt:     (city) => `Dallas guests and private hibachi chef at a real backyard ${city} event`,
      caption: null,
      trustBadge: 'Five-Star Entertainment & Dining',
      intro:   (city) => `Trusted by executives, hosts, event planners, birthday hosts, corporate teams, and families across ${city}–Fort Worth. From Uptown rooftop gatherings to Plano and Frisco backyard celebrations, our certified chefs travel to you with the full teppanyaki setup and complete cleanup — everything handled. Here's what ${city} hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-dallas-tyler.jpg',
      alt:     (city) => `Private hibachi chef in action at a ${city} backyard event`,
      caption: null,
    },
  },
  houston: {
    testimonial: {
      src:     '/pics/backyard-hibachi.jpg',
      alt:     (city) => `Backyard hibachi party with live chef entertaining guests in ${city}, Texas`,
      caption: 'Poolside, patio, or full backyard setup — Houston knows how to throw a hibachi party.',
      trustBadge: 'Trusted by Local Families',
      intro:   (city) => `${city} families, corporate teams, and celebration hosts choose private hibachi for birthdays, graduation dinners, and backyard events that turn any outdoor space into a five-star dining room. Our certified chefs travel to your ${city} home — Energy Corridor, Memorial, River Oaks, or anywhere in the metro — with the full teppanyaki setup and complete cleanup. Here's what ${city} hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-at-home.jpg',
      alt:     (city) => `Mobile hibachi chef setup at a ${city} home event`,
      caption: null,
    },
  },
  austin: {
    testimonial: {
      ...
      alt:     (city) => `Social hibachi gathering at an ${city} Airbnb weekend rental`,
      caption: 'Airbnb weekends, rooftop hangouts, and backyard block parties — Austin hosts love hibachi at home.',
      trustBadge: 'Hundreds of Private Events',
      intro:   (city) => `Tech professionals, bachelorette groups, and Lake Travis weekend renters have made private hibachi one of ${city}'s favorite ways to entertain. From South Congress Airbnbs to Barton Hills backyards, our certified chefs bring the full teppanyaki experience directly to your outdoor space. See what ${city} hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-catering-austin.jpg',
      alt:     (city) => `Private hibachi chef catering a ${city} home event`,
      caption: null,
    },
  },
  'san-antonio': {
    testimonial: {
      ...
      alt:     (city) => `Hibachi chef at a large family celebration in ${city}, Texas`,
      caption: 'Quinceañeras, graduations, and multi-generational reunions — our chefs make every milestone in San Antonio unforgettable.',
      trustBadge: 'Thousands of Happy Guests',
      intro:   (city) => `Military families, Hill Country visitors, and multi-generational ${city} households choose private hibachi for quinceañeras, JBSA homecoming dinners, and graduation celebrations that deserve more than a restaurant table. Our chefs travel throughout the ${city} metro with complete setup and cleanup — no prep, no mess, no reservations. Read what ${city} families are saying:`,
    },
    cta: {
      src:     '/pics/mobile-hibachi.jpg',
      alt:     (city) => `Mobile hibachi chef arriving for a ${city} family event`,
      caption: null,
    },
  },
  'fort-worth': {
    testimonial: {
      ...
      alt:     (city) => `Private hibachi chef at a ${city} backyard event, Texas`,
      caption: 'Authentic Texas backyard culture meets live teppanyaki — the Fort Worth way to entertain.',
      trustBadge: 'Highly Rated by Local Hosts',
      intro:   (city) => `${city} families near the Cultural District, Sundance Square, and the surrounding neighborhoods know how to host — and private hibachi fits right into that Western tradition of big, welcoming gatherings. Our certified chefs bring the full teppanyaki setup to your backyard for milestones like birthdays, anniversaries, and graduation dinners. Here's what ${city} hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-texas.jpg',
      alt:     (city) => `Teppanyaki chef cooking at a Texas backyard gathering in ${city}`,
      caption: null,
    },
  },
  katy: {
    testimonial: {
      ...
      alt:     (city) => `Family hibachi celebration with live chef in ${city}, Texas`,
      caption: 'Katy families love hibachi at home — from milestone birthdays to graduation weekends.',
      trustBadge: 'Unforgettable Private Dining Experiences',
      intro:   (city) => `${city} families celebrate big — milestone birthdays, graduation weekends, and backyard block parties are a regular part of life in this Houston suburb. Our certified chefs travel to your ${city} home with the full teppanyaki grill and handle everything from setup to cleanup. See what ${city} hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-chef-at-home.jpg',
      alt:     (city) => `Private hibachi chef preparing food at a ${city} home event`,
      caption: null,
    },
  },
  'sugar-land': {
    testimonial: {
      ...
      alt:     (city) => `Hibachi catering at a multi-generational family party in ${city}, Texas`,
      caption: 'Sugar Land gatherings — bigger tables, more proteins, zero restaurant stress.',
      trustBadge: "Texas' Favorite Hibachi Experience",
      intro:   (city) => `${city}'s diverse, family-forward community has embraced private hibachi as the go-to format for celebrations of every size — from intimate anniversary dinners to 40-person extended family gatherings. Our chefs travel to your ${city} home with full teppanyaki setup and complete cleanup, so the only thing you handle is enjoying the night. Here's what ${city} hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-pic-62.jpg',
      alt:     (city) => `Backyard teppanyaki experience at a ${city} home`,
      caption: null,
    },
  },
  'the-woodlands': {
    testimonial: {
      ...
      alt:     (city) => `Corporate hibachi dinner at a ${city}, Texas event`,
      caption: 'From Hughes Landing patios to Creekside Park backyards — The Woodlands expects premium.',
      trustBadge: '5.0 Average Rating',
      intro:   (city) => `${city} hosts — from Hughes Landing executives to Creekside Park families — set a high standard for their events, and our private hibachi chefs meet it every time. Whether it's a corporate team dinner, a milestone birthday, or a neighborhood celebration, we arrive with full teppanyaki setup and leave with everything cleaned up. Read what ${city} hosts are saying:`,
    },
    cta: {
      src:     '/pics/hibachi-catering.jpg',
      alt:     (city) => `Private chef hibachi setup at a ${city} catering event`,
      caption: null,
    },
  },
}

// Fallback pool for all other Texas cities — 5 slots by variant index
const TEXAS_SUPPORT_FALLBACKS = [
  {
    testimonial: { src: '/pics/hibachi-pic-3.jpg',       alt: (city) => `Live hibachi chef entertaining guests at a private ${city} event`,   caption: null, trustBadge: 'Trusted by Local Families',                       intro: (city) => `${city} families and celebration hosts across Texas choose private hibachi for birthdays, graduations, and backyard gatherings that go well beyond the ordinary dinner out. Our certified chefs travel to your ${city} home with the full teppanyaki setup and handle everything from lighting the grill to cleaning up after — zero effort on your end. Here's what ${city} hosts are saying:` },
    cta:         { src: '/pics/traveling-hibachi.jpg',    alt: (city) => `Traveling hibachi chef arriving for a ${city} backyard party`,        caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-pic-4.jpg',       alt: (city) => `Hibachi chef cooking teppanyaki at a ${city} home gathering`,         caption: null, trustBadge: 'Hundreds of Private Events',                      intro: (city) => `Private hibachi has become one of the most requested event formats in ${city} — for good reason. Our chefs bring the full teppanyaki experience to your backyard, patio, or outdoor space and turn any evening into a performance your guests won't stop talking about. Read what ${city} hosts are saying:` },
    cta:         { src: '/pics/hibachi-to-you.jpg',      alt: (city) => `Hibachi to your door — private chef event in ${city}, Texas`,         caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-pic-32.jpg',      alt: (city) => `Private teppanyaki event at a ${city} residence`,                     caption: null, trustBadge: 'Thousands of Happy Guests',                      intro: (city) => `Across ${city} and the surrounding Texas communities, families, corporate teams, and milestone celebration hosts choose private hibachi for events that deserve more than a restaurant table. Our certified chefs arrive with everything — grill, ingredients, and full cleanup — so you can focus on your guests. Here's what ${city} hosts are saying:` },
    cta:         { src: '/pics/backyard-hibachi-2.jpg',  alt: (city) => `Backyard hibachi setup with full grill in ${city}`,                   caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-pic-2.jpg',       alt: (city) => `Hibachi chef at a backyard party in ${city}, Texas`,                  caption: null, trustBadge: "Texas' Favorite Hibachi Experience",            intro: (city) => `${city} hosts who want the wow-factor without the restaurant logistics choose private hibachi every time. From intimate anniversary dinners to large graduation parties, our certified chefs travel to your ${city} location and deliver a live teppanyaki performance that becomes the highlight of every event. See what ${city} guests are saying:` },
    cta:         { src: '/pics/hibachi-austin-3.jpg',    alt: (city) => `Private chef hibachi experience in ${city}`,                          caption: null },
  },
  {
    testimonial: { src: '/pics/hibachi-home-austin.jpg', alt: (city) => `Private hibachi chef at a ${city} home event`,                        caption: null, trustBadge: 'Five-Star Entertainment & Dining',              intro: (city) => `Whether it's a milestone birthday, a corporate team dinner, or a backyard block party, ${city} hosts trust our private hibachi chefs to deliver an experience that impresses every guest at the table. We bring the full setup, cook fresh on-site, and leave with everything cleaned up. Here's what ${city} hosts are saying:` },
    cta:         { src: '/pics/hibachi-pic-62.jpg',      alt: (city) => `Teppanyaki chef serving guests at a ${city} backyard dinner`,          caption: null },
  },
]

export function getTexasSupportImages(citySlug, variantIdx) {
  return TEXAS_SUPPORT_IMAGES[citySlug] ?? TEXAS_SUPPORT_FALLBACKS[variantIdx % TEXAS_SUPPORT_FALLBACKS.length]
}
