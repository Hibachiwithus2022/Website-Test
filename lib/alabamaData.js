...
const AL_BLOG_POSTS = [
  // Slot 0
  [
    { slug: 'hibachi-birthday-party-ideas',        title: '10 Hibachi Birthday Party Ideas Your Guests Will Never Forget',    excerpt: 'From Mountain Brook estate dinners to Vestavia Hills graduation parties — how to host a backyard hibachi event in Alabama.', category: 'Guide', readTime: '6 min read' },
    { slug: 'how-much-does-private-hibachi-cost',  title: 'How Much Does a Private Hibachi Chef Cost?',                       excerpt: 'A full pricing breakdown for Alabama hibachi events — what\'s included and what to expect at every guest count.', category: 'Guide', readTime: '4 min read' },
  ...
  [
    ...
    { slug: 'how-to-plan-a-backyard-hibachi-party',     title: 'How to Plan a Backyard Hibachi Party (Complete Checklist)',           excerpt: 'Everything Alabama hosts need before the private hibachi chef arrives — checklist for Birmingham, Hoover, and Montgomery.', category: 'Guide', readTime: '6 min read' },
    { slug: 'hibachi-at-home-vs-restaurant',            title: 'Hibachi at Home vs. Restaurant: Which Is Worth It?',                 excerpt: 'Alabama hibachi restaurants vs. a private chef at your property — the real cost, experience quality, and convenience breakdown.', category: 'Guide', readTime: '5 min read' },
  ],
  // Slot 2
  [
    { slug: 'what-to-expect-hibachi-chef-home',    title: 'What to Expect When You Book a Private Hibachi Chef at Home',      excerpt: 'Huntsville and Gulf Shores hosts: what happens from booking to cleanup at an Alabama private hibachi event.', category: 'Guide', readTime: '5 min read' },
    ...
    { slug: 'how-much-does-private-hibachi-cost',  title: 'How Much Does a Private Hibachi Chef Cost?',                       excerpt: 'A full pricing breakdown for Gulf Coast Alabama hibachi events — what\'s included at every guest count.', category: 'Guide', readTime: '4 min read' },
  ],
]
